...
public class Class1
{
    ...
    public static void method129(byte abyte0[], boolean flag)
    {
        ...
        for(int l2 = 0; l2 < anInt75; l2++)
            ...
            {
                itemNameArray[l2] = "Members object";
        ...
        anInt122 = method126();
        NPCNameArray = new String[anInt122];
        ...
        NPCHitpoints = new int[anInt122];
        NPCDefense = new int[anInt122];
        ...
        for(int i4 = 0; i4 < anInt122; i4++)
            NPCHitpoints[i4] = method125();

        for(int j4 = 0; j4 < anInt122; j4++)
            NPCDefense[j4] = method125();
        ...
        anInt108 = method126();
        anInt120 = method126();
        spellNameArray = new String[anInt120];
    ...
    public static int NPCHitpoints[];
    ...
    public static int shopBaseWorth[];
