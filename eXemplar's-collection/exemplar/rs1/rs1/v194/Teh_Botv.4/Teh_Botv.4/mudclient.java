...
try
{
     Thread.sleep(1000); // 250 milliseconds
...

{
 ...
 super.aah.hem();
 if(eff == 0)
 enl("@gre@Teh_Bot: @ran@Fighting mode set to Controlled", 3);
 if(eff == 1)
 enl("@gre@Teh_Bot: @ran@Fighting mode set to Strength", 3);
 if(eff == 2)
 enl("@gre@Teh_Bot: @ran@Fighting mode set to Attack", 3);
 if(eff == 3)
 enl("@ora@Teh_Bot: @ran@Fighting mode set to Defense", 3);
 }
