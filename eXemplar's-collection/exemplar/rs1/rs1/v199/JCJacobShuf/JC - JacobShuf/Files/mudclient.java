...
public final class mudclient extends b
{
    ...
    public static final void main(String args[])
    {
        ...
        mudclient1.flc(mudclient1.dcl, mudclient1.dcm + 11, "Runescape by Andrew Gower", false);
        mudclient1.fkd = 10;
    }
    ...
    private final void faa()
    {
        ...
        {
            efj.cbf();
            efj.cdl("Oh dear! You are dead...", dcl / 2, dcm / 2, 7, 0xff0000);
            fcm();
            efj.caj(dci, 0, 0);
            return;
        }
    ...
    private final void fae()
    {
        ...
        {
            ehm.gfd(256, 200 + l, "Welcome to RuneScape", 4, true);
            ehm.gfd(256, 215 + l, "You need a member account to use this server", 4, true);
        ...
        eld = dkf.gfj(190, l + 10, 200, 40, 4, 20, true, false);
        l -= 55;
    ...
    private final void fbf(boolean arg0)
    {
        ...
        if(dej)
            if(ejl)
                efj.cdn("Sound effects - @red@off", j1, l1, 1, 0xffffff);
            else
                efj.cdn("Sound effects - @gre@on", j1, l1, 1, 0xffffff);
        l1 += 15;
    ...
    private final int fce(int arg0)
    {
        int l = 0;
        for(int i1 = 0; i1 < eja; i1++)
            if(ejb[i1] == arg0)
