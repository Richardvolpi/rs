...
public class gobvil extends Macro {
    
    public gobvil(slave rs) {
        super(rs);
    }
    public String[] getCommands() {
        return new String[]{"gobvil"};
    }
    public String[] getComments() {
        return new String[]{"Usage: /gobvil fightmode"};
    }
    public void start(String command) {
        ...
        if(command.indexOf(" ")!=-1) {
            int fmode = Integer.parseInt(command.substring(command.indexOf(" ")+1,command.length()));
