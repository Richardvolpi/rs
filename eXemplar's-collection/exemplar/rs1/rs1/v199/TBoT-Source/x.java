...
public class x
{
    ...
    public void gjd(i k, int l, int i1, int j1, int k1, int l1)
    {
        gkk(i1, j1, 40);
        gkk(k1, l1, 40);
        int i2 = identify.akf[l];
        int j2 = identify.akg[l];
        int k2 = identify.akh[l];
        int l2 = i1 * 128;
        int i3 = j1 * 128;
        int j3 = k1 * 128;
        int k3 = l1 * 128;
    ...
    public void gjf(int arg0, int arg1, int arg2, int arg3)
    {
        ...
        try
        {
            if(gii != null)
            {
                byte abyte0[] = t.fng(s + ".hei", 0, gii);
                if(abyte0 == null && gib != null)
                    abyte0 = t.fng(s + ".hei", 0, gib);
                ...
                abyte0 = t.fng(s + ".dat", 0, gij);
                if(abyte0 == null && gic != null)
                    abyte0 = t.fng(s + ".dat", 0, gic);
                if(abyte0 == null || abyte0.length == 0)
            ...
            } else
            {
                ...
                for(int k5 = 0; k5 < 2304; k5++)
                    ghg[arg3][k5] = abyte1[k2++];

                for(int l6 = 0; l6 < 2304; l6++)
                    gif[arg3][l6] = abyte1[k2++];

                for(int i8 = 0; i8 < 2304; i8++)
                {
                    ghk[arg3][i8] = (abyte1[k2] & 0xff) * 256 + (abyte1[k2 + 1] & 0xff);
                    k2 += 2;
                }

                for(int l8 = 0; l8 < 2304; l8++)
                    gik[arg3][l8] = abyte1[k2++];

                for(int k9 = 0; k9 < 2304; k9++)
                    ghl[arg3][k9] = abyte1[k2++];

                for(int k10 = 0; k10 < 2304; k10++)
                    ghn[arg3][k10] = abyte1[k2++];
    ...
    public void gjj(int arg0, int arg1, int arg2)
    {
        if(arg0 < 0 || arg1 < 0 || arg0 >= 95 || arg1 >= 95)
            return;
        if(identify.aln[arg2] == 1 || identify.aln[arg2] == 2)
        {
            int k = gjh(arg0, arg1);
            int l;
            int i1;
            ...
            {
                l = identify.all[arg2];
                i1 = identify.alm[arg2];
            } else
            {
                i1 = identify.all[arg2];
                l = identify.alm[arg2];
            }
            for(int j1 = arg0; j1 < arg0 + l; j1++)
            {
                for(int k1 = arg1; k1 < arg1 + i1; k1++)
                    if(identify.aln[arg2] == 1)
                        ghb[j1][k1] |= 0x40;
                    else
                    if(k == 0)
                    {
    ...
    public int gjm(int k, int l, int i1, int j1)
    {
        ...
        if(k1 == 0)
            ...
            return identify.ahd[k1 - 1];
    }

    public void gjn(int k, int l, int i1, int j1, int k1)
    {
        int l1 = k * 3;
        int i2 = l * 3;
        int j2 = ghe.bjj(j1);
        ...
        if(i1 == 0)
        {
            ghd.drawLine(l1, i2, 3, j2);
            ghd.drawLine(l1, i2 + 1, 2, j2);
            ghd.drawLine(l1, i2 + 2, 1, j2);
            ghd.drawLine(l1 + 2, i2 + 1, 1, k2);
            ghd.drawLine(l1 + 1, i2 + 2, 2, k2);
            return;
        }
        if(i1 == 1)
        {
            ghd.drawLine(l1, i2, 3, k2);
            ghd.drawLine(l1 + 1, i2 + 1, 2, k2);
            ghd.drawLine(l1 + 2, i2 + 2, 1, k2);
            ghd.drawLine(l1, i2 + 1, 1, j2);
            ghd.drawLine(l1, i2 + 2, 2, j2);
        }
    }
    ...
    public int gkb(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6[], 
    ...
    public void gke(int arg0, int arg1, int arg2, int arg3)
    {
        if(arg0 < 0 || arg1 < 0 || arg0 >= 95 || arg1 >= 95)
            return;
        if(identify.aki[arg3] == 1)
        {
            if(arg2 == 0)
            {
    ...
    public void gkf(int k, int l, int i1)
    {
        gkh();
        int j1 = (k + 24) / 48;
        int k1 = (l + 24) / 48;
    ...
    public void gkg(int arg0, int arg1, int arg2)
    {
        if(arg0 < 0 || arg1 < 0 || arg0 >= 95 || arg1 >= 95)
            return;
        if(identify.aln[arg2] == 1 || identify.aln[arg2] == 2)
    ...
    public void gkj(int arg0, int arg1, int arg2, int arg3)
    {
        if(arg0 < 0 || arg1 < 0 || arg0 >= 95 || arg1 >= 95)
            return;
        if(identify.aki[arg3] == 1)
    ...
    public void gkm(int arg0, int arg1, int arg2, boolean arg3)
    {
        ...
        if(arg3)
        {
            ...
            for(int j2 = 0; j2 < 96; j2++)
            {
                ...
                {
                    int i4 = -gkd(j2, i3);
                    if(gjk(j2, i3, arg2) > 0 && identify.ahe[gjk(j2, i3, arg2) - 1] == 4)
                        i4 = 0;
                    if(gjk(j2 - 1, i3, arg2) > 0 && identify.ahe[gjk(j2 - 1, i3, arg2) - 1] == 4)
                        i4 = 0;
                    if(gjk(j2, i3 - 1, arg2) > 0 && identify.ahe[gjk(j2, i3 - 1, arg2) - 1] == 4)
                        i4 = 0;
                    if(gjk(j2 - 1, i3 - 1, arg2) > 0 && identify.ahe[gjk(j2 - 1, i3 - 1, arg2) - 1] == 4)
                        i4 = 0;
            ...
            for(int j3 = 0; j3 < 95; j3++)
            {
                for(int j4 = 0; j4 < 95; j4++)
                {
                    ...
                    if(gjk(j3, j4, arg2) > 0)
                    {
                        ...
                        int l5 = identify.ahe[l16 - 1];
                        int i19 = glg(j3, j4, arg2);
                        k7 = i10 = identify.ahd[l16 - 1];
                        if(l5 == 4)
                        {
                            k7 = 1;
                            i10 = 1;
                        ...
                        if(l5 != 2 || gkn(j3, j4) > 0 && gkn(j3, j4) < 24000)
                        ...
                        if(identify.ahf[l16 - 1] != 0)
                            ghb[j3][j4] |= 0x40;
                        if(identify.ahe[l16 - 1] == 2)
                            ghb[j3][j4] |= 0x80;
                    }
                    gjn(j3, j4, l14, k7, i10);
            ...
            for(int k4 = 1; k4 < 95; k4++)
            {
                for(int i6 = 1; i6 < 95; i6++)
                    if(gjk(k4, i6, arg2) > 0 && identify.ahe[gjk(k4, i6, arg2) - 1] == 4)
                    {
                        int l7 = identify.ahd[gjk(k4, i6, arg2) - 1];
                    ...
                    if(gjk(k4, i6, arg2) == 0 || identify.ahe[gjk(k4, i6, arg2) - 1] != 3)
                    {
                        if(gjk(k4, i6 + 1, arg2) > 0 && identify.ahe[gjk(k4, i6 + 1, arg2) - 1] == 4)
                        {
                            int i8 = identify.ahd[gjk(k4, i6 + 1, arg2) - 1];
                        ...
                        if(gjk(k4, i6 - 1, arg2) > 0 && identify.ahe[gjk(k4, i6 - 1, arg2) - 1] == 4)
                        {
                            int j8 = identify.ahd[gjk(k4, i6 - 1, arg2) - 1];
                        ...
                        if(gjk(k4 + 1, i6, arg2) > 0 && identify.ahe[gjk(k4 + 1, i6, arg2) - 1] == 4)
                        {
                            int k8 = identify.ahd[gjk(k4 + 1, i6, arg2) - 1];
                        ...
                        if(gjk(k4 - 1, i6, arg2) > 0 && identify.ahe[gjk(k4 - 1, i6, arg2) - 1] == 4)
                        {
                            int l8 = identify.ahd[gjk(k4 - 1, i6, arg2) - 1];
        ...
        for(int i2 = 0; i2 < 95; i2++)
        {
            ...
            {
                int k3 = gkl(i2, k2);
                if(k3 > 0 && (identify.akj[k3 - 1] == 0 || ghf))
                {
                    gjd(gin, k3 - 1, i2, k2, i2 + 1, k2);
                    if(arg3 && identify.aki[k3 - 1] != 0)
                    {
                        ghb[i2][k2] |= 1;
                        if(k2 > 0)
                            gli(i2, k2 - 1, 4);
                ...
                if(k3 > 0 && (identify.akj[k3 - 1] == 0 || ghf))
                {
                    ...
                    if(arg3)
                        ghd.cbd(i2 * 3, k2 * 3, 3, j1);
                }
                k3 = gkn(i2, k2);
                if(k3 > 0 && k3 < 12000 && (identify.akj[k3 - 1] == 0 || ghf))
                {
                    ...
                    if(arg3)
                    {
                        ghd.cbe(i2 * 3, k2 * 3, j1);
                        ghd.cbe(i2 * 3 + 1, k2 * 3 + 1, j1);
                        ghd.cbe(i2 * 3 + 2, k2 * 3 + 2, j1);
                    }
                }
                if(k3 > 12000 && k3 < 24000 && (identify.akj[k3 - 12001] == 0 || ghf))
                {
                    gjd(gin, k3 - 12001, i2 + 1, k2, i2, k2 + 1);
                    if(arg3 && identify.aki[k3 - 12001] != 0)
                        ghb[i2][k2] |= 0x10;
                    if(arg3)
                    {
                        ghd.cbe(i2 * 3 + 2, k2 * 3, j1);
                        ghd.cbe(i2 * 3 + 1, k2 * 3 + 1, j1);
                        ghd.cbe(i2 * 3, k2 * 3 + 2, j1);
                    }
                }
            }
        ...
        for(int i7 = 1; i7 < 95; i7++)
        {
            for(int k9 = 1; k9 < 95; k9++)
            {
                ...
                if(i12 > 0)
                {
                    ...
                    if(gkn(i7, k9) > 0 && gkn(i7, k9) < 12000 && gkc(i7 + 1, k9 - 1) == 0)
                    {
                        int ai10[] = new int[3];
        ...
        for(int k = 0; k < 96; k++)
        {
            for(int l = 0; l < 96; l++)
                if(gjk(k, l, 0) == 250)
                    ...
                    if(l == 47 && gjk(k, l + 1, 0) != 250 && gjk(k, l + 1, 0) != 2)
                        gje(k, l, 9);
                    else
                        gje(k, l, 2);
        ...
        for(int k = 0; k < 94; k++)
        {
            for(int l = 0; l < 94; l++)
                if(gkn(k, l) > 48000 && gkn(k, l) < 60000)
                {
                    ...
                    gjj(k, l, i1);
                    i i2 = arg0[identify.alk[i1]].cnk(false, true, false, false);
                    int j2 = ((k + k + k1) * 128) / 2;
                    int l2 = ((l + l + l1) * 128) / 2;
    ...
    public x(n arg0, j arg1)
    {
        ...
        ghd = arg1;
        for(int k = 0; k < 64; k++)
            ghc[k] = n.bjm(255 - k * 4, 255 - (int)((double)k * 1.75D), 255 - k * 4);

        for(int l = 0; l < 64; l++)
            ghc[l + 64] = n.bjm(l * 3, 144, 0);

        for(int i1 = 0; i1 < 64; i1++)
            ghc[i1 + 128] = n.bjm(192 - (int)((double)i1 * 1.5D), 144 - (int)((double)i1 * 1.5D), 0);

        for(int j1 = 0; j1 < 64; j1++)
            ghc[j1 + 192] = n.bjm(96 - (int)((double)j1 * 1.5D), 48 + (int)((double)j1 * 1.5D), 0);

    }

    public void glh(int k, int l, int i1, int j1, int k1)
    {
        int l1 = identify.akf[k];
        if(gig[l][i1] < 0x13880)
            gig[l][i1] += 0x13880 + l1;
