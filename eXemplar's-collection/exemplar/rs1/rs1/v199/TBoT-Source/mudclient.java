...
public final class mudclient extends b
{
    ...
    {
		System.out.println("### TBoT199 - RichyT v" + version);
        ...
        mudclient1.createWindow(mudclient1.width, mudclient1.height + 11, "TBoT199 - RichyT", false);
        mudclient1.fkd = 10;
        ...
        try
        {
            ...
            if(arg0 == 71)
            {
                for(int j1 = 1; j1 < arg1;)
                    ...
                    {
                        int k8 = 0;
                        int i15 = smallX + arg2[j1 + 1] >> 3;
                        int l19 = smallY + arg2[j1 + 2] >> 3;
                        j1 += 3;
    ...
    public final void handleMenu(int l)
    {
        ...
        if(j2 == 620)
        {
            super.connection.newID(135);
            super.connection.addInt(k1);
            super.connection.complete();
        }
        if(j2 == 630)
        {
            super.connection.newID(105);
            super.connection.addInt(k1);
            super.connection.complete();
        }
        if(j2 == 640)
        {
            super.connection.newID(137);
            super.connection.addInt(k1);
            super.connection.complete();
        }
        if(j2 == 650)
        ...
        if(j2 == 805 || j2 == 2805)
        {
            ...
            super.connection.newID(134);
            super.connection.addInt(k1);
            super.connection.complete();
        }
        if(j2 == 2806)
        {
            super.connection.newID(170);
            super.connection.addInt(k1);
            super.connection.complete();
        }
        if(j2 == 2810)
        {
            super.connection.newID(39);
            super.connection.addInt(k1);
            super.connection.complete();
        }
        if(j2 == 2820)
        {
            super.connection.newID(214);
            super.connection.addInt(k1);
            super.connection.complete();
        }
        if(j2 == 900)
