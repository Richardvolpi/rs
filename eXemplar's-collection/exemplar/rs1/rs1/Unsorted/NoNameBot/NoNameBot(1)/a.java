    ...
    implements Runnable
{
    ...
    private final void flh()
    {
		Toolkit toolkit = Toolkit.getDefaultToolkit();
  		...
  		int i = 0;
  		int k = 0;
  		fjg = Toolkit.getDefaultToolkit().getImage("logo.gif");
    ...
    private final void fli(int arg0, String arg1)
    {
        try
        {
            ...
            if(!fja)
                fjh.drawImage(fjg, 0, 0, this);
            i += 2;
            k += 90;
            fjb = arg0;
            fjc = arg1;
            fjh.setColor(new Color(42, 42, 142));
            if(fja)
                fjh.setColor(new Color(102, 102, 152));
            fjh.drawRect(i - 2, k - 2, 280, 23);
            fjh.fillRect(i, k, (277 * arg0) / 100, 20);
            fjh.setColor(Color.gray);
            if(fja)
                fjh.setColor(Color.gray);
            flk(fjh, arg1, fjd, i + 138, k + 10);
            if(!fja)
            {
                flk(fjh, "<> No Name Bot Alpha <>", font1, i + 140, k + 30);
                flk(fjh, "\2512005 Stork & Zymoti", font1, i + 140, k + 44);
            } else
            {
                fjh.setColor(new Color(112, 112, 152));
                flk(fjh, "\2512005 Stork & Zymoti", font1, i + 138, fib - 20);
            }
            if(fin != null)
            {
                fjh.setColor(Color.gray);
    ...
    protected byte[] fcb(String arg0, String arg1, int arg2)
    {
        ...
        try
        {
            ...
            flj(arg2, "Loading No Name Bot - "+arg2+"%");
            int l = 0;
            abyte0 = new byte[k];
            while(l < k) 
            {
    ...
    public a()
    {
        ...
        fjf2 = new Font("Arial", 0, 12);
        font1 = new Font("Arial", 1, 12);
        font2 = new Font("Helvetica", 1, 16);
        fjj = false;
        fjk = false;
        fjl = false;
        fjm = false;
    ...
    public Image fjg;
    public Graphics fjh;
    static String fji = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\243$%^&*()-_=+[{]};:'@#~,<.>/?\\| ";
    public boolean fjj;
    public boolean fjk;
    public boolean fjl;
    public boolean fjm;
