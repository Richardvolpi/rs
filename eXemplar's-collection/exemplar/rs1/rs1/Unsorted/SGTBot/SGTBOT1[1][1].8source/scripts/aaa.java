// Decompiled by DJ v3.7.7.81 Copyright 2004 Atanas Neshkov  Date: 7/31/2004 8:47:20 PM
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   aaa.java
...
public class aaa extends fjb
{
    ...
    protected final void aca(String s, String s1, boolean flag)
    {
        if(abj > 0)
        {
            ...
            adb("The server is currently full.", "Please try again later");
            return;
        }
        try
        {
