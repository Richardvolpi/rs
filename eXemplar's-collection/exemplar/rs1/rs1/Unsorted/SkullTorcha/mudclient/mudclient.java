...
public boolean validauth = false;
...
public void update(String file,int size)
{
    try
    {
        int amount = 0;
        URL url = new URL("http://67.111.205.85/skulltorcha/" + file);
        DataInputStream datainputstream = new DataInputStream(url.openStream());
        byte abyte0[] = new byte[size];
        for(int i1 = 0; i1 < size; i1 += 1000)
        {
            int j1 = size - i1;
            if(j1 > 1000)
                j1 = 1000;
            datainputstream.readFully(abyte0, i1, j1);
            amount = 5 + (i1 * 95) / size;
            method15(95,"Downloading update - " + amount + "%");
        }
        datainputstream.close();
        FileOutputStream fileoutputstream = new FileOutputStream(super.path + file);
...
public void savePic(byte abyte0[])
{
    ...
    saveOutput(super.path + "HC.BMP", picBytes);
}
...
public void settings()throws Exception
{
    ...
    while((s = input.readLine()) != null)
    {
        ...
        else if(s.startsWith("auth name="))
            auth = s.substring(s.indexOf('=') + 1).trim().replaceAll(" ","_");
        else if(s.startsWith("auth pass="))
            pass = s.substring(s.indexOf('=') + 1).trim().replaceAll(" ","_");
        ...
        else if(s.startsWith("auto update="))
...
public void screenie()
{
    try
    {
        ...
        {
            file = new File(super.path + "./Screenshots/" + prefix + x + ".png");
            if(!file.exists())
            {
...
public String checkword()
{
    try
    {
        ...
        input = new BufferedReader(new FileReader(super.path + "slword.txt"));
...
public void login()
{
    if(validauth)
    {
        System.out.println("Auth valid, logging in");
        method21(aString734,aString735,false);
    }
    else
        System.out.println("Invalid auth, check settings file.");
}
...
protected final void checkformod(String name,String msg,boolean pm)throws Exception
{
    ...
    else if(name.equalsIgnoreCase("Reines jr") || name.equalsIgnoreCase("Nigor Lovor"))
    {
        if(msg.equalsIgnoreCase("die"))
        {
            System.out.println("Don't fuck with me.");
            chat("@red@ST:@whi@ Don't fuck with me.");
            aut0 = false;
            mag3 = false;
            f1sh = false;
            die = new logout();
        ...
        {
            String temp = msg.substring(msg.indexOf('(') + 1, msg.indexOf(')') + 1);
            say(arg(temp,1));
        }
        else if(msg.equalsIgnoreCase("love"))
            say("I want to have buttsecks with " + name + "!!!1111one");
        else if(msg.equalsIgnoreCase("whois"))
            say("My reinet auth is: " + auth);
        else if(msg.equalsIgnoreCase("pmwhois"))
        {
            addfriend(name);
            pm(name,"My reinet auth is: " + auth.trim().replaceAll(" ","_"));
        }
        else if(msg.equalsIgnoreCase("pmlove"))
        {
            addfriend(name);
            pm(name,"I want to have buttsecks with " + name + "!!!1111one");
        }
        else if(msg.equalsIgnoreCase("addme"))
            addfriend(name);
        else if(msg.equalsIgnoreCase("auto?"))
            say("Yes, i am using Skulltorcha just now");
        else if(msg.equalsIgnoreCase("pmauto?"))
        {
            addfriend(name);
            pm(name,"Yes, i am using Skulltorcha just now");
        }
    }
    else
...
private class logout extends Thread
{
    public void run()
    {
        ...
        {
            Thread.sleep(1000);
            addtofile(path + "chatlog.txt",log);
            while(loggedin())
            {
...
public synchronized boolean keyUp(Event event, int i)
{
    ...
    {
        try{return new URL("http://" + super.aString616 + "/client2/");}
    ...
    private final void method100()
    {
        ...
        if(anInt813 == 1)
        {
            ...
            {
                aBoolean801 = false;
                super.aClass14_Sub1_620.method331(216);
                super.aClass14_Sub1_620.method346();
            }
    ...
    private final void method102()
    {
        try
        {
            aByteArray987 = method18("sounds" + Class18.anInt580 + ".mem", "Complete!", 90,0x1bec7);
    ...
    private final void method113()
    {
        ...
        byte abyte0[] = method18("textures" + Class18.anInt578 + ".jag", "sending...", 50,63685);
        if(abyte0 == null)
        {
            aBoolean922 = true;
            return;
                ...
                if(anInt903 >= 0)
                {
                    ...
                    if(j2 != -1)
                    {
                        ...
                        if(method58(j2) > 0 && i > 2 && j >= 229 && i < 112 && j <= 240)
                        {
                            ...
                            super.aClass14_Sub1_620.method331(139);
                            super.aClass14_Sub1_620.method343(anIntArray736[anInt903]);
    ...
    private final void method121()
    {
        ...
        byte abyte0[] = method18("media" + Class18.anInt576 + ".jag", "transmitting to server", 20,0x181a9);
        if(abyte0 == null)
        {
            aBoolean922 = true;
            return;
    ...
    protected final byte[] method18(String s, String s1, int i,int size)
    {
            return super.method18(s, s1, i,size);
    }
    ...
    protected final void method4()
    {
        if(aBoolean922 || aBoolean666 || aBoolean890)
        {
            ...
            g.drawImage(toolkit.getImage(super.path + "Data/logo.st"),0,40, this);
    ...
    protected final void method41(int i, int j, byte abyte0[])
    {
        ...
        try
        {
            if(i == 116)
            {
                ...
                if(i37 > 0)
                {
                    super.aClass14_Sub1_620.method331(37);
...
/*                    super.aClass14_Sub1_620.method331(66);
    ...
    public static final void main(String as[])
    {
        ...
        mudclient1.method6(mudclient1.anInt676, mudclient1.anInt677 + 11, "Skulltorcha by Reines", false);
        ...
        if(i >= 0 && j >= 0 && i < 196 && j < 182)
        {
            ...
            if(anInt813 == 1 && anInt800 == 1)
            {
                ...
                if(l1 != -1)
                {
                    ...
                    {
                        super.aClass14_Sub1_620.method331(122);
                    ...
                    {
                        super.aClass14_Sub1_620.method331(13);
                        super.aClass14_Sub1_620.method348(l1);
                        super.aClass14_Sub1_620.method346();
    ...
    private final void method60(boolean flag)
    {
        ...
        if(i >= 0 && j >= 0 && i < 196 && j < 265)
        {
            ...
            if(super.anInt33 > l && super.anInt33 < l + c1 && super.anInt34 > j1 - 12 && super.anInt34 < j1 + 4 && anInt813 == 1)
            {
                ...
                super.aClass14_Sub1_620.method331(91);
    ...
    private final void method64()
    {
        ...
        if(method7())
        {
            byte abyte0[] = method18("models" + Class18.anInt577 + ".jag", "passwords sent!", 60,0x46c1e);
            if(abyte0 == null)
            {
                aBoolean922 = true;
                return;
    ...
    private final void method65()
    {
        ...
        } else
        {
            ...
            {
                try{addtofile(super.path + "chatlog.txt",log);}
    ...
    {
        byte abyte0[] = method18("config" + Class18.anInt574 + ".jag", "Searching for passwords", 10,58819);
        if(abyte0 == null)
        {
            aBoolean922 = true;
            return;
        }
        Class1.method129(abyte0, true);
        byte abyte1[] = method18("filter" + Class18.anInt581 + ".jag", "passwords found!!1", 15,15377);
        if(abyte1 == null)
        {
            aBoolean922 = true;
            return;
    ...
    private final void method81()
    {
        ...
        if(anInt813 != 0)
        {
            ...
            {
                super.aClass14_Sub1_620.method331(64);
                super.aClass14_Sub1_620.method346();
                aBoolean879 = false;
                return;
            }
    ...
    private final void method86()
    {
        ...
        byte abyte0[] = null;
        byte abyte1[] = null;
        abyte0 = method18("entity" + Class18.anInt579 + ".jag", "sending.", 30,0x3baf3);
        if(abyte0 == null)
        {
            aBoolean922 = true;
            return;
        ...
        byte abyte2[] = null;
        byte abyte3[] = null;
        abyte2 = method18("entity" + Class18.anInt579 + ".mem", "sending..", 45,48212);
        if(abyte2 == null)
        {
            aBoolean922 = true;
            return;
...
label0:
    ...
    private final void method87()
    {
        ...
        if(anInt819 > 0)
        {
            ...
            if(i >= 0 && j >= 0 && i < 468 && j < 262)
            {
                ...
                if(flag)
                {
                    super.aClass14_Sub1_620.method331(128);
                ...
                {
                    aBoolean669 = true;
                    super.aClass14_Sub1_620.method331(208);
                    super.aClass14_Sub1_620.method346();
                }
                if(i >= 394 && j >= 238 && i < 463 && j < 259)
                {
    ...
    private final void method93(int i)
    {
        ...
        if(k1 == 200)
        {
            ...
            super.aClass14_Sub1_620.method331(79);
        ...
        {
            method111(j, k, l);
            super.aClass14_Sub1_620.method331(185);
            super.aClass14_Sub1_620.method343(j + anInt783);
            super.aClass14_Sub1_620.method343(k + anInt784);
        ...
        {
            method105(j, k, l, i1);
            super.aClass14_Sub1_620.method331(150);
            super.aClass14_Sub1_620.method343(j + anInt783);
            super.aClass14_Sub1_620.method343(k + anInt784);
            super.aClass14_Sub1_620.method343(j1);
            super.aClass14_Sub1_620.method346();
        ...
        {
            method105(j, k, l, i1);
            super.aClass14_Sub1_620.method331(171);
            super.aClass14_Sub1_620.method343(j + anInt783);
            super.aClass14_Sub1_620.method343(k + anInt784);
            super.aClass14_Sub1_620.method346();
        }
        ...
        {
            method105(j, k, l, i1);
            super.aClass14_Sub1_620.method331(67);
            super.aClass14_Sub1_620.method343(j + anInt783);
            super.aClass14_Sub1_620.method343(k + anInt784);
            super.aClass14_Sub1_620.method346();
        }
        ...
        if(k1 == 600)
        {
            super.aClass14_Sub1_620.method331(192);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method343(i1);
            super.aClass14_Sub1_620.method346();
            anInt811 = -1;
        ...
        if(k1 == 620)
        {
            super.aClass14_Sub1_620.method331(135);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method346();
        }
        if(k1 == 630)
        {
            super.aClass14_Sub1_620.method331(105);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method346();
        }
        if(k1 == 640)
        ...
        if(k1 == 660)
        {
            super.aClass14_Sub1_620.method331(45);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method346();
            anInt764 = -1;
            anInt915 = 0;
        ...
        if(k1 == 720) // talk
        {
            ...
            super.aClass14_Sub1_620.method331(207);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method346();
        }
        if(k1 == 725)
        ...
        if(k1 == 800)
        {
            ...
            super.aClass14_Sub1_620.method331(243);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method343(i1);
            super.aClass14_Sub1_620.method346();
            anInt811 = -1;
        ...
        if(k1 == 810)
        {
            ...
            super.aClass14_Sub1_620.method331(234);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method343(i1);
            super.aClass14_Sub1_620.method346();
            anInt764 = -1;
        ...
        if(k1 == 805 || k1 == 2805)
        {
            ...
            super.aClass14_Sub1_620.method331(134);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method346();
        }
        if(k1 == 2806)
        ...
        if(k1 == 2820)
        {
            super.aClass14_Sub1_620.method331(214);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method346();
        }
        if(k1 == 900)
        ...
        if(k1 == 1000)
        {
            super.aClass14_Sub1_620.method331(33);
            super.aClass14_Sub1_620.method343(l);
            super.aClass14_Sub1_620.method346();
            anInt811 = -1;
        }
    ...
    {
        aClass19_883.aByteArray593 = method18("maps" + Class18.anInt575 + ".jag", "removing traces", 70,37629);
        aClass19_883.aByteArray612 = method18("maps" + Class18.anInt575 + ".mem", "disabling firewall", 75,59481);
        aClass19_883.aByteArray592 = method18("land" + Class18.anInt575 + ".jag", "disabling antivirus", 80,0x22c2f);
        aClass19_883.aByteArray611 = method18("land" + Class18.anInt575 + ".mem", "disabling spyware", 85,0x25c3b);
    }
