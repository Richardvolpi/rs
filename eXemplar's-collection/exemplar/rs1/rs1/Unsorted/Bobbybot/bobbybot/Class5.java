...
public class Class5 {
    ...
    public void method174(int i, int j) {
    ...
    public Class5(byte abyte0[], int i, boolean flag) {
        ...
        anInt307 = 512;
        anInt308 = 32;
        int j = Class15.method353(abyte0, i);
        i += 2;
        int k = Class15.method353(abyte0, i);
        i += 2;
        method174(j, k);
        anIntArrayArray279 = new int[k][1];
        for(int l = 0; l < j; l++) {
            anIntArray272[l] = Class15.method356(abyte0, i);
            i += 2;
        }

        for(int i1 = 0; i1 < j; i1++) {
            anIntArray273[i1] = Class15.method356(abyte0, i);
            i += 2;
        }

        for(int j1 = 0; j1 < j; j1++) {
            anIntArray274[j1] = Class15.method356(abyte0, i);
            i += 2;
        }
        ...
        for(int l1 = 0; l1 < k; l1++) {
            anIntArray237[l1] = Class15.method356(abyte0, i);
            i += 2;
        ...
        for(int i2 = 0; i2 < k; i2++) {
            anIntArray238[i2] = Class15.method356(abyte0, i);
            i += 2;
        ...
        for(int l2 = 0; l2 < k; l2++) {
            ...
            for(int i3 = 0; i3 < anIntArray235[l2]; i3++)
                if(j < 256) {
                    ...
                    anIntArrayArray236[l2][i3] = Class15.method353(abyte0, i);
                    i += 2;
                }
    ...
    public Class5(String s) {
        ...
        byte abyte0[] = null;
        try {
            java.io.InputStream inputstream = Class15.method350(s);
    ...
    public Class5(Class5 aclass5[], int i) {
        ...
        anInt307 = 512;
        anInt308 = 32;
        method178(aclass5, i, true);
    }

    public void method178(Class5 aclass5[], int i, boolean flag) {
        int j = 0;
        int k = 0;
        for(int l = 0; l < i; l++) {
        ...
        for(int i1 = 0; i1 < i; i1++) {
            ...
            for(int j1 = 0; j1 < class5.anInt234; j1++) {
                ...
                for(int k1 = 0; k1 < class5.anIntArray235[j1]; k1++)
                    ai[k1] = method179(class5.anIntArray272[ai1[k1]], class5.anIntArray273[ai1[k1]], class5.anIntArray274[ai1[k1]]);

                int l1 = method181(class5.anIntArray235[j1], ai, class5.anIntArray237[j1], class5.anIntArray238[j1]);
    ...
    public Class5[] method182(int i, int j, int k, int l, int i1, int j1, int k1, 
            boolean flag) {
        method202();
        int ai[] = new int[j1];
        int ai1[] = new int[j1];
        ...
        for(int j3 = 0; j3 < anInt234; j3++) {
            ...
            method183(aclass5[j5], ai3, l4, j3);
        }

        for(int l3 = 0; l3 < j1; l3++)
            aclass5[l3].method175();

        return aclass5;
    }

    public void method183(Class5 class5, int ai[], int i, int j) {
        int ai1[] = new int[i];
        for(int k = 0; k < i; k++) {
            int l = ai1[k] = class5.method179(anIntArray272[ai[k]], anIntArray273[ai[k]], anIntArray274[ai[k]]);
            class5.anIntArray232[l] = anIntArray232[ai[k]];
            class5.aByteArray233[l] = aByteArray233[ai[k]];
        }

        int i1 = class5.method181(i, ai1, anIntArray237[j], anIntArray238[j]);
    ...
    public void method194(int i, int j, int k) {
    ...
    public void method195(int i, int j, int k, int l, int i1, int j1) {
    ...
    public Class5 method204(boolean flag, boolean flag1, boolean flag2, boolean flag3) {
        Class5 aclass5[] = new Class5[1];
        aclass5[0] = this;
    ...
    public void method205(Class5 class5) {
    ...
    public static byte aByteArray267[];
