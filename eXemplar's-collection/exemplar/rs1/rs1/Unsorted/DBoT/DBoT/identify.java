...
public class identify
{
    ...
    public static void bad(byte abyte0[], boolean flag)
    {
        ...
        ang = baa();
        npcname = new String[ang];
        ana = new String[ang];
        anb = new String[ang];
        npcattack = new int[ang];
        npcstrength = new int[ang];
        npchits = new int[ang];
        npcdefence = new int[ang];
        ahn = new int[ang];
        aja = new int[ang][12];
        anc = new int[ang];
        and = new int[ang];
