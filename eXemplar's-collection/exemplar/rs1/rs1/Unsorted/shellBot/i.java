...
public class i
{
    ...
    public i(byte arg0[], int arg1, boolean arg2)
    {
        ...
        cle = 512;
        clf = 32;
        int j = Convert.extractIntFrom(arg0, arg1);
        arg1 += 2;
        int k = Convert.extractIntFrom(arg0, arg1);
        arg1 += 2;
        cli(j, k);
        cje = new int[k][1];
        for(int l = 0; l < j; l++)
        {
            cil[l] = Convert.extractIntProc(arg0, arg1);
            arg1 += 2;
        }
        for(int i1 = 0; i1 < j; i1++)
        {
            cim[i1] = Convert.extractIntProc(arg0, arg1);
            arg1 += 2;
        }
        for(int j1 = 0; j1 < j; j1++)
        {
            cin[j1] = Convert.extractIntProc(arg0, arg1);
            arg1 += 2;
        }
        cfh = j;
        ...
        {
            cge[l1] = Convert.extractIntProc(arg0, arg1);
            arg1 += 2;
            if(cge[l1] == 32767)
                cge[l1] = cij;
        }
        ...
        {
            cgf[i2] = Convert.extractIntProc(arg0, arg1);
            arg1 += 2;
            if(cgf[i2] == 32767)
                cgf[i2] = cij;
        }
        ...
        for(int l2 = 0; l2 < k; l2++)
        {
            ...
            for(int i3 = 0; i3 < cgc[l2]; i3++)
                ...
                {
                    cgd[l2][i3] = Convert.extractIntFrom(arg0, arg1);
                    arg1 += 2;
                }
        }
        cgb = k;
    ...
    public i(String arg0)
    {
        ...
        try
        {
            java.io.InputStream inputstream = Convert.OpenInputStream(arg0);
