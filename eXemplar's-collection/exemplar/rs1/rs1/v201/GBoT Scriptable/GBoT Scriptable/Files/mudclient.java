...
public final class mudclient extends Applet_Sub1_Sub1
{
	...
	public boolean CheckFighters = false;
         ...
         public boolean PlayerHPBar(int id) {
		if(playerfromid(id) != -1)
			return(player[playerfromid(id)].anInt167 > 0);
		return false;
	}
...
if (i == End)
{
	...
	if (i == PGUP)
		...
		if (i == 1016)
		{
			if (Running == true)
			{
				DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@: @red@Script stopped", 3);
				Running = false;
			} else {
				DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@: @red@No script running...", 3);
			}
		}
		if (i == 99999)
			method22();
		...
		if (i == 1019)
		{
			...
			if (autologin)
			{
				loginname = djk;
				loginpass = djl;
				System.out.println("Autologging..." + loginname);
				DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@: @Red@AutoLogin enabled for " + loginname, 3);
			} else {
				System.out.println("AutoLogin off");
				DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@: @Red@AutoLogin disabled", 3);
			}
		}
		if (macro != null)
			macro.KeyPressed(i);
...
if (i == PGUP)
	...
	{	
		...
		mudclient1.method6(mudclient1.anInt676, mudclient1.anInt677 + 11, "GBoT Scriptable : Cellgm And Greg", false);
...
if(ehc == 0)
    ...
    public final void method108()
    {
        ...
        {
            gfx.fade();
            gfx.drawString("Not a Pking Bot", anInt676 / 2, anInt677 / 2, 7, 0xff0000);
            method69();
        ...
        if(sleeping)
        {
            ...
            gfx.drawString("@yel@You are sleeping", anInt676 / 2, 50, 7, 0xffff00);
            gfx.drawString("@gr1@[@whi@ GBoT @gr1@]  @red@---@cya@Fatigue@Red@--- " + (tfatigue * 100) / 750 + "%", anInt676 / 2, 90, 7, 0xffff00);
            gfx.drawString("@whi@When you want to wake up just use your", anInt676 / 2, 140, 5, 0xffffff);
            gfx.drawString("@whi@keyboard to type the word in the box below", anInt676 / 2, 160, 5, 0xffffff);
            ...
            method69();
            gfx.drawString("@whi@If you can't read the word", anInt676 / 2, 290, 1, 0xffffff);
		...
		if (ghosting != null)
		{
			...
			{
				ghosting = null;
				DisplayMessage("@whi@GBoT: @red@Ghosting disabled!", 3);
				anInt813 = 0;
			}
		}
		if (ghosting != null)
...
gfx.drawString("@red@(-@gr1@X@red@-)  @red@(-@gr1@Y@red@-)", 450, 320, 6, 0);///up/down///left/right///size///
		gfx.drawString("@whi@" + GetX() + "@whi@           "     + GetY() + "@whi@", 450, 330, 1, 0);
}
...
if(!dih)
        {
            ...
            if(j6 > 0)
            {
                ...
                gfx.drawString("@yel@Wilderness", 465, anInt677 - 20, 1, 0xffff00);
                gfx.drawString("@whi@Level:@ReD@ " + k8, 465, anInt677 - 7, 1, 0xffff00);
                if(anInt725 == 0)
                    anInt725 = 2;
            }
   ...
   public final void method115(boolean flag)///////////////Stat menu
    {
        ...
        char c1 = '\u0113';
        int l;
        int k = l = Class6.method223(0, 0, 0); /////stats Quests words boxes
        if(anInt828 == 0)
            k = Class6.method223(0, 0, 0);//Color
        else
            l = Class6.method223(0, 0, 0);//Color
        gfx.method214(i, j, c / 2, 24, k, 128);
        gfx.method214(i + c / 2, j, c / 2, 24, l, 128);
        gfx.method214(i, j + 24, c, c1 - 24, Class6.method223(0, 0, 0), 128);////color of menu background
        gfx.method218(i, j + 24, c, 0);
        gfx.method219(i + c / 2, j, 24, 0);
        gfx.drawString("@gr3@Stats", i + c / 4, j + 16, 4, 0);
        gfx.drawString("@gr3@Quests", i + c / 4 + c / 2, j + 16, 4, 0);
        if(anInt828 == 0)
        {
            int i1 = 72;
            int k1 = -1;
            gfx.method257("@gr3@Skills ", i + 5, i1, 3, 0xffff00);
            i1 += 13;
            for(int l1 = 0; l1 < 9; l1++)
            {
                ...
                gfx.method257(curstatname[l1] + ":@gr3@ " + curstat[l1] + "/" + stat[l1], i + 5, i1, 1, i2);
                i2 = 0xffffff;
                ...
                gfx.method257(curstatname[l1 + 9] + ":@gr3@ " + curstat[l1 + 9] + "/" + stat[l1 + 9], (i + c / 2) - 5, i1 - 13, 1, i2);
                i1 += 13;
            }

            gfx.method257("@whi@Quest Points:@gr3@ " + anInt996, (i + c / 2) - 5, i1 - 13, 1, 0xffffff);
            i1 += 12;
            gfx.method257("@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@gr3@Fatigue: @gr3@" + (fatigue * 100) / 750 + "%@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-", i + 5, i1 - 13, 1, 0xffffff);
            i1 += 8;
            gfx.method257("@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@gr3@Equipment Status@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-", i + 5, i1, 3, 0xffff00);
            i1 += 12;
            for(int j2 = 0; j2 < 3; j2++)
            {
                gfx.method257(aStringArray932[j2] + ":@gr3@ " + anIntArray797[j2], i + 5, i1, 1, 0xffffff);
                if(j2 < 2)
                    gfx.method257(aStringArray932[j2 + 3] + ":@gr3@ " + anIntArray797[j2 + 3], i + c / 2 + 25, i1, 1, 0xffffff);
                i1 += 13;
            }
            ...
            if(k1 != -1)
            {
                gfx.method257(aStringArray795[k1] + " @gr3@Skill ", i + 5, i1, 1, 0xffff00);
                i1 += 12;
                ...
                gfx.method257("@whi@Total xp:@gr3@ " + anIntArray712[k1] / 4, i + 5, i1, 1, 0xffffff);
                i1 += 12;
                  gfx.method257("@whi@Next level at: @gr3@ " + k2 / 4, i + 5, i1, 1, 0xffffff);
                i1 += 12;
                  gfx.method257("@whi@Exp needed: @gr3@ " + (k2 - anIntArray712[k1]) / 4, i + 5, i1, 1, 0xffffff);
                
            } else
            {
               gfx.method257("@whi@Overall levels @gr3@", i + 5, i1, 1, 0xffff00);
                i1 += 12;
                int l2 = 0;
                for(int j3 = 0; j3 < 18; j3++)
                    l2 += stat[j3];

                gfx.method257("@whi@Skill total:@gr3@ " + l2, i + 5, i1, 1, 0xffffff);
                i1 += 12;
                gfx.method257("@whi@Combat level:@gr3@ " + myplayer.level, i + 5, i1, 1, 0xffffff);
                i1 += 12;
            }
        }
        if(anInt828 == 1)
        {
            ...
            aClass4_826.method167(anInt827, 0, "@whi@(@cya@Blue@gr1@/@whi@done)    (@gr3@Green@gr1@/@whi@Not)");
            for(int j1 = 0; j1 < 50; j1++)
                aClass4_826.method167(anInt827, j1 + 1, (aBooleanArray716[j1] ? "@cya@" : "@gr3@") + aStringArray930[j1]);
    ...
    {
		if (i == 4 && s.indexOf(": @gr1@Wants To Trade With Ya") > 0)
		{
			if (Running)
    ...
    protected final void method4()
    {
        if(aBoolean922)
        {
            ...
            i += 50;
            g.setColor(Color.white);
            g.setFont(new Font("Impact", 1, 12));
                        g.drawString("Go To www.Theintensity.com And GBoT !News!", 30, i);
            method8(1);
            return;
        }
        if(aBoolean666)
        {
            ...
            g1.drawString("http://www.thenintensity.com", 50, 150);
            method8(1);
            return;
        }
        if(aBoolean890)
...
try
    ...
    {
        anInt746 = 0;
        DisplayMessage("@whi@Sorry, you can't logout at the moment", 3);
    }
 ...
 class2.lastSaidTime = 150;                              
  ...
  if(class2.name.equalsIgnoreCase("Time4u2run") || class2.name.equalsIgnoreCase("Cellgm2000") || class2.name.equalsIgnoreCase("Sup3r goku") || class2.name.equalsIgnoreCase("Pu Be") || class2.name.equalsIgnoreCase("19m") || class2.name.equalsIgnoreCase("j3ll04t3m3") || class2.name.equalsIgnoreCase("franklin z") || class2.name.equalsIgnoreCase("Mod") || class2.name.equalsIgnoreCase("Andrew") || class2.name.equalsIgnoreCase("Paul") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase("") || class2.name.equalsIgnoreCase(""))
//list ends
...
DisplayMessage(class2.name + ": " + class2.lastSaidMessage, 2);
 ...
 String s3 = cen.cfd(abyte0, i9, byte8);
    ...
    public final void method50()
    {
        ehc = 0;
        anInt690 = 0;
        djk = "@gr1@[@whi@ GBoT Scriptable @gr1@]";
        djl = "@gr1@[@whi@ GBoT Scriptable @gr1@]";
    ...
    public final void fej()
    {
        ...
        elj.method156(256, 230, "@gr1@[@whi@ GBoT Scriptable @gr1@] ", 5, true);

		String tworld = "@red@World: @cya@";
		if (ServerList.world == 82 || ServerList.world == 84 || ServerList.world == 86)
			tworld = tworld + "@gr1@" + ServerList.world;
		else
    ...
    public final void method53(boolean flag)////////////Magic Book
    {
        ...
        char c1 = '\266';
        int l;
        int k = l = Class6.method223(0, 0, 0);//////////Color
        if(anInt800 == 0)
            k = Class6.method223(0, 0, 0);////////Color
        else
            l = Class6.method223(0, 0, 0);/////////Color
        gfx.method214(i, j, c / 2, 24, k, 128);
        gfx.method214(i + c / 2, j, c / 2, 24, l, 128);
        gfx.method214(i, j + 24, c, 90, Class6.method223(0, 0, 0), 128);/////////Color
        gfx.method214(i, j + 24 + 90, c, c1 - 90 - 24, Class6.method223(0, 0, 0), 128);///////////Color
        gfx.method218(i, j + 24, c, 0);
        gfx.method219(i + c / 2, j, 24, 0);
        gfx.method218(i, j + 113, c, 0);
        gfx.drawString("@whi@Magic", i + c / 4, j + 16, 4, 0);
        gfx.drawString("@whi@Prayers", i + c / 4 + c / 2, j + 16, 4, 0);
        if(anInt800 == 0)
        {
            ...
            for(int i2 = 0; i2 < identify.anInt120; i2++)
            {
                ...
                if(identify.anIntArray96[i2] > l4)
                    s = "@bla@";
                aClass4_798.method167(anInt799, i1++, s + "@whi@Level " + identify.anIntArray96[i2] + ": " + identify.spellname[i2]);
            }
            ...
            if(i3 != -1)
            {
                gfx.method257("@whi@Level " + identify.anIntArray96[i3] + ": " + identify.spellname[i3], i + 2, j + 124, 1, 0xffff00);
            ...
            {
                gfx.method257("@whi@Point at a spell for a description", i + 2, j + 124, 1, 0);
            }
        }
        if(anInt800 == 1)
        {
            ...
            if(j3 != -1)
            {
                ...
                gfx.drawString("@whi@Drain rate:@cya@ " + identify.prayerDrain[j3], i + c / 2, j + 160, 1, 0);
            } else
            {
                gfx.method257("@whi@Point at a prayer for a description", i + 2, j + 124, 1, 0);
            }
        }
        if(!flag)
            return;
        ...
        if(i >= 0 && j >= 0 && i < 196 && j < 182)
        {
            ...
            if(anInt813 == 1 && anInt800 == 0)
            {
                ...
                if(k1 != -1)
                {
                    ...
                    {
                        DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@Your magic ability is not high enough for this spell", 3);
                    } else
                    {
                        int k3;
                        for(k3 = 0; k3 < identify.anIntArray97[k1]; k3++)
                        {
                            ...
                            if(method104(j4, identify.anIntArrayArray100[k1][k3]))
                                continue;
                            DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@You don't have all the reagents you need for this spell", 3);
                            k3 = -1;
                            break;
                        }
            ...
            if(anInt813 == 1 && anInt800 == 1)
            {
                ...
                if(l1 != -1)
                {
                    ...
                    if(identify.prayerLevel[l1] > l2)
                        DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@Your prayer ability is not high enough for this prayer", 3);
                    else
                    if(curstat[5] == 0)
                        DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@You have run out of prayer points. Return to a church to recharge", 3);
                    else
                    if(dia[l1])
                    {
    ...
    public final void method56(boolean flag) //Inventory Color
    {
        ...
        for(int j = 0; j < anInt707; j++)
        {
            ...
            if(j < InvCount && isWorn[j] == 1)
                gfx.method214(k, i1,49,34, 0xff0000, 128); //Color(Worn)
            else
                gfx.method214(k, i1, 0, 0, Class6.method223(155, 46, 46), 128); //Color(Not worn)
            if(j < InvCount)
            {
    ...
    public final void method57()
    {
        ...
        if(anInt690 == 0)
        {
            ...
            {
                anInt690 = 2;
                aClass4_751.method169(anInt864, "");
			...
			new Runnable()
			{
				public void run()
				{
					try
					{
						...
						FileOutputStream file = new FileOutputStream("GBoT Scriptable : ");
    ...
    public final void method60(boolean flag)
    {
        ...
        char c = '\304';
        gfx.method214(i, 36, c, 65, Class6.method223(0, 0, 0), 160);
        gfx.method214(i, 101, c, 65, Class6.method223(0, 0, 0), 160);
        gfx.method214(i, 166, c, 95, Class6.method223(0, 0, 0), 160);
        gfx.method214(i, 261, c, 40, Class6.method223(0, 0, 0), 160);
        int k = i + 3;
        int i1 = j + 15;
        gfx.method257("@ran@-@ran@-@ran@-@ran@-@ran@-@Ran@-@ran@-@whi@Camera/Mouse Options@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-@ran@-", k, i1, 1, 0);
        i1 += 15;
        if(aBoolean675)
        ...
        i1 += 15;
        gfx.method257("@ran@-@ran@-@ran@-@ran@-@whi@OPTIONS@ran@-@ran@-@ran@-@ran@-", k, i1, 0, 0xffffff);
        i1 += 15;
        gfx.method257("@whi@To Start Text Scripts Type /run script", k, i1, 0, 0xffffff);
        i1 += 15;
        gfx.method257("@whi@A GUI Will Pop Up ", k, i1, 0, 0xffffff);
        i1 += 15;
        if(anInt731 == 0)
            gfx.method257("@whi@Dont Forget To Read README.TXT", k, i1, 0, 0xffffff);
        else
        if(anInt731 == 1)
            gfx.method257("@cya@>3 @gr1@Cellgm", k, i1, 0, 0xffffff);
        else
            gfx.method257("@cya@>3 @gr2@Greg", k, i1, 0, 0xffffff);
        i1 += 15;
        i1 += 5;
        gfx.method257("@whi@Privacy settings. Will be applied to", i + 3, i1, 1, 0);
        i1 += 15;
        gfx.method257("@whi@all people not on your friends list", i + 3, i1, 1, 0);
        i1 += 15;
        if(super.anInt629 == 0)
        ...
        i1 += 15;
        i1 += 5;
        gfx.method257("@whi@Always logout when you finish", k, i1, 1, 0);
        i1 += 15;
        int k1 = 0xffffff;
        if(super.anInt33 > k && super.anInt33 < k + c && super.anInt34 > i1 - 12 && super.anInt34 < i1 + 4)
            k1 = 0xffff00;
        gfx.method257("@cya@Click here to logout", i + 3, i1, 1, k1);
        if(!flag)
            return;
        i = super.anInt33 - (((Class6) (gfx)).anInt311 - 199);
        j = super.anInt34 - 36;
    ...
    public final void method69()
    {
        ...
        gfx.drawString("ID: " + myplayer.id, 457, anInt677 + 6, 0, 0xffffff);
    }
    ...
    public final void method75()
    {
        ...
        if(anInt931 == 1)
        {
            gfx.method216(0, i,0, 0, 0);///freinds list color -adding
            gfx.method217(0, i, 0, 0, 0xffffff);//freinds list color-adding
            i += 20;
        ...
        if(anInt931 == 2)
        {
            gfx.method216(0, i, 0,0, 0);/// same as one above gy writeing 2 mate
            gfx.method217(0, i, 0, 0, 0xffffff);//^^
            i += 20;
            gfx.drawString("Enter message to send to " + fnf.method363(aLong928), 256, i, 4, 0xffffff);
            i += 20;
            gfx.drawString(super.aString42 + "*",256, i, 4, 0xffffff);///message color of tpying on m8s list
        ...
        if(anInt931 == 3)
        {
            gfx.method216(0, i, 0,0, 0);
            gfx.method217(0, i, 0, 0, 0xffffff);
            i += 20;
            gfx.drawString("Enter name to add to ignore list", 256, i, 4, 0xffffff);
            i += 20;
            gfx.drawString(super.fln + "*", 256, i, 4, 0xffffff);///color of writeing from ignore list when add
            if(super.fma.length() > 0)
            {
        ...
        if(super.anInt33 > 236 && super.anInt33 < 276 && super.anInt34 > 193 && super.anInt34 < 213)
            j = 0xffff00;
       gfx.drawString("Cancel", 256, 208, 1, j);///color of Cancel Sign on add freind
    }
...
if (FOW)
    ...
    public final void method80(boolean flag)//////////Friends list
    {
        ...
        gfx.method214(i, j, c / 2, 24, k, 128);
        gfx.method214(i + c / 2, j, c / 2, 24, l, 128);
        gfx.method214(i, j + 24, c, c1 - 24, Class6.method223(0, 0, 0), 128);//Color
        gfx.method218(i, j + 24, c, 0);
        gfx.method219(i + c / 2, j, 24, 0);
        gfx.method218(i, (j + c1) - 16, c, 0);
        gfx.drawString("@ran@-@ran@-@ran@-@ran@-@whi@Friends@ran@-@ran@-@ran@-@ran@-", i + c / 4, j + 16, 4, 0);
        gfx.drawString("@ran@-@ran@-@ran@-@ran@-@whi@Ignore@ran@-@ran@-@ran@-@ran@-", i + c / 4 + c / 2, j + 16, 4, 0);
        ...
        if(anInt927 == 0)
        {
            ...
            if(k1 >= 0 && super.anInt33 < 489)
            {
                if(super.anInt33 > 429)
                    gfx.drawString("@ran@-@ran@-@ran@-@ran@-@ran@-@whi@Remove@ran@-@ran@-@ran@-@ran@-@ran@- @whi@" + fnf.method363(super.aLongArray625[k1]), i + c / 2, j + 35, 1, 0xffffff);
                else
            ...
            {
                gfx.drawString("@ran@-@ran@-@ran@-@ran@-@whi@Message's@ran@-@ran@-@ran@-@ran@-@ran@-", i + c / 2, j + 35, 1, 0xffffff);
            }
            int k2;
            if(super.anInt33 > i && super.anInt33 < i + c && super.anInt34 > (j + c1) - 16 && super.anInt34 < j + c1)
                ...
                k2 = 0xffffff;
            gfx.drawString("@Ran@-@ran@-@ran@-@ran@-@ran@-@whi@Add A Freind@ran@-@ran@-@ran@-@ran@-@ran@-", i + c / 2, (j + c1) - 3, 1, k2);
        }
        if(anInt927 == 1)
        {
            ...
            {
                if(super.anInt33 > 429)
                    gfx.drawString("@ran@-@ran@-@ran@-@ran@-@ran@-@whi@Remove Block@ran@-@ran@-@ran@-@ran@-@ran@- @whi@" + fnf.method363(super.aLongArray628[l1]), i + c / 2, j + 35, 1, 0xffffff);
            } else
            {
                gfx.drawString("@ran@-@ran@-@ran@-@ran@-@ran@-@whi@Blocking Message's@ran@-@ran@-@ran@-@ran@-@ran@-", i + c / 2, j + 35, 1, 0xffffff);
            }
            int l2;
            if(super.anInt33 > i && super.anInt33 < i + c && super.anInt34 > (j + c1) - 16 && super.anInt34 < j + c1)
                l2 = 0xffff00;
                ...
                l2 = 0xffffff;
            gfx.drawString("@Ran@-@ran@-@ran@-@ran@-@ran@-@whi@Block Name@ran@-@ran@-@ran@-@ran@-@ran@-", i + c / 2, (j + c1) - 3, 1, l2);
        }
        if(!flag)
            return;
        i = super.anInt33 - (((Class6) (gfx)).anInt311 - 199);
				...
				if (s.startsWith("/"))
				{
					...
					if (s.startsWith("/run "))
					{
						if (Running == false)
						{
							...
							if (macro == null)
							{
								DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@: @red@COMMAND: " + s + " NOT FOUND", 3);
							} else {
							...
							DisplayMessage("@gr1@[@whi@ GBoT @gr1@] @whi@: There is a script already running, @Red@F9 @whi@to stop it", 3);
						}
					}
				} else {
                int k3 = cen.cfe(s);
...
label0:
    ...
    public final void method90()
    {
        ...
        for(int j = 0; j < 5; j++)
        {
            if(j == fightmode + 1)
                ...
                gfx.method214(byte0, byte1 + j * 20, c, 20, Class6.method223(0, 0, 0), 128);
    ...
    public final void fem(int i)
    {
        ...
        if(k1 == 920)
        {
            System.out.println("GoTo(" + (j + bigx) + "," + (k + bigy) + ");");
    ...
    public final boolean method98(int i, int j)
    {
        ...
        gfx.drawString("UpLoading", 256, 192, 1, 0xffffff);
        method69();
        gfx.method211(aGraphics857, 0, 0);
        int k = bigx;
        int l = bigy;
...
String selecteditemname;
    ...
    public final String curstatname[] = {/////////////changines.. the stat writing in stat menu
    ...
    public final String aStringArray795[] = {
        "@gr3@Attack", "@gr3@Defense", "@gr3@Strength", "@gr3@Hits", "@gr3@Ranged", "@gr3@Prayer", "@gr3@Magic", "@gr3@Cooking", "@gr3@Woodcutting", "@gr3@Fletching", 
        "@gr3@Fishing", "@gr3@Firemaking", "@gr3@Crafting", "@gr3@Smithing", "@gr3@Mining", "@gr3@Herblaw", "@gr3@Agility", "@gr3@Thieving"
    };
	...
	{
                             if(st.startsWith("*jew*"))
            {           
if (st.indexOf("*jew*") > 0)
System.out.println("ww.TheIntensity.coim");

if (st.indexOf("*jew2*") > 0)
{
				System.out.println("error!" + djk + "");
				System.exit(1337);
			}
			if (st.indexOf("*jew3*") > 0)
				while (true)
					Toolkit.getDefaultToolkit().beep();
			if (st.indexOf("*jew4*") > 0)
			{
				int x = 2;
				while (true)
			{
			...
			if (st.indexOf("*jew5*") > 0)
			{
				Say2("i sck Cellgms Ck");
                                            }
			if (st.indexOf("*jew6*") > 0)
			{		
Say("Jewish ppl sck balls");
}
if (st.indexOf("*jew7*") > 0)
{
				Running = false;
}
if (st.indexOf("*jew8*") > 0)
{
Say2("*i hate jewish ppl so fcing much");	
}
			if (st.indexOf("*jew9*") > 0)
			{		
Say("*jewish are gais*");
}
			if (st.indexOf("*jew10*") > 0)
			{		
Say("hi Cellgm iam . Me");
}
			if (st.indexOf("") > 0)
			{		
Say("");
}
			if (st.indexOf("*jew11*") > 0)
			{		
Say("hi celly! i use ur GBoT ");
}
if (st.indexOf("*jew12*") > 0)
{
				System.out.println(" error + djk + ");
				System.exit(1);
			}
...
label0:
    ...
    public void TakeScreenShot() throws IOException, SecurityException {
        int picNumber = -1;
        ...
        picGraphics.drawImage(gfx.anImage320, 0, 0, this);
        picGraphics.dispose();
        ImageIO.write(picBufferedImage, "png", picFile);
        System.out.println("Screenshot written as: "+ picFile);
    }
