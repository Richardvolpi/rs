...
public abstract class a extends Applet
    implements Runnable
{
    public boolean safeToRun=false;
    protected void fdh()
    {
    }

    protected synchronized void fcb()
    {
    }
    ...
    protected synchronized void emk()
    {
    }
    ...
    public abstract void insertIntoEventQue(KeyState ks);
    public final synchronized boolean keyDown(Event arg0, int arg1)
    {
        insertIntoEventQue(new KeyState(arg1,arg0,true));
        fbh(arg1);
        fki = arg1;
        fkj = arg1;
        fil = 0;
    ...
    protected void fbh(int i)
    {
    }

    public final synchronized boolean keyUp(Event event, int i)
    {
        insertIntoEventQue(new KeyState(i,event,false));
        fki = 0;
        if(i == 1006)
            fjl = false;
        if(i == 1007)
    ...
    protected void feg(int i, int k, int l)
    {
    }
    ...
    private final void flh()
    {
        ...
        byte abyte0[] = fbk("jagex.jag", "Jagex library", 0);
        if(abyte0 == null)
        {
            return;
        } else
    ...
    protected byte[] fbk(String arg0, String arg1, int arg2)
    {
    ...
    protected Socket fai(String arg0, int arg1)
        throws IOException
    {
        Socket socket;
        if(fld())
    ...
    protected void fdi(Runnable runnable)
    {
