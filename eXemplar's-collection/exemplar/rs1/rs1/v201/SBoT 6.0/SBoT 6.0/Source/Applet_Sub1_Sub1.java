...
public class Applet_Sub1_Sub1 extends Applet_Sub1
{
    ...
    public final void method26(int i, int j)
    {
            ...
            for(int i2 = 0; i2 < anInt624; i2++)
                if(aLongArray625[i2] == l)
                {
                    if(anIntArray626[i2] == 0 && j1 != 0)
                        method42("@pri@" + fnf.method363(l) + " has logged in");
                    if(anIntArray626[i2] != 0 && j1 == 0)
                        method42("@pri@" + fnf.method363(l) + " has logged out");
                    anIntArray626[i2] = j1;
                    j = 0;
                    method27();
                    return;
        ...
        if(i == 230)
        {
            ...
            method42("@pri@" + fnf.method363(l1) + ": tells you " + s1);
            return;
        } else
        {
    ...
    protected final void method32(long l)
    {
        ...
        method42("@pri@" + fnf.method363(l) + " has been removed from your friends list");
    }
