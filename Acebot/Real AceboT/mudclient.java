...
public int WhatMode = 1;
public boolean AutoSet = true;
public double praynum = 0;
public double stylenum = 0;
public boolean food;
private AutoFisher AW;
boolean autoFisher = false;
    ...
    public static final void main(String args[])
    {
        ...
        mudclient1.flc(mudclient1.dch, mudclient1.dci + 11, "AceboT By Ace and xZoLx", false);
        mudclient1.fkd = 10;
    }
   ...
   { 
       ...
       public boolean isPrayOn(int type)
    {               
        return eeh[type];
    }
    public int cbtstyle() {
...
public void thieveNpc(int l)
    {
        fbk(djd, dje, (dgf[l].gmh - 64) / ehd,(dgf[l].gmi - 64) / ehd, true); 
        super.aag.hcn(83);
 ...
 //   }
    ...
    */
    ...
    public void objectCmd2(int idx) {
        ...
        if(idx < 0 || idx >= getNumObjects()) {
           // fdj("@cya@Object " + idx + " couldn't be found");
        } else {
            dga[ejf] = 2400;
            dfl[ejf] = ekm[idx];
            dfm[ejf] = ekn[idx];
    ...
    public int wildernessLvl() {

     int c = 2203 - (dje + eaj + dnj);
...
public void bankDeposit(int id, int amount) {
...
public void bankWithdraw(int id, int amount) {
...
public boolean questCompleted(int quest) {
...
public File HCPath = new File("../HC.bmp"); public File SLPath = new File("../slword.txt"); public void sendWord(String word) { super.aag.hcn(142); super.aag.hdc(word); super.aag.hdl(); super.fkl = ""; super.fkm = ""; del = "Please wait..."; } public void startedSleeping(byte[] pic) { try { if (!SLPath.exists()) SLPath.createNewFile(); word = "NOT-YET-RECIEVED"; slLastMod = SLPath.lastModified(); lastSentSleepReq = 0; savePic(pic); } catch(Exception e) {} } public long slLastMod=0, lastSentSleepReq=0; public long lastChecked=0; public String word = "NOT-YET-RECIEVED"; public void CheckWords(){ if(den){ if (word.equals("NOT-YET-RECIEVED")) { if (lastChecked+500 < System.currentTimeMillis() && SLPath.lastModified() != slLastMod) { lastChecked = System.currentTimeMillis(); slLastMod = SLPath.lastModified(); try { word = new BufferedReader(new FileReader(SLPath)).readLine(); System.out.println("The word is " + word); } catch (Exception e) {} } } else if (getSleepingFatigue() < 4) { System.out.println("Sending word " + word); sendWord(word.trim()); word = "NOT-YET-RECIEVED"; } } return; } public void savePic(byte abyte0[]) { int i1 = 1; byte byte0 = 0; int j1; byte picBytes[] = new byte[10200]; for(j1 = 0; j1 < 255;) { int k1 = abyte0[i1++] & 0xff; for(int i2 = 0; i2 < k1; i2++) picBytes[j1++] = byte0; byte0 = (byte)(255 - byte0); } for(int l1 = 1; l1 < 40; l1++) { for(int j2 = 0; j2 < 255;) { int k2 = abyte0[i1++] & 0xff; for(int l2 = 0; l2 < k2; l2++) { picBytes[j1] = picBytes[j1 - 255]; j1++; j2++; } if(j2 < 255) { picBytes[j1] = (byte)(255 - picBytes[j1 - 255]); j1++; j2++; } } } saveOutput("../HC.bmp", picBytes); System.out.println("Drawing HC.bmp"); } public void saveOutput(String s1, byte abyte0[]) { try { FileOutputStream fileoutputstream = new FileOutputStream(s1); fileoutputstream.write(66); fileoutputstream.write(77); int i1 = 1342; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); fileoutputstream.write(0); fileoutputstream.write(0); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 62; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 40; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 256; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 40; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 1; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); i1 = 1; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); i1 = 0; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 0; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 0; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 0; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 0; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); i1 = 0; fileoutputstream.write(i1 & 0xff); fileoutputstream.write(i1 >> 8 & 0xff); fileoutputstream.write(0); fileoutputstream.write(0); fileoutputstream.write(0); fileoutputstream.write(0); fileoutputstream.write(0); fileoutputstream.write(0); fileoutputstream.write(255); fileoutputstream.write(255); fileoutputstream.write(255); fileoutputstream.write(0); int j1 = 9945; for(int k1 = 0; k1 < 40; k1++) { for(int l1 = 0; l1 < 32; l1++) { byte byte0 = 0; for(int i2 = 0; i2 < 8; i2++) { byte0 = (byte)(2 * byte0); if(l1 != 31 || i2 != 7) { if(abyte0[j1] != 0) byte0++; j1++; } } fileoutputstream.write(byte0); } j1 -= 510; } fileoutputstream.close(); } catch(Exception e){System.out.println(e);} } 
   ...
   if(j2 == 3710)
{
	...
	if(autofighter)
	smacro = new script();
	fdj("@cya@AceboT: @whi@Autofighter started", 3);
	fdj("@whi@NPC ID set to: @cya@" + npcNum, 3); 
}
    ...
    private final void enk()
    {
        ...
        if(!egi)
        {
            eki.gfd(256, 200 + l, "@whi@Acebot201 By Ace", 5, true);
            eki.gfe(156, 240 + l, 120, 35);
            eki.gfe(356, 240 + l, 120, 35);
            eki.gfd(156, 240 + l, "@cya@News", 5, false);
            eki.gfd(356, 240 + l, "@blu@Login", 5, false);
        ...
        dla = new h(dnb, 50);
        l = 230;
        eej = dla.gfd(256, l - 10, "Ent3r Y0ur Us3rN4m3", 4, true);
        l += 28;
        ...
        l -= 55;
        dla.gfe(295, 258, 95, 40);
        dla.gfd(295, 248, "Auth. Name:", 4, false);
        auth = dla.gfj(295, 268, 95, 40, 4, 20, false, false);
        l += 30;
        dla.gfe(295, 305, 95, 40);
        dla.gfd(295, 295, "Auth. Pass:", 4, false);
        auth2 = dla.gfj(295, 315, 95, 40, 4, 20, true, false);
        l += 30;
        dla.gfe(410, 258, 120, 25);
        dla.gfd(410, 258, "Ok", 4, false);
        eem = dla.gfl(410, 258, 120, 25);
        l += 30;
        dla.gfe(410, 305, 120, 40);
        dla.gfd(410, 295, "World:", 4, false);
        serv = dla.gfj(410, 315, 120, 40, 4, 20, false, false);
        dla.ggg(eek);
    }
...
return new URL("http://" + super.aac + "/client2/"); 
    ...
    private final void fag(boolean arg0)
    {
        ...
        int j1 = l + 3;
        int l1 = i1 + 15;
        dnb.cdn("@cya@Currently on world - @ora@" + server, j1, l1, 1, 0);
        l1 += 15;
        if(dka)
        ...
        l1 += 15;
        if(lefty)
                dnb.cdn("Player One-Click - @gre@On", j1, l1, 1, 0xffffff);
            else
                dnb.cdn("Player One-Click - @red@Off", j1, l1, 1, 0xffffff);
        l1 += 15;
        if(foodType == 0)
        {
            dnb.cdn("Food Type: @gre@Lobster", j1, l1, 1, 0xffffff);
            foodName = "Lobster";
            foodID = 373;
        } else
        if(foodType == 1)
        {
            dnb.cdn("Food Type: @gre@Trout", j1, l1, 1, 0xffffff);
            foodName = "Trout";
            foodID = 359;
        } else
        if(foodType == 2)
        {
            dnb.cdn("Food Type: @gre@Tuna", j1, l1, 1, 0xffffff);
            foodName = "Tuna";
            foodID = 367;
        } else
        if(foodType == 3)
        {
            dnb.cdn("Food Type: @gre@Swordfish", j1, l1, 1, 0xffffff);
            foodName = "Swordfish";
            foodID = 370;
        } else
        if(foodType == 4)
        {
            dnb.cdn("Food Type: @gre@Salmon", j1, l1, 1, 0xffffff);
            foodName = "Salmon";
            foodID = 357;
        }
        l1 += 15;
        if(showInfo)
                dnb.cdn("Info Menu - @gre@On", j1, l1, 1, 0xffffff);
            else
                dnb.cdn("Info Menu - @red@Off", j1, l1, 1, 0xffffff);
        l1 += 15;       
        if(prayercomb == 0)
        {
            dnb.cdn("Prayer Combo: @gre@Burst", j1, l1, 1, 0xffffff);
            prayername = "Burst";
            prayerid = 1;
            prayerdot = 1;
        } else
        if(prayercomb == 1)
        {
            dnb.cdn("Prayer Combo: @gre@Superhuman", j1, l1, 1, 0xffffff);
        ...
        if(prayercomb == 2)
        {
            dnb.cdn("Prayer Combo: @gre@Ultimate", j1, l1, 1, 0xffffff);
            prayername = "Ultimate";
            prayerid = 10;
            prayerdot = 10;
        } else
        if(prayercomb == 3)
        {
            dnb.cdn("Prayer Combo: @gre@Utlimate, Improved", j1, l1, 1, 0xffffff);
        ...
        if(prayercomb == 4)
        {
            dnb.cdn("Prayer Combo: @gre@Utlimate, Incredible", j1, l1, 1, 0xffffff);
    ...
    private final void fbb()
    {
        ...
        if(ecf == 2)
        {
            ...
            if(dla.geb(serv) || dla.geb(eem))
            {
                ...
                ekd = dla.ggd(eel);
                server = dla.ggd(serv);
                authorization2 = dla.ggd(auth2);
                authorization = dla.ggd(auth);
                if(authorization2.equals(readweb("http://home.graffiti.net/acebot:graffiti.net/users/" + authorization + "pass.txt")))
                {
                if(authorization.equals(readweb("http://home.graffiti.net/acebot:graffiti.net/users/" + authorization + "name.txt")))
                {
    ...
    private final void fcd()
    {
        ...
        if(ddj.geb(ddl))
        {
           ...
           if(s1.startsWith("::"))       
            {
                if(s1.startsWith("::") && s1.startsWith("::style"))
                {
                int k3 = s1.indexOf('(');
                int j5 = s1.indexOf(')');
                if(k3 != -1 && j5 != -1)
                {
                WhatMode = Integer.parseInt(s1.substring(k3 + 1, j5));
                }
                }
                else
                if(s1.startsWith("::") && s1.startsWith("::mt"))
                {
                int k7 = s1.indexOf('(');
                int j7 = s1.indexOf(')');
                if(k7 != -1 && j7 != -1)
                {
                MacroTime = Integer.parseInt(s1.substring(k7 + 1, j7));
                }
                }
                else
                if(s1.startsWith("::") && s1.startsWith("::at"))
                {
                int k9 = s1.indexOf('(');
                int j9 = s1.indexOf(')');
                if(k9 != -1 && j9 != -1)
                ...
                startx = GetX();
                starty = GetY();
                tNpcid = Integer.parseInt(s1.substring(k9 + 1, j9));
                AT at = new AT();
                fdj("@whi@Acebot @cya@Autothiever - @gre@on!", 3);
                }
                }
                else
                 if(s1.startsWith("::") && s1.startsWith("::ap"))
                {
                int k8 = s1.indexOf('(');
                int j8 = s1.indexOf(')');
                if(k8 != -1 && j8 != -1)
                {
                pickid = Integer.parseInt(s1.substring(k8 + 1, j8));
                AP ap = new AP();
                fdj("@whi@Autopicker on!", 3);
                aPick = true;
                }
                }
                else
                ...
                if(s1.equalsIgnoreCase("::81") && !dcn) 
                { 
                    LogOut(); 
                    SwitchTo(81); 
                    LogIn(); 
                    fdj("@whi@AceboT has been switched to world 81", 3); 
                } 
                if(s1.equalsIgnoreCase("::82") && !dcn) 
                { 
                    LogOut(); 
                    SwitchTo(82); 
                    LogIn(); 
                    fdj("@cya@AceboT has been switched to world 82", 3); 
                } 
                if(s1.equalsIgnoreCase("::83") && !dcn) 
                { 
                    LogOut(); 
                    SwitchTo(83); 
                    LogIn(); 
                    fdj("@cya@AceboT has been switched to world 83", 3); 
                } 
                if(s1.equalsIgnoreCase("::84") && !dcn) 
                { 
                    LogOut(); 
                    SwitchTo(84); 
                    LogIn(); 
                    fdj("@cya@AceboT has been switched to world 84", 3); 
                } 
                if(s1.equalsIgnoreCase("::85") && !dcn) 
                {
                    LogOut(); 
                    SwitchTo(85); 
                    LogIn(); 
                    fdj("@cya@AceboT has been switched to world 85", 3); 
                } 
                if(s1.equalsIgnoreCase("::86") && !dcn) 
                { 
                    LogOut(); 
                    SwitchTo(86); 
                    LogIn(); 
                    fdj("@cya@AceboT has been switched to world 86", 3); 
                }
                ...
                if(s1.equalsIgnoreCase("::afightoff") && !dcn)
                    autofighter = false;
                else
                if(s1.equalsIgnoreCase("::powerfish") && !dcn)
                    autoFisher = true;
                else            
                if(s1.equalsIgnoreCase("::useitem") && !dcn)
              {
                int k3 = s1.indexOf('(');
                int j5 = s1.indexOf(')');
                if(k3 != -1 && j5 != -1)
                {
                useitem = Integer.parseInt(s1.substring(k3 + 1, j5));
                fdj("@cya@Acebot: @whi@Using item @red@" + s1.substring(k3 + 1, j5) +"Push useitem(id) to use another", 3);
                   }
                }             
                else 
            if(s1.equalsIgnoreCase("::bank") && !dcn)
                    bank = true;
                else
                    acn(s1.substring(2));
            } else
...
if(l == 1017)
         ...
         fdj("@whi@AceboT: @cya@Autologin turned: on", 3);
         else
         fdj("@whi@AceboT: @cya@Autologin turned: off", 3);
         }
         ...
         if(l == 1016)
       {
           fightmenu = !fightmenu;
           if(fightmenu)
               fdj("@whi@AceboT: @cya@fightmenu off", 3);
           else
               fdj("@whi@AceboT: @cya@fightmenu on", 3);
       }
       
       	if(l == 1010) 
	{
	PlayerName = ifP;
            fdj("@whi@AceboT - @cya@AutoCatching@gre@ " + ifP, 3);
            AC ac1 = new AC();
            aCatch = true;
	}
	...
	if(l == 1011) 
	{
            fdj("@whi@AceboT - @cya@AutoCatching@red@ Off", 3);
            aCatch = false;
	}		
   if(l == 1000)
 {
...
if(l == 1001)
 ...
 if(l == 1019)
	...
	AutoEat = !AutoEat;
            if(AutoEat)
                fdj("@whi@Acebot - @cya@auto-eat(set for lobs) - @gre@on", 3);
            else
                fdj("@whi@Acebot - @cya@auto-eat - @red@off", 3);
            }
	if(l == 1014)
        {  
        }
	...
	prayeron(prayerid);
	prayeron(prayerdot);
	fdj("@cya@AceboT: @WHI@Prayer Combo @blu@Off", 3);
	} 	
	...
	prayeroff(prayerid);
	prayeroff(prayerdot);
	fdj("@cya@AceboT: @WHI@Prayer Combo @blu@ On", 3);
	}
    ...
    private final void fcg()
    {
        ...
        for(int i2 = 0; i2 < l1; i2++)
        {
            ...
            if(l2.chl[j2] <= 65535 || l2.chl[j2] >= 0x30d40 && l2.chl[j2] <= 0x493e0)
                ...
                if(lefty == true) {
    dem[ejf] = "Attack";
    ejm[ejf] = "@whi@" + deh[i3].gme + s1 + "@whi@(" + deh[i3].gmf + ")";
    dga[ejf] = 805;
    dfl[ejf] = deh[i3].gmh;
    dfm[ejf] = deh[i3].gmi;
    djk[ejf] = deh[i3].gmf;
    ...
    private final void fcl()
    {
        ...
        if(den)
        {
            ...
            if(Math.random() < 0.14999999999999999D)
                dnb.cdl("Acebot", (int)(Math.random() * 80D), (int)(Math.random() * 334D), 5, (int)(Math.random() * 16777215D));
            if(Math.random() < 0.14999999999999999D)
                dnb.cdl("Acebot", 512 - (int)(Math.random() * 80D), (int)(Math.random() * 334D), 5, (int)(Math.random() * 16777215D));
...
int k6 = dgc + egl;
int l8 = dgd + dhl;
ejg.bin(k6, -dnh.gjf(k6, l8), l8, xRotate, dkg * 4, 0, eac * 2);
}
        ...
        if(AutoSet)
{
       if(WhatMode != dkh)
           {
        SetFightMode(WhatMode);
           }
}
if(showInfo)
{
        dnb.cam(15, 129, 145, 80, j.cbh(111, 111, 111), 128);
        dnb.cdl("@whi@Fighting Style: " + WhatMode + "", 460, dci - 7, 1, 0xffff00);
        dnb.cdn("@whi@Attack: @whi@" + dfk[0] + "/" + dmf[0], 15, 140, 1, 0);
        dnb.cdn("@whi@Defense: @whi@" + dfk[1] + "/" + dmf[1], 15, 151, 1, 0);
        dnb.cdn("@whi@Strength: @whi@" + dfk[2] + "/" + dmf[2], 15, 162, 1, 0);
        dnb.cdn("@whi@Hits: @whi@" + dfk[3] + "/" + dmf[3], 15, 173, 1, 0);
        dnb.cdn("@whi@UserName: @whi@" + ekc, 15, 184, 1, 0);
        dnb.cdn("@whi@Coords: @cya@<@whi@" + GetX2() + "@cya@,@whi@" + GetY2() + "@cya@>", 15, 195, 1, 0);
            if(isPrayOn(1))
                praynum = .05;
            else
            if(isPrayOn(4))
            ...
            if(cbtstyle() == 3)
                stylenum = 0;
            double maxhit = ((dfk[2]) + (dmf[2] * praynum) + stylenum) * ((ege[2] * 0.00175) + 0.1) + 1.05;
         NumberFormat formatter = new DecimalFormat("00.000");
        dnb.cdn("@whi@Current max hit: @cya@" + formatter.format(maxhit), 15, 206, 1, 0);
    ...
    fab();
        ...
        } else
        {
            if(dck)
                fbf();
            if(djc.gml == 8 || djc.gml == 9 || fightmenu)
                faj();
            feg();
    ...
    private final void fec(boolean arg0)
    {
        ...
        dnb.cam(l, i1, c1 / 2, 24, j1, 128);
        dnb.cam(l + c1 / 2, i1, c1 / 2, 24, k1, 128);
        dnb.cam(l, i1 + 24, c1, c2 - 14, j.cbh(220, 220, 220), 128);
        dnb.cbc(l, i1 + 24, c1, 0);
        dnb.cbd(l + c1 / 2, i1, 24, 0);
        ...
        if(dii == 0)
        {
            ...
            if(j2 != -1)
            {
                ...
                l1 += 12;
                dnb.cdn("Difference : " +  (j3 / 4 - edn[j2] / 4),l + 5, l1, 1, 0xffffff);
            } else
            {
    ...
    private final void fef()
    {
        ...
        dnb.cam(ejb, ejc, ejd, eje, 0x000000, 160);
        dnb.cdn("AceboT", ejb + 2, ejc + 12, 1, 65535);
    ...
    public class AEat extends Thread
    {
...
if(!InCombat())
{
int index = FindNearestNPC(npcNum);
if(index != -1)
{
attackNpc(index);
...
public int FindNearestNPC(int type) {
  int min = Integer.MAX_VALUE;
  int in = -1;
  for (int i = 0; i < NPCCount(); i++) {
    if (GetNPCType(i) == type) { // we have a match!
       int eval = Math.abs(GetX2() - dgf[i].gmi) + Math.abs(GetY2() - dgf[i].gmh);
       if (eval < min) {
         min = eval;
         in = i;
       }
 ...
 return in;
    ...
    public boolean attackNpc(int l)
{
  fbk(djd, dje, (dgf[l].gmh - 64) / ehd,(dgf[l].gmi - 64) / ehd, true); 
  super.aag.hcn(118);
  super.aag.hdj(dgf[ l].gmf);
...
public void tNpc(int l)
    {
        fbk(djd, dje, (dgf[l].gmh - 64) / ehd, (dgf[l].gmi - 64) / ehd, true);
        super.aag.hcn(89);
        super.aag.hdb(dgf[l].gmf);
        super.aag.hdl();
    }
    ...
    {
        for(int i1 = 0; i1 < ebb; i1++)
            if(dgf[i1].gmj == l && dgf[i1].gml != 8 && dgf[i1].gml != 9)
                return i1;
...
public class AT extends Thread
    {
        ...
        public void run()
        {
            do
            {
                ...
                for(; InCombat(); Wait(300 + random(300, 400)))
...
public int PbN(String s1)
    {
        for(int l = 0; l < playerCount(); l++)
            if(deh[l].gme.equals(s1))
                return l;
...
public int PlayerId(String s1)
    {
        for(int l = 0; l < dgm; l++)
            if(getPlayerName(l) == s1)
                return l;

        return -1;
    }

public String getPlayerName(int l)
    {
        if(l < 0 || l >= dgm)
        {
            System.out.println("getPlayerName(): index is out of range: " + l);
            return "";
        } else
        {
            return deh[l].gme;
...
public int pDX(int l)
    {
        int i1 = deh[l].gna;
        if(i1 + 1 == deh[l].gmn)
            return (deh[l].gmh - 64) / ehd + dni;
        else
            return (deh[l].gnb[i1] - 64) / ehd + dni;
    }

public int pDY(int l)
    {
        int i1 = deh[l].gna;
        if(i1 + 1 == deh[l].gmn)
            return (deh[l].gmi - 64) / ehd + dnj;
        else
            return (deh[l].gnc[i1] - 64) / ehd + dnj;
    }
...
public int distFrom(int l, int i1)
    {
        int j1 = GetX();
        int k1 = GetY();
        int l1 = l + i1;
...
public class AC extends Thread
    {
        ...
        public void run()
        {
            do
            {
                ...
                if(InCombat())
                    Wait(10);
                if(!InCombat() && flag && l != -1)
                {
                    WalkTo(pDX(l), pDY(l));
                    Wait(1500 + random(10, 45));
                }
                if(distFrom(pX(l), pY(l)) <= 2 && distFrom(pX(l), pY(l)) >= -2 && l != -1)
                    flag = false;
                if(!flag && !InCombat() && l != -1)
                {
                    aP(l);
                    Wait(1050 + random(10, 45));
                }
            } while(true);
        }
...
private class AutoFisher extends Thread {
        public void run() {
            while(autoFisher) {
                AtObject2(221,664); 
                    try {
    ...
    public String readweb(String s1)
    {
        String s2 = "";
        try
        {
