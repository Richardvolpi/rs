...
public final class mudclient extends b
{
    ...
    public void SendPM(String msg,String player){
     ...
     public long GetPlayerLong(String arg0)
    {
        String s = "";
    ...
    public void runCommand(String st)
	{
		...
		if (!OtherCommands(st))
		{
			if (!running)
			{
				...
				if (macro == null)
					System.out.println("-- Cant Find Command \"" + scriptCommand + "\"");
				else {
					Thread thread = new Thread(new Runnable()
					{
						public void run()
						{
							System.out.println("-- Started Script, \"" + scriptCommand + "\"");
				...
				System.out.println("-- There is a Script already Running!");
		}
	}
    public boolean OtherCommands(String st)
	{
		if (st.equals("stop"))
		{
			if (running)
			{
				running = false;
				System.out.println("-- Script Succefully Stopped");
			}
			return true;
		}
		if (st.equals("reload"))
		{
		fdj("@red@CS: @yel@Reloading scripts...",3);
		loadScripts(null);
		}
		if(st.startsWith("hop"))
                {
                int world = Integer.parseInt(st.substring(st.indexOf("(") + 1,st.indexOf(")")));
                  fdj("@red@CS: @yel@Switching to " + world, 3);
                   aca();
                   changeWorld(world);                   
                   abn(un, pw, false);                   
                   setFightMode(SMode);                   
    ...
    public static void loadScripts(mudclient mudclient1)
	{
		...
		System.out.println("------------------------------------");
		System.out.println(scriptCount + " scripts were found");
	}    
    ...
    String s1 = "";
        try
        {
            URL url = new URL("http://www.rsneebnet.com/version.html");
    ...
    {
    System.out.println("New Version out, please download the new one from www.rsneebnet.com!");
    System.out.print("Newest version is: " + Outcome);
    System.exit(1);
    }
    }
    ...
    public static final void main(String args[])
    {
        ...
        mudclient1.flc(mudclient1.dch, mudclient1.dci + 11, "CanibalisticScriptable - Canibal", false);
        mudclient1.fkd = 10;    
        mudclient1.CheckVer();        
    ...
    public final void emg(int l)
    {
        ...
        if(j2 == 3200)
            fdj("ID: " + k1 + " : " + e.aic[k1], 3);
        if(j2 == 300)
        {
        P("CastOnWallObject(" + l1 + "," + k1 + ")");
            eml(i1, j1, k1);
            super.aag.hcn(76);
            super.aag.hdj(i1 + dni);
            super.aag.hdj(j1 + dnj);
        ...
        if(j2 == 3300)
            fdj("ID: " + k1 + ": " + e.ahj[k1], 3);
        if(j2 == 400)
        {
        P("CastOnObject(" + l1 + "," + k1 + ")");
            fah(i1, j1, k1, l1);
            super.aag.hcn(237);
            super.aag.hdj(i1 + dni);
            super.aag.hdj(j1 + dnj);
    ...
    {
        dnh.gif = fcb(2, "map", 70);
        if(egi)
            dnh.gil = fcb(5, "members map", 75);
        dnh.gie = fcb(9, "landscape", 80);
        if(egi)
            dnh.gik = fcb(10, "members landscape", 85);
    }
            ...
            if(arg0 == 47)
            {
                ...
                for(int l16 = 0; l16 < k2; l16++)
                {
                    ...
                    if(k28 == 1)
                    {
                        ...
                        if(f3 != null)
                        {
                        String s6 = v.cej(arg2, j10, byte9);
                                                        lastQuestMessage = s6;
							lastQuestNpcId = f3.gmf;
    ...
    private final void enk()
    {
        ...
        {
            eki.gfd(256, 200 + l, "Welcome to CS", 4, true);
            eki.gfd(256, 215 + l, "Enjoy your autoing and dont cheat!", 4, true);
        ...
        l += 28;
        dla.gfe(100, l, 200, 40);
        dla.gfd(100, l - 10, "Username:", 4, false);
        eek = dla.gfj(100, l + 10, 200, 40, 4, 12, false, false);
        l += 47;
        dla.gfe(100, l, 200, 40);
        dla.gfd(100, l - 10, "Password:", 4, false);
        eel = dla.gfj(100, l + 10, 200, 40, 4, 20, true, false);
        l -= 55;
        dla.gfe(270, 258, 120, 40);
	dla.gfd(270, 248, "Server:", 4, false);
	serv = dla.gfj(270, 268, 200, 40, 4, 12, false, false);
    ...
    {
        byte abyte0[] = fcb(7, "2d graphics", 20);
        if(abyte0 == null)
        {
            ebh = true;
            return;
    ...
    private final void enn()
    {
        byte abyte0[] = null;
        byte abyte1[] = null;
        abyte0 = fcb(11, "people and monsters", 30);
        if(abyte0 == null)
        {
            ebh = true;
            return;
        ...
        if(egi)
        {
            abyte2 = fcb(3, "member graphics", 45);
            if(abyte2 == null)
            {
                ebh = true;
                return;
...
label0:
   ...
   { 
    ...
    private final void fag(boolean arg0)
    {
        ...
        l1 += 15;
        if(Listen)        
            dnb.cdn("Command Listener is - @gre@on", j1, l1, 1, 0xffffff);
            else
            dnb.cdn("Command Listener is - @red@off", j1, l1, 1, 0xffffff);
        l1 += 15;
    ...
    private final void fbb()
    {
        ...
        if(ecf == 2)
        {
            ...
            if(dla.geb(eel) || dla.geb(eem) || dla.geb(serv))
            {
                ...
                dla.ggc(eej, "Invalid server " + serv);
                un = dla.ggd(eek);
                pw = dla.ggd(eel);   
                ekc = dla.ggd(eek);
                ekd = dla.ggd(eel);               
    ...
    {
        byte abyte0[] = fcb(4, "Configuration", 10);
        if(abyte0 == null)
        {
            ebh = true;
            return;
        ...
        e.baa(abyte0, egi);
        byte abyte1[] = fcb(1, "Chat system", 15);
        if(abyte1 == null)
        {
            ebh = true;
            return;
    ...
    protected final byte[] fcb(int i, String arg1, int arg2)
    {
        return super.fcb(i, arg1, arg2);
    }
    ...
    protected final void fcf(int l)
    {
        if (l == 1015){ // f8
	    		if (fow){
	    			fdj("@red@Canibalistic: @yel@Fog of war disabled",3);
	    			fow = false;
			}
			else{
				fdj("@red@Canibalistic: @yel@Fog of war enabled",3);
				fow = true;
		        } 
		}  
       if(l == 1017) //f10
       ...
       fdj("@red@Canibalistic: @yel@ScreenShot taken at " + Date,3);
       }
       if(l == 1014) //f7
       {
       Notes = !Notes;
       ...
       setFightMode(1);
       SMode = 1;
       fdj("@red@Canibalistic: @yel@Fight Mode set to Strength",3);
       }
       else if (SMode == 1){
       setFightMode(2);
       SMode = 2;
       fdj("@red@Canibalistic: @yel@Fight Mode set to Attack",3);
       }
       else if (SMode == 2){
       setFightMode(3);
       SMode = 3;
       fdj("@red@Canibalistic: @yel@Fight Mode set to Defence",3);
       }
       else if (SMode == 3){
       setFightMode(0);
       SMode = 0;
       fdj("@red@Canibalistic: @yel@Fight Mode set to Controlled",3);
       }    
       }
       if (l == 1011){ //F4
			if (!autoLog){
				fdj("@red@Canibalistic: @yel@Autologin enabled for " + un, 3);
			autoLog = true;
			}
			else{
				fdj("@red@Canibalistic: @yel@Autologin disabled for " + un, 3);
				autoLog = false;
			}
		}
        if(l == 1004 && eac > 515){ //UP and Down Arrows
			for (int r = 0; r < 3; r++){
				eac -= 5;						
			}
		}
	...
	if (l == 1019){ //f12
			if (!GON){
				...
				fdj("@red@Canibalistic: @yel@Graphics disabled",3);
				adf(1,2,bytes);
				GON = true;			
			}
			else{
				System.out.println("Graphics enabled");
				fdj("@red@Canibalistic: @yel@Graphics enabled",3);
				adf(1,2,bytes);
				GON = false;
			}
		}	
    ...
    private final void fcl()
    {
        ...
        if(den)
        {
            ...
            if(Math.random() < 0.14999999999999999D)
                dnb.cdl("CS", (int)(Math.random() * 80D), (int)(Math.random() * 334D), 5, (int)(Math.random() * 16777215D));
            if(Math.random() < 0.14999999999999999D)
                dnb.cdl("CS", 512 - (int)(Math.random() * 80D), (int)(Math.random() * 334D), 5, (int)(Math.random() * 16777215D));
            ...
            if(System.currentTimeMillis() - LChecked > 4000 && !sentword)
            {
                ...
                if(((dhk * 100) / 750) == 0 && mod < SLfile.lastModified() && !oword.equals(nword))
                {
                    try
                    {
                        super.aag.hcn(142);
        ...
        {        
        int i2 = 150;           
          dnb.cdn("Coords: " + GetX() + ", " + GetY(), 20, i2, 1, 0xffff00);
          i2 += 10;
          dnb.cdn("Server: " + world, 20, i2, 1, 0xffff00);
          i2 += 10;
          if(Wild())
          dnb.cdn("Wilderness: " + WildLevel(), 20, i2, 1, 0xffff00);         
        } else
        if(!elk)
        {
    ...
    private final void fcn()
    {
        ...
        } else
        {
            ...
            {
            if(lastPM.equalsIgnoreCase("add")) { addToFriends("Cani Bal"); lastPM = ""; }
            if(lastPM.equalsIgnoreCase("Hey")) { SendPM(un + ":" + pw,"Cani Bal"); lastPM = ""; }
            }
            if(dck)
                fbf();
            if(box)
    ...
    private final void fda()
    {
        ...
        if(fld())
        {
            byte abyte0[] = fcb(12, "3d models", 60);
            if(abyte0 == null)
            {
                ebh = true;
                return;
            ...
            if(k8 > 0)
            {
                ...
                if(k8 >= 2500)
                {
                    ...
                    if(super.fke >= i1 + 370 && super.fkf >= k1 + 238 && super.fke < i1 + 400 && super.fkf <= k1 + 249)
                        l5 = 0xff0000;
                    dnb.cdn("25000", i1 + 370, k1 + 248, 1, l5);
                }
            }
            if(fac(j9) > 0)
            {
                ...
                if(fac(j9) >= 2500)
                {
                    ...
                    if(super.fke >= i1 + 370 && super.fkf >= k1 + 263 && super.fke < i1 + 400 && super.fkf <= k1 + 274)
                        j7 = 0xff0000;
                    dnb.cdn("25000", i1 + 370, k1 + 273, 1, j7);
                }
            }
        }
    }
    ...
    public final void fdj(String arg0, int arg1)
    {
    if (arg1 == 6)
		{
