...
public class b extends a
{
    ...
    protected final void abn(String arg0, String arg1, boolean arg2)
    {
	 // Check c = new Check();
        /*if(!c.doAuth())
        {
		try { aag = new s(enb(aac, aad), this);
            ada("Please wait...", "Connecting to server"); 
		System.out.println("Verb: Session id: "+aag.hdk()); }catch(Exception e) { }
            try
            {
                Thread.sleep(2000L);
            }
            catch(Exception _ex) { }
		System.out.println("login response: 21 [INCORRECT AUTH]");
            ada("Sorry! Your authorization is incorrect.", "");
            return;
        }*/
        try
        {
