...
public class h
{
    ...
    public h(j j1, int i)
    {
        ...
        gca = new String[i];
        gcb = new String[i][];
        gci = gdn(0,0,0); //gdn(114, 114, 176); 
        gcj = gdn(0,0,0); //gdn(14, 14, 62);
        gck = gdn(0,0,0); //gdn(200, 208, 232);
        gcl = gdn(0,0,0); //gdn(96, 129, 184);
        gcm = gdn(0,0,0); //gdn(53, 95, 115);
        gcn = gdn(0,0,0); //gdn(117, 142, 171);
        gda = gdn(0,0,0); //gdn(98, 122, 158);
        gdb = gdn(0,0,0); //gdn(86, 100, 136);
        gdc = gdn(0,0,0); //gdn(135, 146, 179);
        gdd = gdn(0,0,0); //gdn(97, 112, 151);
        gde = gdn(0,0,0); //gdn(88, 102, 136);
        gdf = gdn(255,255,255); //gdn(84, 93, 120);
    }

    public int gdn(int i, int k, int l)
    {
        return j.cbh((gdj * i) / 114, (gdk * k) / 114, (gdl * l) / 176);
    }
    ...
    {
        gaj.cba(arg1, arg2, arg3, arg4, 0xffffff);
    ...
    public void gei(int arg0, int arg1, int arg2, int arg3)
    {
        ...
        gaj.cbc(arg0, arg1, arg2, gdc);
        gaj.cbc(arg0 + 1, arg1 + 1, arg2 - 2, gdc);
        gaj.cbc(arg0 + 2, arg1 + 2, arg2 - 4, gdd);
        gaj.cbd(arg0, arg1, arg3, gdc);
        gaj.cbd(arg0 + 1, arg1 + 1, arg3 - 2, gdc);
        gaj.cbd(arg0 + 2, arg1 + 2, arg3 - 4, gdd);
        gaj.cbc(arg0, (arg1 + arg3) - 1, arg2, gdf);
        gaj.cbc(arg0 + 1, (arg1 + arg3) - 2, arg2 - 2, gdf);
        gaj.cbc(arg0 + 2, (arg1 + arg3) - 3, arg2 - 4, gde);
        gaj.cbd((arg0 + arg2) - 1, arg1, arg3, gdf);
        gaj.cbd((arg0 + arg2) - 2, arg1 + 1, arg3 - 2, gdf);
        gaj.cbd((arg0 + arg2) - 3, arg1 + 2, arg3 - 4, gde);
        gaj.cai();
    }
    ...
    {
        gaj.cba(i, k, l, i1, 0);
        gaj.cbb(i, k, l, i1, gcn);
        gaj.cbb(i + 1, k + 1, l - 2, i1 - 2, gda);
        gaj.cbb(i + 2, k + 2, l - 4, i1 - 4, gdb);
        gaj.ccb(i, k, 2 + gdi);
        gaj.ccb((i + l) - 7, k, 3 + gdi);
        gaj.ccb(i, (k + i1) - 7, 4 + gdi);
        gaj.ccb((i + l) - 7, (k + i1) - 7, 5 + gdi);
    }
    ...
    {
        int l1 = (i + l) - 12;
        gaj.cbb(l1, k, 12, i1, 0);
        gaj.ccb(l1 + 1, k + 1, gdi);
        gaj.ccb(l1 + 1, (k + i1) - 12, 1 + gdi);
        gaj.cbc(l1, k + 13, 12, 0);
        gaj.cbc(l1, (k + i1) - 13, 12, 0);
        gaj.can(l1 + 1, k + 14, 11, i1 - 27, gci, gcj);
        gaj.cba(l1 + 3, j1 + k + 14, 7, k1, gcl);
        ...
        for(int l = 0; l < i; l++)
        {
            ...
            if(gbe[arg0] == l)
                if(gbg[arg0])
                    ...
                    i1 = 0xc00000;
            gaj.cdn(arg4[l], arg1 - j1 / 2, k, arg3, i1);
            k += gaj.ced(arg3);
        }
            ...
            int arg7, int arg8)
    {
        ...
        for(int l1 = arg8; l1 < arg7; l1++)
        {
            ...
            if(gbg[arg0])
                ...
                j2 = 0;
            if(gcc >= arg1 + 2 && gcc <= arg1 + 2 + gaj.cef(arg6[l1], arg5) && gcd - 2 <= j1 && gcd - 2 > j1 - gaj.ced(arg5))
            {
                if(gbg[arg0])
                    j2 = 0x808080;
                else
            ...
            if(gbe[arg0] == l1 && gdg)
                j2 = 0xff0000;
            gaj.cdn(arg6[l1], arg1 + 2, j1, arg5, j2);
            j1 += gaj.ced(arg5);
            if(j1 >= arg2 + arg4)
                return;
        }
    ...
    public int gfj(int i, int k, int l, int i1, int j1, int k1, boolean flag, 
            boolean flag1)
    {
        gbj[gak] = 6;
        gam[gak] = true;
