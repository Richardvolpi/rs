...

{
 ...
 super.aah.hem();
 if(eff == 0)
 enl("@gre@Teh_Bot:@ran@Fight mode set to Controlled", 3);
 if(eff == 1)
 enl("@gre@Teh_Bot:@ran@Fight mode set to Strength", 3);
 if(eff == 2)
 enl("@gre@Teh_Bot: @ran@Fight mode set to Attack", 3);
 if(eff == 3)
 enl("@ora@Teh_Bot: @ran@Fightmode set to Defense", 3);
 }
if (i==1013)
{
