    ...
    implements Runnable
{
    ...
    protected final void createWindow(int i, int k, String s, boolean flag)
    {
        fih = false;
        fia = i;
        fib = k;
    ...
    protected final boolean application()
    {
        return fih;
    }
    ...
    private final void flh()
    {
        ...
        byte abyte0[] = enb("jagex.jag", "Jagex library", 0);
        if(abyte0 == null)
        {
            return;
        } else
