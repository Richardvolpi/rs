...
Your Run.bat should defaultly contain 3 lines. The middle being "java -classpath STS.jar;./Scripts;./SBoT/; mudclient".
this can be changed to "java -classpath STS.jar;./Scripts;./SBoT/; mudclient user+name pass+word fighter(3,1)" for example. This makes the bot
login as soon as it is loaded, with the username "user name" and the password "pass word". When it logs in the script called "fighter" will be
run, with the parameters "3" and "1". Which world you login to can be set in the Settings.ini
