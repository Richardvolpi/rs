    ...
    implements Runnable
{
    ...
    public Applet_Sub1()
    {
        ...
        aFont19 = new Font("Impact", 1, 13);
        aFont20 = new Font("bubblegums", 0, 18);
        aBoolean24 = false;
        aBoolean25 = false;
        aBoolean26 = false;
        aBoolean27 = false;
    ...
    {
        aBoolean8 = true;
        System.out.println("GBoT Scriptable Loading...");
        anInt1 = 512;
        anInt2 = 344;
        anInt13 = 1;
    ...
    {
        anInt9 = -2;
        System.out.println("... Closing GBoT");
        method3();
        try
        {
            Thread.sleep(1000L);
    ...
    public final void method13()
    {
        ...
        int i = (anInt1 - 281) / 2;
        int k = (anInt2 - 148) / 2;
        anImage21 = toolkit.getImage(this.UserDirect + "/Data/" + "logo.gif");
        aGraphics22.drawImage(anImage21, i, k, this);
    ...
    public final void method14(int i, String s)
    {
        try
        {
            ...
            anInt16 = i;
            aString17 = s;
            aGraphics22.setColor(new Color(0, 0, 0));
            if(aBoolean15)
            ...
            k += 90;
                aGraphics22.setColor(new Color(255, 255, 255));
                method16(aGraphics22, "", aFont20, j + 250, k + -154);
                method16(aGraphics22, "", aFont20, j + 250, k + -142);
            } else
            {
                aGraphics22.setColor(new Color(255, 255, 255));
                method16(aGraphics22, "", aFont20, j + 250, k + -154);
    ...
    public static final String UserDirect = System.getProperty("user.dir");
