...
public class identify
{
    ...
    {
        int i = fnf.method354(aByteArray141, anInt143);
        anInt143 += 2;
        return i;
    }
    ...
    {
        int i = fnf.method355(aByteArray141, anInt143);
        anInt143 += 4;
        if(i > 0x5f5e0ff)
            i = 0x5f5e0ff - i;
        return i;
    ...
    {
        int j19 = anInt144;
        aByteArray140 = fnf.method366("string.dat", 0, abyte0);
        anInt142 = 0;
        aByteArray141 = fnf.method366("integer.dat", 0, abyte0);
        anInt143 = 0;
        anInt75 = method126();
        itemName = new String[anInt75];
        itemDesc = new String[anInt75];
        itemCommand = new String[anInt75];
        anIntArray53 = new int[anInt75];
        ahk = new int[anInt75];
        ahl = new int[anInt75];
        anIntArray56 = new int[anInt75];
        isWearable = new int[anInt75];
        anIntArray58 = new int[anInt75];
        anIntArray59 = new int[anInt75];
        anIntArray60 = new int[anInt75];
        for(int i = 0; i < anInt75; i++)
            itemName[i] = method128();

        for(int j = 0; j < anInt75; j++)
            itemDesc[j] = method128();

        for(int k = 0; k < anInt75; k++)
            itemCommand[k] = method128();
        ...
        anInt122 = method126();
        npcName = new String[anInt122];
        npcDesc = new String[anInt122];
        npcCommand = new String[anInt122];
        npcAttack = new int[anInt122];
        npcStrength = new int[anInt122];
        npcHits = new int[anInt122];
        npcDefence = new int[anInt122];
        attackable = new int[anInt122];
        ...
        anInt104 = method126();
        mobName = new String[anInt104];
        mobDesc = new String[anInt104];
        mobCommand1 = new String[anInt104];
        mobCommand2 = new String[anInt104];
        ...
        for(int l9 = 0; l9 < anInt104; l9++)
            mobName[l9] = method128();

        for(int i10 = 0; i10 < anInt104; i10++)
            mobDesc[i10] = method128();

        for(int j10 = 0; j10 < anInt104; j10++)
            mobCommand1[j10] = method128();

        for(int k10 = 0; k10 < anInt104; k10++)
            mobCommand2[k10] = method128();
        ...
        anInt139 = method126();
        doorname = new String[anInt139];
        aif = new String[anInt139];
        dooraction = new String[anInt139];
        dooraction2 = new String[anInt139];
        ...
        prayerLevel = new int[anInt95];
        prayerDrain = new int[anInt95];
        ...
        for(int l18 = 0; l18 < anInt95; l18++)
            prayerLevel[l18] = method125();

        for(int i19 = 0; i19 < anInt95; i19++)
            prayerDrain[i19] = method125();
    ...
    public static String dooraction[];
    public static String dooraction2[];
    public static String aStringArray77[];
    public static String mobName[];
    public static String mobDesc[];
    public static String mobCommand1[];
    public static String mobCommand2[];
