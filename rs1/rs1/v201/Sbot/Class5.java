...
public class Class5
{
    ...
    public Class5(byte abyte0[], int i, boolean flag)
    {
        ...
        anInt307 = 512;
        anInt308 = 32;
        int j = fnf.method354(abyte0, i);
        i += 2;
        int k = fnf.method354(abyte0, i);
        i += 2;
        method175(j, k);
        anIntArrayArray279 = new int[k][1];
        for(int l = 0; l < j; l++)
        {
            anIntArray272[l] = fnf.method357(abyte0, i);
            i += 2;
        }

        for(int i1 = 0; i1 < j; i1++)
        {
            anIntArray273[i1] = fnf.method357(abyte0, i);
            i += 2;
        }

        for(int j1 = 0; j1 < j; j1++)
        {
            anIntArray274[j1] = fnf.method357(abyte0, i);
            i += 2;
        }
        ...
        {
            anIntArray237[l1] = fnf.method357(abyte0, i);
            i += 2;
        ...
        {
            anIntArray238[i2] = fnf.method357(abyte0, i);
            i += 2;
        ...
        for(int l2 = 0; l2 < k; l2++)
        {
            ...
            for(int i3 = 0; i3 < anIntArray235[l2]; i3++)
                ...
                {
                    anIntArrayArray236[l2][i3] = fnf.method354(abyte0, i);
                    i += 2;
                }
    ...
    public void method175(int i, int j)
    {
    ...
    public void method196(int i, int j, int k, int l, int i1, int j1)
    {
