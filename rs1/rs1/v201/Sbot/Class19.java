...
public class Class19
{
    ...
    public void method407(int i, int j, int k)
    {
        ...
        if(i < 0 || j < 0 || i >= 95 || j >= 95)
            return;
        if(identify.anIntArray65[k] == 1 || identify.anIntArray65[k] == 2)
        {
            int l = method402(i, j);
            int i1;
            int j1;
            if(l == 0 || l == 4)
            {
                i1 = identify.anIntArray63[k];
                j1 = identify.anIntArray64[k];
            } else
            {
                j1 = identify.anIntArray63[k];
                i1 = identify.anIntArray64[k];
            }
            for(int k1 = i; k1 < i + i1; k1++)
            {
                for(int l1 = j; l1 < j + j1; l1++)
                    if(identify.anIntArray65[k] == 1)
    ...
    public void method413(int i, int j, int k, boolean flag)
    {
        ...
        if(flag)
        {
            ...
            for(int j2 = 0; j2 < 96; j2++)
            {
                for(int i3 = 0; i3 < 96; i3++)
                {
                    ...
                    if(method420(j2, i3, k) > 0 && identify.anIntArray135[method420(j2, i3, k) - 1] == 4)
                        i4 = 0;
                    if(method420(j2 - 1, i3, k) > 0 && identify.anIntArray135[method420(j2 - 1, i3, k) - 1] == 4)
                        i4 = 0;
                    if(method420(j2, i3 - 1, k) > 0 && identify.anIntArray135[method420(j2, i3 - 1, k) - 1] == 4)
                        i4 = 0;
                    if(method420(j2 - 1, i3 - 1, k) > 0 && identify.anIntArray135[method420(j2 - 1, i3 - 1, k) - 1] == 4)
                        i4 = 0;
            ...
            for(int j3 = 0; j3 < 95; j3++)
            {
                for(int j4 = 0; j4 < 95; j4++)
                {
                    ...
                    if(method420(j3, j4, k) > 0)
                    {
                        ...
                        int l5 = identify.anIntArray135[l16 - 1];
                        int i19 = method419(j3, j4, k);
                        k7 = i10 = identify.anIntArray134[l16 - 1];
                        if(l5 == 4)
                        {
                            k7 = 1;
                            i10 = 1;
                        ...
                        if(identify.anIntArray136[l16 - 1] != 0)
                            anIntArrayArray608[j3][j4] |= 0x40;
                        if(identify.anIntArray135[l16 - 1] == 2)
            ...
            for(int k4 = 1; k4 < 95; k4++)
            {
                for(int i6 = 1; i6 < 95; i6++)
                    if(method420(k4, i6, k) > 0 && identify.anIntArray135[method420(k4, i6, k) - 1] == 4)
                    {
                        int l7 = identify.anIntArray134[method420(k4, i6, k) - 1];
                    ...
                    if(method420(k4, i6, k) == 0 || identify.anIntArray135[method420(k4, i6, k) - 1] != 3)
                    {
                        if(method420(k4, i6 + 1, k) > 0 && identify.anIntArray135[method420(k4, i6 + 1, k) - 1] == 4)
                        {
                            int i8 = identify.anIntArray134[method420(k4, i6 + 1, k) - 1];
                        ...
                        if(method420(k4, i6 - 1, k) > 0 && identify.anIntArray135[method420(k4, i6 - 1, k) - 1] == 4)
                        {
                            int j8 = identify.anIntArray134[method420(k4, i6 - 1, k) - 1];
                        ...
                        if(method420(k4 + 1, i6, k) > 0 && identify.anIntArray135[method420(k4 + 1, i6, k) - 1] == 4)
                        {
                            int k8 = identify.anIntArray134[method420(k4 + 1, i6, k) - 1];
                        ...
                        if(method420(k4 - 1, i6, k) > 0 && identify.anIntArray135[method420(k4 - 1, i6, k) - 1] == 4)
                        {
                            int l8 = identify.anIntArray134[method420(k4 - 1, i6, k) - 1];
        ...
        for(int i2 = 0; i2 < 95; i2++)
        {
            for(int k2 = 0; k2 < 95; k2++)
            {
                ...
                if(k3 > 0 && (identify.anIntArray82[k3 - 1] == 0 || aBoolean588))
                {
                    method432(aClass5_586, k3 - 1, i2, k2, i2 + 1, k2);
                    if(flag && identify.anIntArray81[k3 - 1] != 0)
                    {
                ...
                k3 = method430(i2, k2);
                if(k3 > 0 && k3 < 12000 && (identify.anIntArray82[k3 - 1] == 0 || aBoolean588))
                {
                ...
                if(k3 > 12000 && k3 < 24000 && (identify.anIntArray82[k3 - 12001] == 0 || aBoolean588))
                {
                    method432(aClass5_586, k3 - 12001, i2 + 1, k2, i2, k2 + 1);
                    if(flag && identify.anIntArray81[k3 - 12001] != 0)
        ...
        for(int i7 = 1; i7 < 95; i7++)
        {
            for(int k9 = 1; k9 < 95; k9++)
            {
                ...
                if(i12 > 0)
                {
                    ...
                    int j28 = identify.anIntArray124[i12 - 1];
                    ...
                    if(!method403(k23, i24 + 1))
                        i27 += byte0;
                    i12 = identify.anIntArray125[i12 - 1];
                    j27 = -j27;
                    k27 = -k27;
                    l27 = -l27;
                    i28 = -i28;
    ...
    {
        int j1 = identify.anIntArray78[i];
    ...
    public int method419(int i, int j, int k)
    {
        ...
        if(l == 0)
            return -1;
        int i1 = identify.anIntArray135[l - 1];
        return i1 != 2 ? 0 : 1;
    }
    ...
    public void method424(int i, int j, int k, int l)
    {
        ...
        try
        {
            ...
            {
                byte abyte0[] = fnf.method366(s + ".hei", 0, aByteArray592);
                if(abyte0 == null && aByteArray611 != null)
                    abyte0 = fnf.method366(s + ".hei", 0, aByteArray611);
                ...
                abyte0 = fnf.method366(s + ".dat", 0, aByteArray593);
                if(abyte0 == null && aByteArray612 != null)
                    abyte0 = fnf.method366(s + ".dat", 0, aByteArray612);
                if(abyte0 == null || abyte0.length == 0)
                ...
                abyte0 = fnf.method366(s + ".loc", 0, aByteArray593);
                if(abyte0 != null && abyte0.length > 0)
                {
                    int i2 = 0;
            ...
            } else
            {
                ...
                fnf.method352("../gamedata/maps/" + s + ".jm", abyte1, 20736);
                int j2 = 0;
                int i3 = 0;
        ...
        for(int i = 0; i < 94; i++)
        {
            for(int j = 0; j < 94; j++)
                if(method430(i, j) > 48000 && method430(i, j) < 60000)
                {
                    ...
                    method407(i, j, k);
                    Class5 class5 = aclass5[identify.anIntArray62[k]].method205(false, true, false, false);
                    int k1 = ((i + i + i1) * 128) / 2;
                    int i2 = ((j + j + j1) * 128) / 2;
    ...
    public int method431(int i, int j, int k, int l)
    {
        ...
        if(i1 == 0)
            ...
            return identify.anIntArray134[i1 - 1];
    }
    ...
    public void method432(Class5 class5, int i, int j, int k, int l, int i1)
    {
        ...
        method426(l, i1, 40);
        int j1 = identify.anIntArray78[i];
        int k1 = identify.anIntArray79[i];
        int l1 = identify.anIntArray80[i];
        int i2 = j * 128;
        int j2 = k * 128;
        int k2 = l * 128;
        int l2 = i1 * 128;
