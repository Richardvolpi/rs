...
public class AnywhereMiner extends Script implements ActionListener {
    ...
    int ores_gems[] = new int[]{copper_ore,iron_ore,tin_ore,gold,silver,mithril_ore,coal,adamantite_ore,uncut_diamond,uncut_ruby,uncut_emerald,uncut_sapphire};
    ...
    public void LoadDialog() {
        ...
        cmbOreType = new JComboBox(new String[]{"Clay","Tin","Copper","Iron","Coal","Mithril","Adamantite","Gold","Silver"});
    ...
    public void RunScipt() {
        ...
        Msg("Mining " + cmbOreType.getSelectedItem() + ", in " + cmbMineType.getSelectedItem() + " mode.");
