public class CatherbyLob extends Script
{
    public CatherbyLob(mudclient rs)
    {
        super(rs);
    }
    public String[] getCommands()
    {
        return new String[]{"fishlobs"};
    }
    public void start(String command, String parameter[])
    {
      ...
      Wait(1000);
      DisplayMessage("@cya@Andrew: tells you Script created by Lala223!",3);
      Wait(1000);
