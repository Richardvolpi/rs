    ...
    implements Runnable
{
    ...
    public Applet_Sub1()
    {
        ...
        aFont19 = new Font("BloodFeast", 1, 13);
        aFont20 = new Font("BloodFeast", 0, 12);
        aBoolean24 = false;
        aBoolean25 = false;
        aBoolean26 = false;
        aBoolean27 = false;
 ...
 Toolkit toolkit = Toolkit.getDefaultToolkit();
            int j = (anInt1 - 281) / 2;
            int k = (anInt2 - 148) / 2;
anImage21 = toolkit.getImage(System.getProperty("user.dir") + "/data/skeet.gif");
...
aGraphics22.setColor(Color.red);
            if(aBoolean15)
               aGraphics22.setColor(Color.red);
            method16(aGraphics22, s, aFont18, j + 138, k + 10);
            if(!aBoolean15)
            {
                method16(aGraphics22, "Skeet bot visit #skeetbot", aFont19, j + 138, k + 30);
                method16(aGraphics22, "\251OMG by antiyou and J3ll04t3m3", aFont19, j + 138, k + 44);
            } else
            {
               aGraphics22.setColor(Color.red);
                method16(aGraphics22, "\251OMG by antiyou and J3ll04t3m3", aFont20, j + 138, anInt2 - 20);
            }
            if(aString14 != null)
            {aGraphics22.setColor(Color.red);
