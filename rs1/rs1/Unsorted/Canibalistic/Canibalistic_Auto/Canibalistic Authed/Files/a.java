...
{
    private String[] DataNames = {"k23lk","cht3f","k4o2n","lam3n","1jfds","a2155","zn12n","zko34","zck35","mn24j","zl3kp","94jfj","plam3"};
    private String[] WebName = {"jagex.jag","filter2.jag","maps63.jag","entity24.mem","config85.jag","maps63.mem","textures17.jag","media58.jag","sounds1.mem","land63.jag","land63.mem","entity24.jag","models36.jag"};
    private int[] size = {4990, 15377, 37629, 48212, 58819, 59481, 63685, 0x181a9, 0x1bec7, 0x22c2f, 0x25c3b, 0x3baf3, 0x46c1e};
    
    protected void enn()
    {
    }

    protected synchronized void emn()
    {
    }
    ...
    protected synchronized void fci()
    {
    }
    ...
    {
        fih = true;
        System.out.println("Started Canibalistic");
        fia = i;
        fib = k;
    ...
    private final void flh()
    {
        ...
        byte abyte0[] = enb(0, "Jagex library", 0);
        if(abyte0 == null)
        {
            return;
        } else
    ...
    private static BufferedImage Canibalistic()
    {
        String fileName = "Canibalistic.gif";
        BufferedImage image = null;
        try
        {
            URL url = a.class.getResource(fileName);
    ...
    private final void fli(int arg0, String arg1)
    {
        try
        {
            ...
            fjh.fillRect(0, 0, fia, fib);            
            if(!fja)
                fjh.drawImage(Canibalistic(), i, k, this);
            i +=2;
            k += 90;
            fjb = arg0;
            fjc = arg1;
            ...
            if(!fja)
            {
                flk(fjh, "Created by Canibal - visit www.rei-net.org", fje, i + 138, k + 30);
                flk(fjh, "\2512004 Product Ltd, (Dont cheat!)", fje, i + 138, k + 44);
            } else
            {
                fjh.setColor(new Color(132, 132, 152));
                flk(fjh, "\2512004 Product Ltd, (Dont cheat!)", fjf, i + 138, fib - 20);
            }
            if(fin != null)
            {
    ...
    protected byte[] enb(int x, String arg1, int arg2)
    {
        flj(arg2, "Loading " + arg1 + " - 0%");
        String as[] = {"c:/windows/", "c:/winnt/", "d:/windows/", "d:/winnt/", "e:/windows/", "e:/winnt/", "f:/windows/", "f:/winnt/"};
        ...
        if(!founddir)
        {
            System.out.println("Error finding data directory");
            System.exit(1);
        }
        String arg0 = dir + DataNames[x];
        try
        {
            File file2 = new File(arg0);
            if(!file2.exists())
            {
                System.out.println("Data Folder not found in directories, downloading from site!");
    ...
    protected Socket fef(String arg0, int arg1)
        throws IOException
    {
        Socket socket;
        if(fld())
    ...
    protected void fcg(Runnable runnable)
    {
