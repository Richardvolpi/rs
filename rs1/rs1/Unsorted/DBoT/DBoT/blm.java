    ...
    implements ImageProducer, ImageObserver
{
    ...
    public void transparentbox(int i, int j, int k, int l, int i1, int j1)
    {
        boolean flag = false;
        if(i < bnh)
        {
    ...
    public void drawpic(int i, int j, int k)
    {
        if(bne[k])
        {
            i += bna[k];
    ...
    public void drawrotatedpicture(int i, int j, int k, int l, int i1)
    {
        boolean flag = false;
        int j1 = bln;
        int k1 = bma;
...
label3:
    ...
    {
        drawtext(s, i - cem(s, k), j, k, l);
    }
    public void drawcenteredtext(String s, int i, int j, int k, int l)
    {
        drawtext(s, i - cem(s, k) / 2, j, k, l);
    }
        ...
        try
        {
            ...
            for(int i2 = 0; i2 < s.length(); i2++)
            {
                ...
                if(j1 > i1)
                {
                    if(l1 <= k1)
                        l1 = i2;
                    drawcenteredtext(s.substring(k1, l1), i, j, k, l);
                    j1 = 0;
                    k1 = i2 = l1 + 1;
                    j += cek(k);
                }
            ...
            if(j1 > 0)
            {
                drawcenteredtext(s.substring(k1), i, j, k, l);
                return;
            }
        }
