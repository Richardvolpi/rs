...
public class Class4 {
    ...
    public int method137(int i, int j, int k) {
        return Class6.method222((anInt222 * i) / 114, (anInt223 * j) / 114, (anInt224 * k) / 176);
    }
    ...
    public boolean method139(int i) {
        ...
        for(int i = 0; i < anInt181; i++)
            if(aBooleanArray183[i])
                ...
                if(anIntArray194[i] == 1)
                    method143(i, anIntArray192[i] - aClass6_180.method262(aStringArray199[i], anIntArray198[i]) / 2, anIntArray193[i], aStringArray199[i], anIntArray198[i]);
                else
                ...
                if(anIntArray194[i] == 4)
                    method150(i, anIntArray192[i], anIntArray193[i], anIntArray195[i], anIntArray196[i], anIntArray198[i], aStringArrayArray200[i], anIntArray188[i], anIntArray187[i]);
                else
                ...
                if(anIntArray194[i] == 9)
                    method154(i, anIntArray192[i], anIntArray193[i], anIntArray195[i], anIntArray196[i], anIntArray198[i], aStringArrayArray200[i], anIntArray188[i], anIntArray187[i]);
                else
    ...
    public void method142(int i, int j, int k, int l, int i1) {
        aClass6_180.method215(j, k, l, i1, 0xffffff);
        aClass6_180.method217(j, k, l, anInt215);
        aClass6_180.method218(j, k, i1, anInt215);
        aClass6_180.method217(j, (k + i1) - 1, l, anInt218);
        aClass6_180.method218((j + l) - 1, k, i1, anInt218);
        if(anIntArray189[i] == 1) {
            for(int j1 = 0; j1 < i1; j1++) {
                aClass6_180.method217(j + j1, k + j1, 1, 0);
                aClass6_180.method217((j + l) - 1 - j1, k + j1, 1, 0);
            }
    ...
    public void method143(int i, int j, int k, String s, int l) {
        int i1 = k + aClass6_180.method260(l) / 3;
    ...
    public void method144(int i, int j, int k, String s, int l) {
        ...
        if(aBooleanArray191[i])
            ...
            i1 = 0;
        aClass6_180.method256(s, j, k, l, i1);
    }
    ...
    public void method145(int i, int j, int k, int l, int i1, String s, int j1) {
        ...
        if(anIntArray194[i] == 6) {
            if(anInt203 == 1 && anInt201 >= j - l / 2 && anInt202 >= k - i1 / 2 && anInt201 <= j + l / 2 && anInt202 <= k + i1 / 2)
                anInt205 = i;
            j -= aClass6_180.method262(s, j1) / 2;
        }
        if(anInt205 == i)
            s = s + "*";
        int l1 = k + aClass6_180.method260(j1) / 3;
        method144(i, j, l1, s, j1);
    }

    public void method146(int i, int j, int k, int l) {
        aClass6_180.method208(i, j, i + k, j + l);
        aClass6_180.method214(i, j, k, l, anInt218, anInt215);
        if(aBoolean220) {
            for(int i1 = i - (j & 0x3f); i1 < i + k; i1 += 128) {
                for(int j1 = j - (j & 0x1f); j1 < j + l; j1 += 128)
                    aClass6_180.method232(i1, j1, 6 + anInt221, 128);

            }

        }
        aClass6_180.method217(i, j, k, anInt215);
        aClass6_180.method217(i + 1, j + 1, k - 2, anInt215);
        aClass6_180.method217(i + 2, j + 2, k - 4, anInt216);
        aClass6_180.method218(i, j, l, anInt215);
        aClass6_180.method218(i + 1, j + 1, l - 2, anInt215);
        aClass6_180.method218(i + 2, j + 2, l - 4, anInt216);
        aClass6_180.method217(i, (j + l) - 1, k, anInt218);
        aClass6_180.method217(i + 1, (j + l) - 2, k - 2, anInt218);
        aClass6_180.method217(i + 2, (j + l) - 3, k - 4, anInt217);
        aClass6_180.method218((i + k) - 1, j, l, anInt218);
        aClass6_180.method218((i + k) - 2, j + 1, l - 2, anInt218);
        aClass6_180.method218((i + k) - 3, j + 2, l - 4, anInt217);
        aClass6_180.method209();
    }

    public void method147(int i, int j, int k, int l) {
        aClass6_180.method215(i, j, k, l, 0);
        aClass6_180.method216(i, j, k, l, anInt212);
        aClass6_180.method216(i + 1, j + 1, k - 2, l - 2, anInt213);
        aClass6_180.method216(i + 2, j + 2, k - 4, l - 4, anInt214);
        aClass6_180.method230(i, j, 2 + anInt221);
        aClass6_180.method230((i + k) - 7, j, 3 + anInt221);
        aClass6_180.method230(i, (j + l) - 7, 4 + anInt221);
        aClass6_180.method230((i + k) - 7, (j + l) - 7, 5 + anInt221);
    }

    public void method148(int i, int j, int k) {
        aClass6_180.method230(i, j, k);
    }

    public void method149(int i, int j, int k) {
        aClass6_180.method217(i, j, k, 0);
    }

    public void method150(int i, int j, int k, int l, int i1, int j1, String as[], 
            int k1, int l1) {
        int i2 = i1 / aClass6_180.method260(j1);
        if(l1 > k1 - i2)
            l1 = k1 - i2;
        if(l1 < 0)
            l1 = 0;
        ...
        int k2 = i1 - i2 * aClass6_180.method260(j1);
        int i3 = k + (aClass6_180.method260(j1) * 5) / 6 + k2 / 2;
        for(int k3 = l1; k3 < k1; k3++) {
            method144(i, j + 2, i3, as[k3], j1);
            i3 += aClass6_180.method260(j1) - anInt225;
            if(i3 >= k + i1)
                return;
        }
    ...
    public void method151(int i, int j, int k, int l, int i1, int j1) {
        int k1 = (i + k) - 12;
        aClass6_180.method216(k1, j, 12, l, 0);
        aClass6_180.method230(k1 + 1, j + 1, anInt221);
        aClass6_180.method230(k1 + 1, (j + l) - 12, 1 + anInt221);
        aClass6_180.method217(k1, j + 13, 12, 0);
        aClass6_180.method217(k1, (j + l) - 13, 12, 0);
        aClass6_180.method214(k1 + 1, j + 14, 11, l - 27, anInt207, anInt208);
        aClass6_180.method215(k1 + 3, i1 + j + 14, 7, j1, anInt210);
        aClass6_180.method218(k1 + 2, i1 + j + 14, j1, anInt209);
        aClass6_180.method218(k1 + 2 + 8, i1 + j + 14, j1, anInt211);
    }
    ...
    public void method152(int i, int j, int k, int l, String as[]) {
        ...
        for(int k1 = 0; k1 < j1; k1++) {
            i1 += aClass6_180.method262(as[k1], l);
            if(k1 < j1 - 1)
                i1 += aClass6_180.method262("  ", l);
        }

        int l1 = j - i1 / 2;
        int i2 = k + aClass6_180.method260(l) / 3;
        for(int j2 = 0; j2 < j1; j2++) {
            ...
            if(aBooleanArray191[i])
                ...
                k2 = 0;
            if(anInt201 >= l1 && anInt201 <= l1 + aClass6_180.method262(as[j2], l) && anInt202 <= i2 && anInt202 > i2 - aClass6_180.method260(l)) {
                if(aBooleanArray191[i])
                    k2 = 0x808080;
                else
                    k2 = 0xffffff;
            ...
            if(anIntArray189[i] == j2)
                if(aBooleanArray191[i])
                    ...
                    k2 = 0xc00000;
            aClass6_180.method256(as[j2], l1, i2, l, k2);
            l1 += aClass6_180.method262(as[j2] + "  ", l);
        }
    ...
    public void method153(int i, int j, int k, int l, String as[]) {
        int i1 = as.length;
        int j1 = k - (aClass6_180.method260(l) * (i1 - 1)) / 2;
        for(int k1 = 0; k1 < i1; k1++) {
            ...
            if(aBooleanArray191[i])
                ...
                l1 = 0;
            int i2 = aClass6_180.method262(as[k1], l);
            if(anInt201 >= j - i2 / 2 && anInt201 <= j + i2 / 2 && anInt202 - 2 <= j1 && anInt202 - 2 > j1 - aClass6_180.method260(l)) {
                if(aBooleanArray191[i])
                    l1 = 0x808080;
                else
                    l1 = 0xffffff;
            ...
            if(anIntArray189[i] == k1)
                if(aBooleanArray191[i])
                    ...
                    l1 = 0xc00000;
            aClass6_180.method256(as[k1], j - i2 / 2, j1, l, l1);
            j1 += aClass6_180.method260(l);
        }

    }

    public void method154(int i, int j, int k, int l, int i1, int j1, String as[], 
            int k1, int l1) {
        int i2 = i1 / aClass6_180.method260(j1);
        if(i2 < k1) {
            int j2 = (j + l) - 12;
        ...
        for(int k3 = l1; k3 < k1; k3++) {
            ...
            if(aBooleanArray191[i])
                ...
                i4 = 0;
            if(anInt201 >= j + 2 && anInt201 <= j + 2 + aClass6_180.method262(as[k3], j1) && anInt202 - 2 <= i3 && anInt202 - 2 > i3 - aClass6_180.method260(j1)) {
                if(aBooleanArray191[i])
                    i4 = 0x808080;
                else
                    i4 = 0xffffff;
            ...
            if(anIntArray189[i] == k3 && aBoolean219)
                i4 = 0xff0000;
            aClass6_180.method256(as[k3], j + 2, i3, j1, i4);
            i3 += aClass6_180.method260(j1);
            if(i3 >= k + i1)
                return;
        }
    ...
    public int method155(int i, int j, String s, int k, boolean flag) {
    ...
    public int method156(int i, int j, int k, int l) {
    ...
    public int method163(int i, int j, int k, int l) {
