...
public class Class15 {
    ...
    public static int method352(byte byte0) {
        return byte0 & 0xff;
    }

    public static int method353(byte abyte0[], int i) {
    ...
    public static long method355(byte abyte0[], int i) {
        return (((long)method354(abyte0, i) & 0xffffffffL) << 32) + ((long)method354(abyte0, i + 4) & 0xffffffffL);
    }

    public static int method356(byte abyte0[], int i) {
        int j = method352(abyte0[i]) * 256 + method352(abyte0[i + 1]);
        if(j > 32767)
            j -= 0x10000;
        return j;
    }
    ...
    public static int method358(byte abyte0[], int i, int j) {
        int k = i >> 3;
        int l = 8 - (i & 7);
        int i1 = 0;
        for(; j > l; l = 8) {
    ...
    public static String method359(String s, int i) {
        String s1 = "";
        for(int j = 0; j < i; j++)
            if(j >= s.length()) {
                s1 = s1 + " ";
    ...
    public static String method360(int i) {
        return (i >> 24 & 0xff) + "." + (i >> 16 & 0xff) + "." + (i >> 8 & 0xff) + "." + (i & 0xff);
    }

    public static long method361(String s) {
        String s1 = "";
    ...
    public static String method362(long l) {
        if(l < 0L)
            return "invalid_name";
        String s = "";
        while(l != 0L)  {
    ...
    public static int method363(String s, byte abyte0[]) {
        int i = method353(abyte0, 0);
        int j = 0;
        s = s.toUpperCase();
    ...
    public static byte[] method365(String s, int i, byte abyte0[]) {
        return method366(s, i, abyte0, null);
    }

    public static byte[] method366(String s, int i, byte abyte0[], byte abyte1[]) {
        ...
        for(int j1 = 0; j1 < j; j1++) {
            ...
            if(k1 == k) {
                ...
                if(l1 != i2) {
                    Class3.method129(abyte1, l1, abyte0, i2, i1);
                } else {
