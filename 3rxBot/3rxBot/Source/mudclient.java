...
{
public int modewanted;
	public boolean disableHop = false;
	public static double version = 2.0;
    public static void main(String args[])
    {
        mudclient mudclient1 = new mudclient();
       mudclient1.Authenicate();
        mudclient1.loadClasses(mudclient1);
        mudclient1.dcn = false;
        mudclient1.egi = true;
        if(mudclient1.changeServer(1) && mudclient1.lls)
        {
        	mudclient1.flc(mudclient1.dch, mudclient1.dci + 11, "3rxbot by Ben v"+version , false);
        	mudclient1.countPictures();
		}
        mudclient1.fkd = 10;
    }
    ...
    public final void emg(int l)
    {
        ...
        if(j2 == 320)
        {
            ...
            super.aag.hdb(k1);
            super.aag.hdl();
            System.out.println("Opening door with direction " + k1);
        ...
        if(j2 == 2300)
        {
            ...
            super.aag.hdb(k1);
            super.aag.hdl();
             System.out.println("Closing door with direction " + k1);
        }
        if(j2 == 3300)
            fdj(e.ahj[k1], 3);
        if(j2 == 400)
    ...
    {
		/*txtTop.setFont(new Font("Tahoma", 0, 12));
		txtSend.setFont(new Font("Tahoma", 0, 12));
		txtShow.setFont(new Font("Tahoma", 0, 12));
		txtUsers.setFont(new Font("Tahoma", 0, 12));
		nickList.setFont(new Font("Tahoma", 0, 12));
		statusList.setFont(new Font("Tahoma", 0, 12));*/
    ...
    public final void eml(int l, int i1, int j1)
    {
        if(j1 == 0)
        {
...
public void OpenDoor(int x,int y, int id)
            ...
            if(k2 < ede)
            {
                ...
                if(dil >= 0)
                {
                    if(e.amd[dil] == 3)
                    {
                        ...
                        ejm[ejf] = "@lre@" + e.aib[l2] + unTrim(l2);
                        dga[ejf] = 600;
                        djk[ejf] = k2;
                        djl[ejf] = dil;
                        ejf++;
    ...
    private final void end()
    {
        ...
        char c3 = '\u044C';
        char c4 = '\u0378';
        ejg.bbg = (fog ? 4100 : 9999);
        ejg.bbh = (fog ? 4100 : 9999);
        ejg.bbi = 1;
        ejg.bbj = (fog ? 4100 : 9999);
                        ...
                        if(f1 != null)
                        {
                            ...
                            if(!flag3)
                            {
                                ...
                                if(Running)
								{
									try
									{
										script.OnChatMessage(f1.gme, f1.gne);
									}
									catch(Exception e)
									{
									}
    ...
    protected final void enj()
    {
        ...
        ejg.bbg = (fog ? 2400 : 9999);
        ejg.bbh = (fog ? 2400 : 9999);
        ejg.bbi = 1;
        ejg.bbj = (fog ? 2300 : 9999);
        ejg.bjk(-50, -10, -50);
        dnh = new x(ejg, dnb);
        dnh.gjc = efh;
        fci();
    ...
    private final void enk()
    {
        ...
        l += 47;
        dla.gfe(140, l, 200, 40);
        dla.gfd(140, l - 10, "Password:", 4, false);
        eel = dla.gfj(140, l + 10, 200, 40, 4, 20, true, false);
        l -= 47;
        dla.gfe(300, l, 75, 40);
		dla.gfd(300, l - 10, "Server:", 4, false);
        serv = dla.gfj(300, l + 10, 75, 40, 4, 1, false, false);
        l += 47;
         dla.gfe(300, l, 75, 40);
		dla.gfd(300, l - 10, "IGNORE", 4, false);
        modewanted = dla.gfj(300, l + 10, 75, 40, 4, 1, false, false);
...
label0:
    ...
    private final void fab()
    {
        ...
        i1 += 20;
        dnb.cdl("Welcome to RuneScape " + ekc, 256, i1, 4, 0xffff00);
        i1 += 30;
        String s1;
        if(eei == 0)
            s1 = "earlier today";
    ...
    public final void fah(int arg0, int arg1, int arg2, int arg3)
    {
        int l;
        int i1;
        if(arg2 == 0 || arg2 == 4)
    ...
    public final void fan(int l, int i1, int j1, int k1, boolean flag)
    {
    ...
    private final void fbb()
    {
        ...
        if(ecf == 2)
        {
            ...
            if(dla.geb(eel))
                dla.ggg(serv);
            if(dla.geb(serv) || dla.geb(eel) || dla.geb(eem))
            {
                ekc = dla.ggd(eek);
                ekd = dla.ggd(eel);
                Server = dla.ggd(serv);
                try
                {
					if(changeServer(Integer.parseInt(Server)))
					{
						abn(ekc, ekd, false);
					...
					{
						dla.ggc(eej, "Invalid world.");
					}
				}
				catch(Exception e)
				{
					dla.ggc(eej, "The server NUMBERS are ONLY NUMBERS");
				}
            }
        }
    }
    ...
    protected final void fbd()
    {
        if(ebh)
        {
            ...
            g1.setFont(new Font("Tahoma", 1, 16));
            g1.setColor(Color.yellow);
            int l = 35;
            g1.drawString("Sorry, an error has occured whilst loading RuneScape", 30, l);
            l += 50;
            g1.setColor(Color.white);
            g1.drawString("Presumably you dont have the neccessary Data files:", 30, l);
            l += 50;
            g1.setColor(Color.white);
            g1.setFont(new Font("Helvetica", 1, 12));
            g1.drawString("Download them from www.3rxnet.org/Data.rar", 30, l);
            l += 30;
            g1.drawString("Extract them into your bot folder. Ensuring the actual files are inside a folder named Data", 30, l);
            l += 30;
            g1.drawString("Dont try using the STS data files it wont work.", 30, l);
            l += 30;
            g1.drawString("Either get them from the download link above, or another bot besides STS", 30, l);
            l += 30;
            g1.drawString("Love {{zym}oti} and Ben", 30, l);
            fle(1);
            return;
        }
        if(ekh)
        ...
        try
        {
            ...
            if(ehe == 1)
            {
				...
				can = true;
				while(needs)	try{Thread.sleep(1);}catch(Exception e){}
				can = false;
                if(showGFX){fcl();}
                return;
            }
    ...
    public final void fbk(int l, int i1, int j1, int k1, boolean flag)
    {
  ...
  private final void fbn(boolean arg0)
    ...
    private final void fcc()
    {
        ...
        dnb.cdl("IRC", 457, dci + 6, 0, 0xffffff);
    }
            ...
            if(s1.startsWith("/"))
            {
				if(s1.startsWith("/run"))
				{
					if(!Running)
					{
						...
						if(args.length >= 2)
						{
							...
							if(scripts.containsKey(args[1]))
							{
								script = (Methods)scripts.get(args[1]);
								final String[] params = getArgs(s1);
								scriptThread = new Thread(new Runnable()
								{
									public void run()
									{
										Running = true;
										script.Main(params);
										fdj("@red@3rxbot: @whi@Script stopped.", 3);
										Running = false;
									}
								});
								fdj("@red@3rxbot: @whi@Starting script..", 3);
								scriptThread.start();

							}
							else
							{
								fdj("@red@3rxbot: @whi@Could not find script.", 3);
							}
						}
						else
						{
							fdj("@red@3rxbot: @whi@What are you trying to do?", 3);
						}
					}
					else
					{
						fdj("@red@3rxbot: @whi@Script already running.", 3);
					}
				}
				else if(s1.startsWith("/stop"))
				{
					display("Stopping script...");
					Running = false;
					try
					{
						scriptThread = null;
						display("Script stopped.");
				...
				else if(s1.startsWith("/hop("))
				{
					if(s1.indexOf("(") != -1 && s1.indexOf(")") != -1)
					{
						try
						{
							HopServer(Integer.parseInt(s1.substring(s1.indexOf("(") + 1, s1.indexOf(")")).trim()));
						}
						catch(Exception e)
						{
							display("Invalid world.");
						}
					}
				}
				else if(s1.startsWith("/withdraw("))
				{
					if(s1.indexOf("(") != -1 && s1.indexOf(")") != -1 && s1.indexOf(",") != -1)
					{
						try
						{
							int id = Integer.parseInt(s1.substring(s1.indexOf("(") + 1, s1.indexOf(",")));
							int amount = Integer.parseInt(s1.substring(s1.indexOf(",") + 1, s1.indexOf(")")));
							if(inBank())
							{
								super.aag.hcn(22);
								super.aag.hdj(id);
						...
						{
							display("Couldnt withdraw item.");
						}
					}
				}
				else if(s1.startsWith("/deposit("))
				{
					if(s1.indexOf("(") != -1 && s1.indexOf(")") != -1 && s1.indexOf(",") != -1)
					{
						try
						...
						{
							display("Couldnt deposit item.");
						}
					}
				}
				else
				{
					fdj("@red@3rxbot: @whi@" + s1 + " command not found.", 3);
				}
			}
			else
            {
	...
	public String msgLastSaid = "";

    protected final void fcf(int l)
    {
		if(Running)try{script.OnKeyPress(l);}catch(Exception e){}
		if(l == 1004)
			ddj.ggc(ddl, msgLastSaid);
		if(l == 1005)
			ddj.ggc(ddl, "");
		if(l == 1015)
		{
			System.out.println("Creating Documents...");
			display("Creating docs..");
			createDocs();
		}
		...
		if(l == 1017)
		{
			try
			{
				screenShot("screenShot" + pictCount);
				display("Screenshot saved as: screenShot" + pictCount + ".png");
				pictCount++;
			}
			catch(Exception e)
			{
                ...
                if(l2 == ejg.beh)
                {
                    ...
                    if(l3 == 1)
                    {
                        ...
                        if(dil >= 0)
                        {
                            ...
                            {
                                dem[ejf] = "Cast " + e.akj[dil] + " on";
                                ejm[ejf] = "@whi@" + deh[i3].gme + s1 + unTrim(deh[i3].gmf);
                                dga[ejf] = 800;
                                dfl[ejf] = deh[i3].gmh;
                                dfm[ejf] = deh[i3].gmi;
                                djk[ejf] = deh[i3].gmf;
                    ...
                    if(l3 == 2)
                    {
                        if(dil >= 0)
                        {
                            ...
                            {
                                dem[ejf] = "Cast " + e.akj[dil] + " on";
                                ejm[ejf] = "@lre@" + e.aib[dmn[i3]] + unTrim(dmn[i3]);
                                dga[ejf] = 200;
                                dfl[ejf] = dml[i3];
                                dfm[ejf] = dmm[i3];
                                djk[ejf] = dmn[i3];
                    ...
                    if(l3 == 3)
                    {
                        ...
                        if(dil >= 0)
                        {
                            ...
                            {
                                dem[ejf] = "Cast " + e.akj[dil] + " on";
                                ejm[ejf] = "@yel@" + e.ahd[dgf[i3].gmj] + unTrim(dgf[i3].gmj);
                                dga[ejf] = 700;
                                dfl[ejf] = dgf[i3].gmh;
                                dfm[ejf] = dgf[i3].gmi;
                                djk[ejf] = dgf[i3].gmf;
                        ...
                        } else
                        {
                            ...
                            {
                                dem[ejf] = "Attack";
                                ejm[ejf] = "@yel@" + e.ahd[dgf[i3].gmj] + s2 + unTrim(dgf[i3].gmj);
                                if(l4 >= 0)
                                    dga[ejf] = 715;
                                else
                                    dga[ejf] = 2715;
                ...
                if(l2 != null && l2.chk >= 10000)
                {
                    ...
                    if(!eah[j3])
                    {
                        if(dil >= 0)
                        {
                            ...
                            {
                                dem[ejf] = "Cast " + e.akj[dil] + " on";
                                ejm[ejf] = "@cya@" + e.ahi[i4] + unTrim(i4);
                                dga[ejf] = 300;
                                dfl[ejf] = dhg[j3];
                                dfm[ejf] = dhh[j3];
                                djk[ejf] = ecn[j3];
                ...
                if(l2 != null && l2.chk >= 0)
                {
                    ...
                    if(!dij[k3])
                    {
                        if(dil >= 0)
                        {
                            ...
                            {
                                dem[ejf] = "Cast " + e.akj[dil] + " on";
                                ejm[ejf] = "@cya@" + e.ajm[j4] + unTrim(j4);
                                dga[ejf] = 400;
                                dfl[ejf] = ekm[k3];
                                dfm[ejf] = ekn[k3];
                                djk[ejf] = elb[k3];
    ...
    private final void fcl()
    {
        ...
        if(dim)
        {
            ...
            ejg.bbg = (fog ? 3000 : 9999);
            ejg.bbh = (fog ? 3000 : 9999);
            ejg.bbi = 1;
            ejg.bbj = (fog ? 2800 : 9999);
            dkg = eli * 32;
            int j6 = dgc + egl;
            int k8 = dgd + dhl;
        ...
        } else
        {
            ...
            {
                ejg.bbg = (fog ? 2200 : 9999);
                ejg.bbh = (fog ? 2200 : 9999);
                ejg.bbi = 1;
                ejg.bbj = (fog ? 2100 : 9999);
            }
            int k6 = dgc + egl;
            int l8 = dgd + dhl;
        ...
        int x = 130;
        dnb.cdn("@red@Pid@red@(@whi@"+getPid()+"@red@)", 10, x, 1, 0xffff00);
        x += 12;
        dnb.cdn("@red@Coords@red@(@whi@"+getX()+","+getY()+"@red@)", 10, x, 1, 0xffff00);
        x += 12;
        dnb.cdn("@red@XP Gained@red@"+"(@whi@"+xpCounter+"@red@)", 10, x, 1, 0xffff00);
        x += 12;
        dnb.cdn("@red@Username@red@"+"(@whi@"+ekc+"@red@)", 10, x, 1, 0xffff00);
        x += 12;
        dnb.cdn("@red@Server@red@"+"(@whi@"+Server+"@red@)", 10, x, 1, 0xffff00);
        if(!elk)
        {
    ...
    {
		if(Running)try{if(!s1.startsWith("@pri@"))script.OnServerMessage(s1);}catch(Exception e){}
        ...
        {
			if(Running && !s1.toLowerCase().startsWith("@pri@you tell"))try{script.OnPrivateMessage(s1.substring(s1.indexOf("@pri@") + 5, s1.indexOf(":")),s1.substring(s1.indexOf(": tells you") + 11));}catch(Exception e){}
            fdj(s1, 6);
            return;
        } else
        {
    ...
    private final void fec(boolean arg0)
    {
        ...
        if(dii == 0)
        {
            ...
            if(j2 != -1)
            {
                ...
                l1 += 12;
                dnb.cdn("Left: " + ((j3 / 4) - (edn[j2] / 4)), l + 5, l1, 1, 0xffffff);
            } else
            {
     ...
     public void AddToOffer(int id, int amount)
    {
	 if(djg < 12)
	 {
		...
		fdj("@red@3rxbot: @whi@You can't fit that much into a trade screen!", 3);
	 }
    }
    ...
    void loadClasses(mudclient mudclient1)
	{
		scripts.clear();
		...
		try
		{
			URLClassLoader cl = new URLClassLoader(new URL[] { new File("./Scripts/").toURL() });
			for(int i = 0; i < files.length; i++)
			{
				if(files[i].endsWith(".class") && files[i].indexOf("$") == -1)
				{
					try
					{
						...
						Methods macro = (Methods)clazz.getConstructor(new Class[]{mudclient.class}).newInstance(new Object[]{mudclient1});
	...
	public final String servIps[] = {
		"217.138.31.250", "217.138.31.250", "209.237.251.20", "209.237.251.20", "69.22.158.236", "69.22.158.236"
	};

	public final int serverPorts[] = {
		43595, 43594
	};

	public void chServ(String ip, int port)
	{
		super.aac = ip;
		super.aad = port;
	}

	public boolean changeServer(int num)
	{
		if(num < 7 && num > 0)
		{
			chServ(servIps[num - 1], serverPorts[(num%2) != 0 ? 1 : 0]);
			return true;
		}
		return false;
	}
	...
	{
		return ((dgf[i].gmh - 64) / ehd) + dni;
	}

	public int npcY(int i)
	{
		return ((dgf[i].gmi - 64) / ehd) + dnj;
	}

	public int npcType(int i)
	{
		return dgf[i].gmj;
	}

	public int npcId(int i)
	{
		return dgf[i].gmf;
	}
	...
	{
		return dgf[i].gml == 8 || dgf[i].gml == 9;
	}

	public int getX()
	{
		return (djc.gmh - 64) / ehd + dni;
	}

	public int getY()
	{
		return (djc.gmi - 64) / ehd + dnj;
	}

	public boolean inArray(int[] array, int i)
	{
	...
	public boolean npcHpBarShowing(int i)
	{
		return (dgf[i].gnl > 0);
	}
	...
	*/
	...
	{
		return (e.alb[id] + e.ale[id] + e.alc[id] + e.ald[id]) / 4;
	}
	...
	{
		long id = -1;
		for(int i = 0; i < super.aak; i++)
		{
			if(t.fnd(super.aal[i]).equalsIgnoreCase(to))
                id = super.aal[i];
		}
		if(id != -1)
		{
			try
			{
				int j1 = v.cek(message);
				acl(id, v.ceg, j1);
				message = v.cej(v.ceg, 0, j1);
				message = u.fgd(message);
				adg("@pri@You tell " + t.fnd(id) + ": " + message);
			}
			catch(Exception e)
			{
			}
	...
	public void addToFriends(String username)
	{
		...
		if(username.length() > 0 && t.fnc(username) != djc.gmd)
			acj(username);
	}

	public void addToIgnore(String username)
	{
		username = username.trim();
		if(username.length() > 0 && t.fnc(username) != djc.gmd)
			ach(username);
	...
	{
		String[] names = new String[super.aak];
		for(int i = 0; i < super.aak; i++)
		{
			names[i] = t.fnd(super.aal[i]);
		}
		return names;
	}
	...
	{
		String[] names = new String[super.aan];
		for(int i = 0; i < super.aan; i++)
		{
			names[i] = t.fnd(super.aba[i]);
		}
		return names;
	}

	public void RemoveFromIgnore(String username)
	{
		username = username.trim();
		long id = -1;
		for(int i = 0; i < super.aan; i++)
		{
			if(t.fnd(super.aba[i]).equalsIgnoreCase(username))
				id = super.aba[i];
		}
		try
		{
	...
	public void RemoveFromFriends(String username)
	{
		...
		for(int i = 0; i < super.aak; i++)
		{
			if(t.fnd(super.aal[i]).equalsIgnoreCase(username))
				id = super.aal[i];
		}
		try
		{
	...
	public boolean isOnFriendsList(String username)
	{
		...
		{
			if(getFriendsList()[i].equalsIgnoreCase(username))
				return true;
		}
		return false;
	}

	public boolean isOnIgnoreList(String username)
	{
		for(int i = 0; i < getIgnoreList().length; i++)
		{
			if(getIgnoreList()[i].equalsIgnoreCase(username))
				return true;
		}
		return false;
	}
	...
	public String getQuestOption(int idx)
	{
		try
		{
			return dda[idx];
...
public int PlayerId(int i)
	...
	{
		return ((djc.gna + 1) % 10 != djc.gmn);
	}

	public int countBank(int id)
	{
	...
	{
		if(id >= 0 && id < e.aid.length)
		{
			String s = e.aid[id].toLowerCase();
			return s.indexOf("eat") != -1;
		}
		return false;
	}
	...
	{
		int i = (dnh.gjl(djd, dje, x - dni, y - dnj, x - dni, y - dnj, dnn, eaa, false));
	...
	public String wallObjectName(int i)
	{
		if(i >= 0 && i < e.ahi.length)
			return e.ahi[i];
		return null;
	}

	public String wallObjectDesc(int i)
	{
		if(i >= 0 && i < e.ahj.length)
			return e.ahj[i];
		return null;
	}
	...
	{
		if(index >= 0 && index < dgm)
			return (deh[index].gmh - 64) / ehd + dni;
		return -1;
	}
	...
	{
		if(index >= 0 && index < dgm)
			return (deh[index].gmi - 64) / ehd + dnj;
		return -1;
	}

	public int playerDestX(int index)
	{
		if(index >= 0 && index < deh.length)
		{
	...
	public boolean isPlayerWalking(int idx)
	{
		if(idx < 0 || idx >= dgm)
			return false;
		return ((deh[idx].gna + 1) % 10 != deh[idx].gmn);
	}

	public String playerName(int index)
	{
		if(index >= 0 && index < dgm)
			return deh[index].gme;
		return null;
	}
	...
	{
		if(index >= 0 && index < dgm)
			return (deh[index].gml == 8 || deh[index].gml == 9);
		return false;
	}
	...
	private void createDocs()
	{
		try
		{
			File docDir = new File("Documentation");
			if(docDir.exists())
			{
				System.out.println("Documentation already exists,\nIf you wish to re-generate please delete its folder.");
				display("Documentation already exists, Please delete its folder to re-generate.");
			}
			else if(docDir.mkdir())
			{
				File idsDir = new File("Documentation/Ids");
				System.out.println("Creating template script..");
				createTemplate("Documentation/");
				System.out.println("Creating command list..");
				createCmdList("Documentation/");
				System.out.println("Creating ids folder..");
				if(idsDir.mkdir())
				{
					System.out.println("Creating monsters documentation..");
					createMonsters("Documentation/Ids");
					System.out.println("Creating stats documentation..");
					createStat("Documentation/Ids");
					System.out.println("Creating prayers documentation..");
					createPray("Documentation/Ids");
					System.out.println("Creating spells documentation..");
					createSpell("Documentation/Ids");
					System.out.println("Creating items documentation..");
					createItem("Documentation/Ids");
					System.out.println("Creating objects documentation..");
					createObject("Documentation/Ids");
					System.out.println("Creating wall objects documentation..");
					createWallObject("Documentation/Ids");
					System.out.println("Creating quests documentation..");
					createQuest("Documentation/Ids");
				}
			}
		}
		catch(Exception e)
		{
			...
			System.out.println("Documentation creation failed.");
		}
	}

	private void createMonsters(String where)
	{
		try
		{
			if(false)
			...
			{
				File doc = new File(where + "/monsters.htm");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "\n";
					out.write("<html>"+n);
					out.write("<head>"+n);
					out.write("<title> Mosters Documentation </title>"+n);
					out.write("</head>"+n);
					out.write("<body bgcolor=\"#000000\" text=\"#000000\">"+n);
					out.write("<font color=\"#555555\" face=\"Tahoma\" size=\"20px\"><center><b>Monsters Documentation</b></center></font><br />"+n);
					for(int i = 0; i < e.ahd.length; i++)
					{
						out.write("<table bgcolor=\"#ffffff\" cellspacing=\"3\" cellpadding=\"2\" width=\"700\" align=\"center\">"+n);
						out.write("<tr>"+n);
						out.write("<th bgcolor=\"#ff0000\" width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" color=\"#FFFFFF\" size=\"2px\">" + e.ahd[i] + "</font>"+n);
						out.write("</th>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>ID:</b> " + i + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Attackable:</b> " + (e.alf[i] > 0 ? "Yes" : "No") + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Description:</b> " + e.ahe[i] + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Combat Level:</b> " + ((e.alb[i] + e.ale[i] + e.alc[i] + e.ald[i]) / 4) + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("</table><br />"+n);
					}
					out.write("<center><font color=\"#ff0000\" face=\"Arial\" size=\"2px\">Generated by 3rxbot, irc.3rxnet.org / www.3rxnet.org/frm/so</font></center>"+n);
					out.write("</body>"+n);
					out.write("</html>"+n);
					out.write("<!-- 3rxbot is an 3rxnet product, Created by Ben Barkay aka OMFG -->"+n);
					out.close();
				}
			}
		}
	...
	private void createStat(String where)
	{
		try
		{
			if(false)
			...
			{
				File doc = new File(where + "/stats.htm");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "\n";
					out.write("<html>"+n);
					out.write("<head>"+n);
					out.write("<title> Stats Documentation </title>"+n);
					out.write("</head>"+n);
					out.write("<body bgcolor=\"#000000\" text=\"#000000\">"+n);
					out.write("<font color=\"#555555\" face=\"Tahoma\" size=\"20px\"><center><b>Stats Documentation</b></center></font><br />"+n);
					for(int i = 0; i < eba.length; i++)
					{
						out.write("<table bgcolor=\"#ffffff\" cellspacing=\"3\" cellpadding=\"2\" width=\"700\" align=\"center\">"+n);
						out.write("<tr>"+n);
						out.write("<th bgcolor=\"#ff0000\" width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" color=\"#FFFFFF\" size=\"2px\">" + eba[i] + "</font>"+n);
						out.write("</th>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
	...
	private void createPray(String where)
	{
		try
		{
			if(false)
			...
			{
				File doc = new File(where + "/prayers.htm");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "\n";
					out.write("<html>"+n);
					out.write("<head>"+n);
					out.write("<title> Prayers Documentation </title>"+n);
					out.write("</head>"+n);
					out.write("<body bgcolor=\"#000000\" text=\"#000000\">"+n);
					out.write("<font color=\"#555555\" face=\"Tahoma\" size=\"20px\"><center><b>Prayers Documentation</b></center></font><br />"+n);
					for(int i = 0; i < e.ake.length; i++)
					{
						out.write("<table bgcolor=\"#ffffff\" cellspacing=\"3\" cellpadding=\"2\" width=\"700\" align=\"center\">"+n);
						out.write("<tr>"+n);
						out.write("<th bgcolor=\"#ff0000\" width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" color=\"#FFFFFF\" size=\"2px\">" + e.aim[i] + "</font>"+n);
						out.write("</th>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						...
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Level to use:</b> " + e.ake[i] + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Description:</b> " + e.ain[i] + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Drain rate:</b> " + e.akf[i] + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("</table><br />"+n);
					}
	...
	private void createSpell(String where)
	{
		try
		{
			if(false)
			...
			{
				File doc = new File(where + "/spells.htm");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "\n";
					out.write("<html>"+n);
					out.write("<head>"+n);
					out.write("<title> Spells Documentation </title>"+n);
					out.write("</head>"+n);
					out.write("<body bgcolor=\"#000000\" text=\"#000000\">"+n);
					out.write("<font color=\"#555555\" face=\"Tahoma\" size=\"20px\"><center><b>Spells Documentation</b></center></font><br />"+n);
					for(int i = 0; i < e.amb.length; i++)
					{
						out.write("<table bgcolor=\"#ffffff\" cellspacing=\"3\" cellpadding=\"2\" width=\"700\" align=\"center\">"+n);
						out.write("<tr>"+n);
						out.write("<th bgcolor=\"#ff0000\" width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" color=\"#FFFFFF\" size=\"2px\">" + e.akj[i] + "</font>"+n);
						out.write("</th>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						...
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Level to use:</b> " + e.amb[i] + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Description:</b> " + e.akk[i] + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("</table><br />"+n);
					}
	...
	private void createItem(String where)
	{
	try
		{
			if(false)
			...
			{
				File doc = new File(where + "/items.htm");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "\n";
					out.write("<html>"+n);
					out.write("<head>"+n);
					out.write("<title> Items Documentation </title>"+n);
					out.write("</head>"+n);
					out.write("<body bgcolor=\"#000000\" text=\"#000000\">"+n);
					out.write("<font color=\"#555555\" face=\"Tahoma\" size=\"20px\"><center><b>Items Documentation</b></center></font><br />"+n);
					for(int i = 0; i < e.aib.length; i++)
					{
						out.write("<table bgcolor=\"#ffffff\" cellspacing=\"3\" cellpadding=\"2\" width=\"700\" align=\"center\">"+n);
						out.write("<tr>"+n);
						out.write("<th bgcolor=\"#ff0000\" width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" color=\"#FFFFFF\" size=\"2px\">" + e.aib[i] + "</font>"+n);
						out.write("</th>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						...
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Description:</b> " + e.aic[i] + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("</table><br />"+n);
					}
	...
	private void createObject(String where)
	{
	try
		{
			if(false)
			...
			{
				File doc = new File(where + "/objects.htm");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "\n";
					out.write("<html>"+n);
					out.write("<head>"+n);
					out.write("<title> Objects Documentation </title>"+n);
					out.write("</head>"+n);
					out.write("<body bgcolor=\"#000000\" text=\"#000000\">"+n);
					out.write("<font color=\"#555555\" face=\"Tahoma\" size=\"20px\"><center><b>Objects Documentation</b></center></font><br />"+n);
					for(int i = 0; i < e.ajm.length; i++)
					{
						out.write("<table bgcolor=\"#ffffff\" cellspacing=\"3\" cellpadding=\"2\" width=\"700\" align=\"center\">"+n);
						out.write("<tr>"+n);
						out.write("<th bgcolor=\"#ff0000\" width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" color=\"#FFFFFF\" size=\"2px\">" + e.ajm[i] + "</font>"+n);
						out.write("</th>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						...
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Description:</b> " + e.ajn[i] + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("</table><br />"+n);
					}
	...
	private void createWallObject(String where)
	{
	try
		{
			if(false)
			...
			{
				File doc = new File(where + "/wallObjects.htm");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "\n";
					out.write("<html>"+n);
					out.write("<head>"+n);
					out.write("<title> Wall Objects Documentation </title>"+n);
					out.write("</head>"+n);
					out.write("<body bgcolor=\"#000000\" text=\"#000000\">"+n);
					out.write("<font color=\"#555555\" face=\"Tahoma\" size=\"20px\"><center><b>Wall Objects Documentation</b></center></font><br />"+n);
					for(int i = 0; i < e.ahi.length; i++)
					{
						out.write("<table bgcolor=\"#ffffff\" cellspacing=\"3\" cellpadding=\"2\" width=\"700\" align=\"center\">"+n);
						out.write("<tr>"+n);
						out.write("<th bgcolor=\"#ff0000\" width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" color=\"#FFFFFF\" size=\"2px\">" + e.ahi[i] + "</font>"+n);
						out.write("</th>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						...
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" size=\"2px\"><b>Description:</b> " + e.ahj[i] + "</font>"+n);
						out.write("</td>"+n);
						out.write("</tr>"+n);
						out.write("</table><br />"+n);
					}
	...
	private void createQuest(String where)
	{
	try
		{
			if(false)
			...
			{
				File doc = new File(where + "/quests.htm");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "\n";
					out.write("<html>"+n);
					out.write("<head>"+n);
					out.write("<title> Quests Documentation </title>"+n);
					out.write("</head>"+n);
					out.write("<body bgcolor=\"#000000\" text=\"#000000\">"+n);
					out.write("<font color=\"#555555\" face=\"Tahoma\" size=\"20px\"><center><b>Quests Documentation</b></center></font><br />"+n);
					for(int i = 0; i < dei.length; i++)
					{
						out.write("<table bgcolor=\"#ffffff\" cellspacing=\"3\" cellpadding=\"2\" width=\"700\" align=\"center\">"+n);
						out.write("<tr>"+n);
						out.write("<th bgcolor=\"#ff0000\" width=\"700\">"+n);
						out.write("<font face=\"Tahoma\" color=\"#FFFFFF\" size=\"2px\">" + dei[i] + "</font>"+n);
						out.write("</th>"+n);
						out.write("</tr>"+n);
						out.write("<tr>"+n);
						out.write("<td width=\"700\">"+n);
	...
	private void createTemplate(String where)
	{
	try
		{
			if(false)
			...
			{
				File doc = new File(where + "/template.java");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "\n";
					out.write("public class template extends Methods"+n);
					out.write("{"+n);
					out.write(""+n);
					out.write("     public template(mudclient rs)"+n);
					out.write("     {"+n);
					out.write("          super(rs);"+n);
					out.write("     }"+n);
					out.write(""+n);
					out.write("     public void Main(String[] args)"+n);
					out.write("     {"+n);
					out.write("          //In here you type whatever you want to do when the script starts"+n);
					out.write("          while(Running())"+n);
					out.write("          {"+n);
					out.write("               //This is the main loop, Everything the script does while running goes in here"+n);
					out.write("          }"+n);
					out.write("     }"+n);
					out.write(""+n);
					out.write("     public void OnServerMessage(String message)"+n);
					out.write("     {"+n);
					out.write("          //When there is a server message, This void is triggered."+n);
					out.write("     }"+n);
					out.write(""+n);
					out.write("     public void OnChatMessage(String sender, String message)"+n);
					out.write("     {"+n);
					out.write("          //When there is a chat message, This void is triggered."+n);
					out.write("     }"+n);
					out.write(""+n);
					out.write("     public void OnPrivateMessage(String sender, String message)"+n);
					out.write("     {"+n);
					out.write("          //When there is a private message, This void is triggered."+n);
					out.write("     }"+n);
					out.write(""+n);
					out.write("     public void OnKeyPress(long keycode)"+n);
					out.write("     {"+n);
					out.write("          //When the user clicks on a button, This void is called."+n);
					out.write("     }"+n);
					out.write("}"+n);
					out.write("// 3rxbot is an 3rxnet(3rxnet.org) product, Created by Ben Barkay aka OMFG"+n);
					out.close();
				}
			}
		}
	...
	private void createCmdList(String where)
	{
		try
		{
			if(false)
			...
			{
				File doc = new File(where + "/commandList.htm");
				if(doc.createNewFile())
				{
					BufferedWriter out = new BufferedWriter(new FileWriter(doc.getPath()));
					String n = "<br />\n";
					out.write("<html>\n");
					out.write("<head>\n");
					out.write("<title> Command List </title>\n");
					out.write("</head>\n");
					out.write("<body bgcolor=\"#FFFFFF\" text=\"#000000\">\n");
					out.write("<font face=\"Courier\" size=\"3px\">\n");
					out.write("<b>/** Server Functions **/</b>"+n);
					out.write("boolean ChangeWorld(int i) - Changes to the given world"+n);
					out.write("int GetWorld() - returns the world your currently on"+n);
					out.write("boolean LoggedIn() - returns true if your logged in"+n);
					out.write("void LogOut() - Logs you out if possible (10sec rule still applies)"+n);
					out.write("void AutoLogin(boolean on) - true to enable, false to disable"+n);
					out.write("boolean IsAutoLogin() - return true is AutoLogin is enabled, false if it isn't"+n);
					out.write("void Login(String user, String pass) - tries to login with the given user and pass"+n);
					out.write("void HopServer() - hops to the next server"+n);
					out.write("<b>/** Npc Functions **/</b>"+n);
					out.write("int CountNpcs() - returns the amount of NPCs near you"+n);
					out.write("int[] GetNpcById(int id) - returns the npc's index, x-coord and y-coord as an array, ignores npc's that are in combat"+n);
					out.write("int[] GetNpcById(int[] id) - returns the npc's index, x-coord and y-coord as an array, ignores npc's that are in combat"+n);
					out.write("int[] GetAllNpcById(int id) - returns the npc's index, x-coord and y-coord as an array, including ones in combat"+n);
					out.write("int[] GetAllNpcById(int[] id) - returns the npc's index, x-coord and y-coord as an array, including ones in combat"+n);
					out.write("boolean NpcAttackable(int id) - returns true if the npc is attackable"+n);
					out.write("boolean NpcInCombat(int index) - returns true if the npc is in combat, false if it isnt"+n);
					out.write("boolean NpcHealthBarShowing(int index) -returns true if the npc's health bar is showing , false if it isnt"+n);
					out.write("String NpcName(int id) - returns the name of the given npc"+n);
					out.write("String NpcDesc(int id) - returns the npc's description"+n);
					out.write("int NpcCombat(int id) - returns the combat level of the given npc"+n);
					out.write("void AttackNpc(int index) - attacks npc's based on their index"+n);
					out.write("void TalkToNpc(int index) - talks to npc's based on their index"+n);
					out.write("void ThieveNpc(int index) - thieves to npc's based on their index"+n);
					out.write("int NpcId(int index) - returns the id of the given npc"+n);
					out.write("int NpcX(int index) - returns the x-coord of the given npc"+n);
					out.write("int NpcY(int index) - returns the y-coord of the given npc"+n);
					out.write("void UseOnNpc(int pos, int index) - uses item in position pos, on the given npc"+n);
					out.write("<b>/** Communication Functions **/</b>"+n);
					out.write("void Speak(String s) - say the given message"+n);
					out.write("void SendPM(String to, String message) - send a private message to the given player"+n);
					out.write("void AddToFriends(String player) - add the specified player to your friend list"+n);
					out.write("void AddToIgnore(String player) - add the specified player to your ignore list"+n);
					out.write("String[] GetFriendList() - returns an array containing the names of everyone on your friend list"+n);
					out.write("String[] GetIgnoreList() - returns an array containing the names of everyone on your ignore list"+n);
					out.write("void RemoveFromFriends(String player) - removes the given name from your friend list"+n);
					out.write("void RemoveFromIgnore(String player) - removes the given name from your ignore list"+n);
					out.write("boolean IsOnFriendList(String player) - returns true if the given player is on your friend list, otherwise false"+n);
					out.write("boolean IsOnIgnoreList(String player) - returns true if the given player is on your ignore list, otherwise false"+n);
					out.write("<b>/** Spell Functions **/</b>"+n);
					out.write("void CastOnNpc(int spell, int index) - casts the spell on an npc based on their index"+n);
					out.write("void CastOnItem(int spell, int pos) - cast the spell on an item based on its position in your inventory"+n);
					out.write("void CastOnGItem(int spell, int id, int x, int y) - cast the spell on an item on the ground"+n);
					out.write("<b>/** Npc Interaction Functions **/</b>"+n);
					out.write("boolean QuestMenu() - returns true if the quest menu is visible, false otherwise"+n);
					out.write("int CountQuestMenu() - returns the amount of options on the quest menu"+n);
					out.write("String GetQuestOption(int i) - returns the given option"+n);
					out.write("void Answer(int i) - answers the quest menu with the given option"+n);
					out.write("<b>/** Bank & Shop Functions **/</b>"+n);
					out.write("void Withdraw(int id, int amount) - withdraws the given amount of items from your bank (can only withdraw 1 non-stackable at a time)"+n);
					out.write("void Deposit(int id, int amount) - deposit the given amount of items into your bank"+n);
					out.write("boolean ItemInBank(int id) - returns true if the item is in your bank"+n);
					out.write("int CountInBank(int id) - returns the amount of the given item in your bank"+n);
					out.write("boolean InBank() - returns true if your bank is open, false is it isn't"+n);
					out.write("void CloseBank() - closes the bank screen"+n);
					out.write("boolean InShop() - returns true if the shop screen is open"+n);
					out.write("void CloseShop() - closes the shop screen"+n);
					out.write("int FindShopSlot(int id)"+n);
					out.write("void BuyShopItem(int id) - buy the given item from the shop"+n);
					out.write("void SellShopItem(int id) - sell the given item to the shop"+n);
					out.write("int ShopBuyPrice(int id) - returns the price of the given item in the shop"+n);
					out.write("int ShopSellPrice(int id) - returns the price the shop will give for the item"+n);
					out.write("int CountShop(int id) - returns the amount of the given item in the shop"+n);
					out.write("<b>/** Status Functions **/</b>"+n);
					out.write("boolean Sleeping() - returns true if you are currently sleeping"+n);
					out.write("void SetMode(int i) - sets your fightmode"+n);
					out.write("int GetMode() - returns your current fightmode"+n);
					out.write("int GetPid() - returns your current player id"+n);
					out.write("int GetFatigue() - returns your fatigue level"+n);
					out.write("long GetExp(int i) - returns the amount of exp in the given stat"+n);
					out.write("String GetLvlName(int i) - returns the name of the given stat"+n);
					out.write("int GetCurLvl(int i) - returns your current level in the given stat"+n);
					out.write("int GetMaxLvl(int i) - returns your max level in the given stat"+n);
					out.write("int GetCombatLvl() - returns your combat level"+n);
					out.write("int GetX() - returns your x-coord"+n);
					out.write("int GetY() - returns your y-coord"+n);
					out.write("boolean InCombat() - returns true if your in combat, false if your not"+n);
					out.write("boolean HealthBarShowing() returns true if your health bar is showing, false if it isn't"+n);
					out.write("int HitsPercent() - returns your current hp as a percentage"+n);
					out.write("boolean IsPrayerOn(int i) - returns true if the given prayer is switched on"+n);
					out.write("void PrayerOn(int i) - turn on the given prayer"+n);
					out.write("void PrayerOff(int i) - turn off the given prayer"+n);
					out.write("int PrayerLvl(int i) - returns the required level for the given prayer"+n);
					out.write("boolean QuestDone(int i) - returns true if the given quest is completed"+n);
					out.write("boolean IsWalking() - returns true if you are currently walking"+n);
					out.write("<b>/** Inventory Functions **/</b>"+n);
					out.write("int CountInv() - returns the amount of items in your inventory"+n);
					out.write("int CountInv(int id) - returns the amount of the given item in your inventory"+n);
					out.write("int CountInv(int[] id) - returns the amount of the given items in your inventory"+n);
					out.write("boolean InInv(int id) - returns true if the given item is in your inventory, false if it isn't"+n);
					out.write("int GetItemPos(int id) - returns the position of the given item in your inventory"+n);
					out.write("void UseItem(int pos) - use an item based on its position"+n);
					out.write("void UseItemWithItem(int pos1, int pos2) - use the item in the first given position with the item in the second given position"+n);
					out.write("void DropItem(int pos) - drop the item in the given position"+n);
					out.write("boolean IsItemWearable(int id) - returns true if the given item is wearable"+n);
					out.write("boolean WearingItem(int pos) - returns true if your wearing the item in the given position"+n);
					out.write("void WearItem(int pos) - wears the item in the given position"+n);
					out.write("void RemoveItem(int pos) - removes the item in the given position"+n);
					out.write("boolean CanEat(int id) - returns true if the given item can be eaten"+n);
					out.write("void UseItemOnGItem(int pos, int x, int y, int id) - uses an item in your iventory with an item on the ground"+n);
					out.write("int InvItemId(int pos) - returns the id of the item in the given position"+n);
					out.write("<b>/** Movement Functions **/</b>"+n);
					out.write("void WalkTo(int x,int y) - walk to the given coords"+n);
					out.write("void WalkToWait(int x,int y) - walk to the given coords and pause the script until you are at them"+n);
					out.write("void ForceWalkTo(int x,int y) - used to walk to the given coords even if a person is currently standing there"+n);
					out.write("void ForceWalkToWait(int x, int y) - used to walk to the given coords even if a person is currently standing there"+n);
					out.write("boolean IsReachable(int x, int y) - returns true if you can reach the current coords"+n);
					out.write("<b>/** Wall Object Functions **/</b>"+n);
					out.write("int CountWallObjects() - returns the amount of wall objects near you"+n);
					out.write("int[] GetWallObjectById(int id) - returns the id, x-coord and y-coord of the nearest given wall object"+n);
					out.write("int[] GetWallObjectById(int[] id) - returns the id, x-coord and y-coord of the nearest given wall object"+n);
					out.write("int GetWallObjectByCoords(int x, int y)"+n);
					out.write("void AtWallObject(int x,int y) - main action on the wall object at the given coords"+n);
					out.write("void AtWallObject2(int x,int y) - secondary action on the wall object at the given coords"+n);
					out.write("int GetIdWallObject(int x, int y) - returns the id of the wallobject at the given coords"+n);
					out.write("void UseOnWallObject(int pos, int x, int y) - use the item in the given pos on the wallobject at the given coords"+n);
					out.write("int WallObjectX(int index) - returns the X coord of the given wallobject"+n);
					out.write("int WallObjectY(int index) - returns the Y coord of the given wallobject"+n);
					out.write("int WallObjectId(int index) - returns the Id of the given wallobject"+n);
					out.write("String WallObjectName(int id) - returns the name of the given wallobject"+n);
					out.write("String WallObjectDesc(int id) - returns the description of the given wallobject"+n);
					out.write("<b>/** Item Functions **/</b>"+n);
					out.write("int CountItems() - returns the amount of items near you"+n);
					out.write("String ItemName(int id) - returns the name of the given item"+n);
					out.write("String ItemDesc(int id) - returns the description of the given item"+n);
					out.write("int[] GetItemById(int id) - returns the id, x-coord and y-coord of the nearest given item"+n);
					out.write("int[] GetItemById(int[] id) - returns the id, x-coord and y-coord of the nearest given item"+n);
					out.write("void PickupItem(int x, int y) - picks up the item at the specified coords"+n);
					out.write("void PickupItem(int x, int y, int id) - picks up an item based on its coords and id"+n);
					out.write("void PickupItemById(int id) - picks up the closest item of the given id"+n);
					out.write("void PickupItemById(int[] id) - picks up the closest item of the given ids"+n);
					out.write("int ItemX(int index) - returns the X coord of the given item"+n);
					out.write("int ItemY(int index) - returns the Y coord of the given item"+n);
					out.write("int ItemId(int index) - returns the Id of the given item"+n);
					out.write("<b>/** Object Functions **/</b>"+n);
					out.write("int CountObjects() - returns the amount of objects near you"+n);
					out.write("int[] GetObjectById(int id) - returns the id, x-coord and y-coord of the nearest given object"+n);
					out.write("int[] GetObjectById(int[] id) - returns the id, x-coord and y-coord of the nearest given object"+n);
					out.write("void AtObject(int x,int y) - main action on the object at the given coords"+n);
					out.write("void AtObject2(int x,int y) - secondary action on the object at the given coords"+n);
					out.write("void UseOnObject(int pos, int x, int y) - use the item in the given position on the given object"+n);
					out.write("int GetIdObject(int x, int y) - return the id of the object at the specified coords"+n);
					out.write("int ObjectX(int index) - returns the X coord of the given object"+n);
					out.write("int ObjectY(int index) - returns the Y coord of the given object"+n);
					out.write("int ObjectId(int index) - returns the Id of the given object"+n);
					out.write("String ObjectName(int id) - returns the name of the given object"+n);
					out.write("String ObjectDesc(int id) - returns the description of the given object"+n);
					out.write("boolean IsObjectAt(int id, int x, int y) - returns true if an object on the given id is at the given coords"+n);
					out.write("boolean IsObjectAt(int[] id, int x, int y) - returns true if an object on the given ids is at the given coords"+n);
					out.write("<b>/** Setup Functions **/</b>"+n);
					out.write("void SaveScreenShot(String name) - Will save a screenshot with the specified name."+n);
					out.write("String GetInput(String message) - prompts the user for input and returns it as a string"+n);
					out.write("String GetRsName() - returns the users username"+n);
					out.write("String GetAuthName() - returns the users forum name"+n);
					out.write("int DistanceTo(int x, int y) - returns the distance between you and the given coords"+n);
					out.write("int DistanceTo(int x1, int y1, int x2, int y2) - returns the distance between the given coords"+n);
					out.write("void UnlockMode() - return the fightmode to normal"+n);
					out.write("void LockMode(int i) - lock the fightmode to the given mode"+n);
					out.write("void End() - stop the script"+n);
					out.write("void Die(String s) - display the given message then exit the bot"+n);
					out.write("void Die() - totally exit the bot"+n);
					out.write("void Display(String s) - display the given message"+n);
					out.write("void Display(int i) - display the given message"+n);
					out.write("int Rand(int low, int high) - returns a random number between the given boundaries"+n);
					out.write("boolean Running() - returns true if the script is still running"+n);
					out.write("void Wait(int ms) - pause the script for the given length of milliseconds"+n);
					out.write("long GetMillis() - returns the system time"+n);
					out.write("String IntToStr(int i) - converts an integer to a string"+n);
					out.write("String IntToStr(long i) - converts a long to a string"+n);
					out.write("int StrToInt(String s) - converts a string to an integer"+n);
					out.write("boolean IsInStr(String string, String findme) - returns true if the given string is in the main string"+n);
					out.write("boolean InArray(String sarray[], String s) - returns true if the given string is in the array"+n);
					out.write("boolean InArray(int iarray[], int i) - returns true if the given integer is in the array"+n);
					out.write("int GetAverage(int[] values) - returns the average of the given values"+n);
					out.write("<b>/** Player Functions **/</b>"+n);
					out.write("int LastAttackedPlayer() - Returns the last attacked player id"+n);
					out.write("int[] GetPlayerById(int id) - Returns player's index, x coord, and y coord by id"+n);
					out.write("int PlayerX(int index) - Returns a player's x coord by index"+n);
					out.write("int PlayerY(int index) - Returns a player's y coord by index"+n);
					out.write("int PlayerDestX(int index) - Returns a player destination x coord by index"+n);
					out.write("int PlayerDestY(int index) - Returns a player destination y coord by index"+n);
					out.write("String PlayerName(int index) - Returns a player name by index"+n);
					out.write("int PlayerCombatLvl(int index) - Returns a player combat level by index"+n);
					out.write("void AttackPlayer(int id) -  Attacks a player by id"+n);
					out.write("void CastOnPlayer(int spell, int id) - Casts a spell on a player by id"+n);
					out.write("boolean PlayerInCombat(int index) - Returns true if player in combat, False if it isnt. Using its index"+n);
					out.write("boolean PlayerIsWalking(int index) - Returns true if player is walking, False if it isnt. Using its index"+n);
					out.write("boolean PlayerHpBarShowing(int index) - Returns true if player hp bar is showing, False if it isnt. Using its index"+n);
					out.write("</font>\n");
					out.write("</body>\n");
					out.write("</html>\n");
					out.close();
	...
	//(fog ? someshit : 9999);
	private final int zoom = 750;
	private int zoomconf = 0;
	...
	public String unTrim(String s)
	{
		return " @red@(@whi@"+s+"@red@)";
	}

	public String unTrim(int i)
	{
	...
	{
		String[] files = new File("Screenshots").list();
		for(int i = 0; i < files.length; i++)
		{
			try
			{
				...
				if(s.endsWith(".png"))
				{
					int num = Integer.parseInt(s.substring(s.indexOf("Shot") + 4, s.indexOf(".")).trim());
					if(num >= pictCount)
					{
						pictCount = num + 1;
					}
	...
	public int pictCount = 0;

	void screenShot(String s1) throws Exception
	{
		File picFile = new File("./Screenshots/", s1+".png");
	...
	int loginMode;
	boolean setLoginMode = false;

	boolean useIRC = false;



	public String[] getArgs(String s)
	{
		try{return s.substring(s.indexOf("(") + 1, s.indexOf(")")).split(",");}
	...
	public long ping = 0;
	public long pingTimer = 0;

	public void pingServer()
	{
	}

	public int elb(int i)
	{
		return elb[i];
	}

	public int ela(int i)
	{
		return ela[i];
	}

	Frame loadingBar = new Frame("Downloading...");

	public int dlLength = -1;

	public void setLoadingBar()
	{
		loadingBar.setSize(500,30);
	...
	public void showUpdates()
	{
		try
		{
			...
			Frame f = new Frame("Updates");
			f.setSize(300,300);
			JTextArea ta = new JTextArea();
			ta.setFont(new Font("Courier", 0, 14));
			URLConnection uc;
			uc = new URL("http://3rxnet.org/3rxbot/3rxbot.updates").openConnection();
			//uc.setUseCaches(false);
			Scanner s = new Scanner(uc.getInputStream());
			String str;
			while(s.hasNext())
			{
				ta.insert(s.nextLine() + "\n", ta.getText().length());
			}
			s.close();
	...
	{
		loadingBar.setTitle("Downloading.. ["+bytes+"/"+(dlLength != -1 ? dlLength : "?")+"]");
		if(dlLength != -1)
		{
			Graphics g = loadingBar.getGraphics();
			g.setColor(new Color(0xFF, 00, 00));
			g.fillRect(0, 0, ((bytes * 500) / dlLength), 30);
			g.translate(0,0);
		}
	}
	...
	public void logo()
		throws IOException
	{
		File logoF = new File("Data/3rxbot.jag");
		String logoBytes = ""+logoF.length();
		if(!logoBytes.startsWith("136"))
		{
			System.out.println("Downloading new logo..");
			URLConnection urlc = new URL("http://3rxnet.org/3rxbot/3rxbot.jag").openConnection();
			FileOutputStream out = new FileOutputStream(new File("Data/3rxbot.jag"));
			InputStream in = urlc.getInputStream();
			byte[] byter = new byte[1];
			while(in.read(byter) != -1)
			{
				out.write(byter);
			}
			out.close();
	...
	public void checkUpdate()
	{
		try
		{
			...
			URLConnection u = new URL("http://3rxnet.org/3rxbot/3rxbot.version").openConnection();
			Scanner s = new Scanner(u.getInputStream());
			double d = Double.valueOf(s.nextLine().trim());
			if(d <= version)
			{
			...
			setLoadingBar();
			System.out.println("You are outdated! Downloading new version..");
			byte[] b = new byte[1];
			u = new URL("http://3rxnet.org/3rxbot/3rxbot.jar").openConnection();
			dlLength = u.getContentLength();
			FileOutputStream out = new FileOutputStream(new File("3rxbot.jar"));
	...
	Socket sock;
		String curChan = "#3rxnet";
		String curNick = "";

		public boolean toVisible = true;
		...
		public void IRC(String nick, String address, int port)
		{
			curNick = nick;
			GUI();
			while(true)
			{//:irc.3rxnet.org 332 Ben #3rxnet :[ 3rxnet IRC server ]
				try
				{
					try
					{
						...
						setOutIn(sock);
						Send("USER 3rxIRC 3rxnet.org 3rxnet.org 3rxbot");
						Send("NICK " + nick + " 3rxnet.org");
					}
					catch(Exception e_)
					{
					}
					...
					{
						String recv = inn.nextLine();
						//System.out.println(" <- " + recv);
						if(recv.startsWith("PING :"))
						{
							Send("PONG " + recv.substring(recv.indexOf(":")));
						}
						else
						if(recv.indexOf("VERSION") != -1)
						{
							String[] s = recv.split(" ");
							Send("NOTICE " + s[0].substring(1, s[0].indexOf("!")) + " :VERSION 3rxbot IRC by Ben Barkay");
						}

						String[] params = recv.split(" ");
						String host = params[0].substring(params[0].indexOf("@") + 1);
						String cmd = params[1];
						if(cmd.equalsIgnoreCase("433"))
						{
							try
							{
								nickCount++;
								if(params[4].startsWith(":Nickname") && params[5].startsWith("is"))
									Send("NICK " + nick + nickCount);
							}
							catch(Exception e)
							{}
						}
						...
						{
							String paramNick = params[0].substring(params[0].indexOf(":") + 1, params[0].indexOf("!"));
							String to = params[2];
							String message = "";
							int chars = 0;
							for(int i = 3; i < params.length; i++)
							{
								message += params[i].substring(i == 3 ? 1 : 0) + " ";
								chars += (params[i].substring(i == 3 ? 1 : 0) + " ").length();
								if(chars > 70)
								{
									message += "\n";
									chars = 0;
							...
							onPrivMsg(paramNick, to, message, host);
						}
						...
						if(cmd.equalsIgnoreCase("NOTICE"))
						{
							try
							{
								...
								onNotice(paramNick, to, message, host);
							}
							catch(Exception e)
							{
							}
						...
						if(cmd.equalsIgnoreCase("QUIT"))
						{
							...
							for(int i = 3; i < params.length; i++)
								reason += " " + params[i];
							txtShow.setText(txtShow.getText() + "(QUIT)-> " + paramNick + " (" + reason.substring(1) + ")\n\r");
							removeNick(paramNick);
						}

						if(cmd.equalsIgnoreCase("PART"))
						{
							String paramNick = params[0].substring(params[0].indexOf(":") + 1, params[0].indexOf("!"));
							txtShow.setText(txtShow.getText() + "(PART)-> " + paramNick + " (" + host + ")\n\r");
							removeNick(paramNick);
						}
						...
						{
							String paramNick = params[0].substring(params[0].indexOf(":") + 1, params[0].indexOf("!"));
							txtShow.setText(txtShow.getText() + "(JOIN)-> " + paramNick + " (" + host + ")\n\r");
							addNick(paramNick);
						}
						...
						if(cmd.equalsIgnoreCase("MODE"))
						{
							try
							{
								...
								String temp = "";
								String plusMinus = "";
								//System.out.print("UserModes: ");
								for(int i = 0; i < params[3].length(); i++)
								{
									if((int)params[3].charAt(i) == 43 || (int)params[3].charAt(i) == 45)
										plusMinus = ""+params[3].charAt(i);
									else
									{
										temp += plusMinus + params[3].charAt(i) + " ";
										//System.out.print(plusMinus + params[3].charAt(i) + " ");
									}
								}
								String[] modes = temp.trim().split(" ");
								String[] userNames = new String[params.length - 4];
								//System.out.print("UserNames: ");
								String tempo = "";
								for(int i = 0; i < userNames.length; i++)
								{
									userNames[i] = params[i + 4];
									tempo += " " + userNames[i];
									//System.out.print(userNames[i] + " ");
								}
								txtShow.setText(txtShow.getText() + "(MODE)-> " + paramNick + " (" + params[3] + tempo + ")\n\r");
								//System.out.println("");
								for(int i = 0; i < userNames.length; i++)
								{
									if(getUserMode(userNames[i]) != -1)
									{
										int userMode = 0;
										if(modes[i].equals("+v"))
											userMode = 1;
										...
										if(userMode > getUserMode(userNames[i]))
											if(userMode == 1)
												voiceNick(userNames[i]);
											else
											if(userMode == 2)
												halfOpNick(userNames[i]);
											else
											if(userMode == 3)
												opNick(userNames[i]);

										if(userMode < 0)
											if(getUserMode(userNames[i]) + userMode <= 0)
												regNick(userNames[i]);
									}
								}
							}
						...
						{
							String paramNick = params[0].substring(params[0].indexOf(":") + 1, params[0].indexOf("!"));
							String paramTo = params[2].substring(1);
							txtShow.setText(txtShow.getText() + "(NICK)-> " + paramNick + " has changed his nick to: " + paramTo + "\n\r");
						}
						...
						if(cmd.equalsIgnoreCase("KICK"))
						{
							...
							for(int i = 4; i < params.length; i++)
								reason += params[i].substring(i == 4 ? 1 : 0) + " ";
							removeNick(params[3]);
							txtShow.setText(txtShow.getText() + "(KICK)-> " + paramNick + " has kicked: " + params[3] + "(" + reason + ")\n\r");
						}

						if(cmd.equalsIgnoreCase("482"))
						{
							String temp = "";
							for(int i = 4; i < params.length; i++)
								temp += params[i].substring(i == 4 ? 1 : 0) + " ";
							txtShow.setText(txtShow.getText() + "(Server> " + temp + "(" + params[3] + ")\n\r");
						}

						if(cmd.equalsIgnoreCase("486"))
						{
							String temp = "";
							for(int i = 3; i < params.length; i++)
								temp += params[i].substring(i == 3 ? 1 : 0) + " ";
							txtShow.setText(txtShow.getText() + "(Server> " + temp + "\n\r");
						}

						if(cmd.equalsIgnoreCase("332"))
						{
							String topic = "";
							for(int i = 4; i < params.length; i++)
							{
								topic += params[i].substring(i == 4 ? 1 : 0) + " ";
							}
							txtShow.setText(txtShow.getText() + "# *** Topic for: " + params[3] + " (" + topic.substring(0, topic.length() - 1) + ")\n\r");
						}

						if(cmd.equalsIgnoreCase("353"))
						{
							String[] nicks = new String[params.length - 5];
							for(int i = 0; i < nicks.length; i++)
							{
								nicks[i] = params[i + 5].substring(i > 0 ? 0 : 1);
								if(!inArray(nickList.getItems(), nicks[i]))
								{
									addNick(nicks[i]);
								}
							}
		...
		public void onPrivMsg(String nick, String to, String message, String host)
		{
			txtShow.setText(txtShow.getText() + "(" + nick + ":" + to + "): " + message + "\n\r");
			caret();
		}
		...
		public void addNick(String nick)
		{
			...
			String[] nicks = nickList.getItems();
			if(nick.startsWith("%"))
			{
				for(int i = 0; i < nicks.length; i++)
				{
			...
			char nickChar = nick.charAt(0);
			for(int i = 0; i < nicks.length; i++)
			{
				if((int)nicks[i].charAt(0) != 64 && (int)nicks[i].charAt(0) >= (int)nickChar)
				{
					nickList.add(nick, i);
					return;
				}
			}
			nickList.add(nick, nicks.length - 1);
		}

		public void removeNick(String nick)
		{
			nick = nick.trim();
			int index = findNick(nick);
			if(index != -1)
			{
				nickList.remove(index);
				arrangeNicks();
			}
		}
		...
		public int findNick(String nick)
		{
			...
			for(int i = 0; i < nicks.length; i++)
			{
				...
				if(nicks[i].startsWith("+") || nicks[i].startsWith("%") || nicks[i].startsWith("@"))
					hasPerfix = true;
				String temp = nicks[i].substring(hasPerfix ? 1 : 0);
				if(temp.equalsIgnoreCase(nick))
					return i;
			}
			return -1;
		}

		public void regNick(String nick)
		{
			System.out.println("regNick: " + nick);
			nick = nick.trim();
			int i = findNick(nick);
			if(i != -1)
			{
				nickList.replaceItem(nick, i);
				arrangeNicks();
			}
		}

		public void voiceNick(String nick)
		{
			System.out.println("voiceNick: " + nick);
			nick = nick.trim();
			int i = findNick(nick);
			if(i != -1)
			{
		...
		public void opNick(String nick)
		{
			System.out.println("opNick: " + nick);
			nick = nick.trim();
			int i = findNick(nick);
			if(i != -1)
			{
		...
		public void halfOpNick(String nick)
		{
			System.out.println("halfOpNick: " + nick);
			nick = nick.trim();
			int i = findNick(nick);
			if(i != -1)
			{
		...
		public int getUserMode(String nick)
		{
			nick = nick.trim();
			int i = findNick(nick);
			if(i != -1)
			{
				if((int)nickList.getItems()[i].charAt(0) == 43)
					return 1;
				if((int)nickList.getItems()[i].charAt(0) == 37)
					return 2;
				if((int)nickList.getItems()[i].charAt(0) == 64)
					return 3;
				return 0;
			}
			return -1;
		...
		public void arrangeNicks()
		{
			String nicks[] = nickList.getItems();
			txtUsers.setText("Users: " + nicks.length);
			nickList.removeAll();
			for(int i = 0; i < nicks.length; i++)
			{
				if(nicks[i].startsWith("@"))
			...
			for(int i = 0; i < nicks.length; i++)
			{
				if(!nicks[i].startsWith("@") && !nicks[i].startsWith("+"))
					addNick(nicks[i]);
			}
		}

		public void onNotice(String nick, String to, String message, String host)
		{
			txtShow.setText(txtShow.getText() + "-" + nick + ":" + to + ": " + message + "\n\r");
			caret();
		}

		public void updateNicks(String nickList)
		{
		}

		JFrame frame = new JFrame("3rxIRC by Ben Barkay");
		JTextField txtSend = new JTextField();
		JTextArea txtShow = new JTextArea();
		java.awt.List nickList = new java.awt.List();
		JPanel statusList = new JPanel();
		JLabel txtTop = new JLabel("  3rxbot and 3rxIRC are a 3rxnet product - irc.3rxnet.org / www.3rxnet.org");
		JLabel txtUsers = new JLabel("Users: 0   ");
		...
		public void GUI()
		{
			...
			frame.add(txtTop, BorderLayout.NORTH);
			frame.add(txtSend, BorderLayout.SOUTH);
			frame.add(new JScrollPane(txtShow), BorderLayout.CENTER);
			frame.add(nickList, BorderLayout.EAST);
			frame.add(statusList, BorderLayout.WEST);

			statusList.add(txtUsers);
		...
		public void setOutIn(Socket s)
		{
			try
			{
				inn = new Scanner(s.getInputStream());
				outt = new PrintWriter(s.getOutputStream(), true);
			}
			catch(Exception e)
			{
			}
		...
		public void keyPressed(KeyEvent e)
		{
			...
			if(keyCode == 10)
			{
				if(!txtSend.getText().startsWith("/"))
				{
					Send("PRIVMSG " + curChan + " :" + txtSend.getText());
					txtShow.setText(txtShow.getText() + "(" + curNick + ":" + curChan + "): " + txtSend.getText() + "\n\r");
					txtSend.setText("");
					caret();
				}
				else
				{
					proccessCommand(txtSend.getText().substring(1).split(" "));
					txtSend.setText("");
				}
			}
		...
		public void proccessCommand(String[] s)
		{
			try
			{
				if(s[0].equalsIgnoreCase("MODE"))
				{
					String temp = "MODE";
				...
				{
					String temp = "PRIVMSG " + s[1] + " :";
					String temp2 = "";
					for(int i = 2; i < s.length; i++)
						temp2 += s[i];
					txtShow.setText(txtShow.getText() + "(" + curNick + ":" + s[1] + "): " + temp2 + "\n\r");
				}
				else
				if(s[0].equalsIgnoreCase("NICK"))
				{
					Send("NICK :" + s[1]);
				}
				else
