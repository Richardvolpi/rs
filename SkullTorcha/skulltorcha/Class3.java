...
public class Class3
{
    ...
    public static int method130(byte abyte0[], int i, byte abyte1[], int j, int k)
    {
        Class11 class11 = new Class11();
        class11.aByteArray475 = abyte1;
        class11.anInt476 = k;
    ...
    private static void method131(Class11 class11)
    {
        int j2 = Class14.anInt553;
        byte byte2 = class11.aByte485;
        int i = class11.anInt486;
        int j = class11.anInt496;
        int k = class11.anInt494;
        int ai[] = Class11.anIntArray499;
...
label0:
        ...
        if(class11.anInt483 < i2)
            class11.anInt484++;
        class11.aByte485 = byte2;
        class11.anInt486 = i;
        class11.anInt496 = j;
        class11.anInt494 = k;
        Class11.anIntArray499 = ai;
        class11.anInt493 = l;
        class11.aByteArray480 = abyte0;
        class11.anInt481 = i1;
        class11.anInt482 = j1;
    ...
    private static void method132(Class11 class11)
    {
        int l11 = Class14.anInt553;
        boolean flag = false;
        boolean flag1 = false;
        boolean flag2 = false;
        boolean flag3 = false;
        ...
        int ai2[] = null;
        class11.anInt490 = 1;
        if(Class11.anIntArray499 == null)
            Class11.anIntArray499 = new int[class11.anInt490 * 0x186a0];
        boolean flag19 = true;
        while(flag19) 
        {
            byte byte0 = method133(class11);
            if(byte0 == 23)
                return;
            ...
            int j4 = method135(3, class11);
            int k4 = method135(15, class11);
            for(int i1 = 0; i1 < k4; i1++)
            {
                int j3 = 0;
                do
                {
                    byte byte3 = method134(class11);
                    if(byte3 == 0)
                        break;
                    j3++;
                } while(true);
            ...
            {
                int l6 = method135(5, class11);
                for(int k1 = 0; k1 < i4; k1++)
                {
                    do
                    {
                        byte byte4 = method134(class11);
                        if(byte4 == 0)
                            break;
                        byte4 = method134(class11);
                        if(byte4 == 0)
                            l6++;
                        else
                            l6--;
            ...
            for(int l3 = 0; l3 < j4; l3++)
            {
                ...
                method137(class11.anIntArrayArray509[l3], class11.anIntArrayArray510[l3], class11.anIntArrayArray511[l3], class11.aByteArrayArray508[l3], byte8, i, i4);
                class11.anIntArray512[l3] = byte8;
            }

            int l4 = class11.anInt500 + 1;
            int l5 = 0x186a0 * class11.anInt490;
            int i5 = -1;
            int j5 = 0;
            ...
            int l7;
            byte byte9;
            for(l7 = method135(i7, class11); l7 > ai[i7]; l7 = l7 << 1 | byte9)
            {
                i7++;
                byte9 = method134(class11);
            }
            ...
            for(int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
                if(k5 == 0 || k5 == 1)
                {
                    ...
                    do
                    {
                        ...
                        int i8;
                        byte byte10;
                        for(i8 = method135(j7, class11); i8 > ai[j7]; i8 = i8 << 1 | byte10)
                        {
                            j7++;
                            byte10 = method134(class11);
                        }
                    ...
                    for(; j6 > 0; j6--)
                    {
                        Class11.anIntArray499[i6] = byte5 & 0xff;
                        i6++;
                    }
                ...
                } else
                {
                    ...
                    Class11.anIntArray499[i6] = class11.aByteArray503[byte6 & 0xff] & 0xff;
                    i6++;
                    if(j5 == 0)
                    {
                        i5++;
                    ...
                    int j8;
                    byte byte11;
                    for(j8 = method135(k7, class11); j8 > ai[k7]; j8 = j8 << 1 | byte11)
                    {
                        k7++;
                        byte11 = method134(class11);
                    }
            ...
            {
                byte byte7 = (byte)(Class11.anIntArray499[l2] & 0xff);
                Class11.anIntArray499[class11.anIntArray497[byte7 & 0xff]] |= l2 << 8;
                class11.anIntArray497[byte7 & 0xff]++;
            }

            class11.anInt493 = Class11.anIntArray499[class11.anInt492] >> 8;
            class11.anInt496 = 0;
            class11.anInt493 = Class11.anIntArray499[class11.anInt493];
    ...
    private static byte method133(Class11 class11)
    {
        return (byte)method135(8, class11);
    }

    private static byte method134(Class11 class11)
    {
        return (byte)method135(1, class11);
    }

    private static int method135(int i, Class11 class11)
    {
        int j;
        do
        {
    ...
    private static void method136(Class11 class11)
    {
        class11.anInt500 = 0;
        for(int i = 0; i < 256; i++)
    ...
    private static void method137(int ai[], int ai1[], int ai2[], byte abyte0[], int i, int j, int k)
    {
        int j3 = Class14.anInt553;
        int l = 0;
