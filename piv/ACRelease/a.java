...
public boolean zoomIn = false;
    ...
    public final synchronized boolean keyDown(Event arg0, int arg1)
    {
        ...
        if(arg1 == 1002) { walkDelay += 1; System.out.println("Walk delay: "+ walkDelay); }
        if(arg1 == 1003) { walkDelay -= 1; System.out.println("Walk delay: "+ walkDelay); }
        if(arg1 == 1004) zoomIn = true;
        if(arg1 == 1005) zoomOut = true;
        if(arg1 == 1012)
        { if(autocatch) 
          {
          autocatch = false;
          //System.out.println("Autocatch OFF");
          }
          else
          {
          autocatch = true;
 	  //System.out.println("Autocatch ON");
    	  }
        }  
        if(arg1 == 1006)
            fjl = true;
    ...
    {
        if(i == 1004) zoomIn = false;
        if(i == 1005) zoomOut = false;
        fki = 0;
        if(i == 1006)
            fjl = false;
        if(i == 1007)
