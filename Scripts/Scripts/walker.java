...
{
   public walker(mudclient rs)
   {
      super(rs);
   }
   public String[] getCommands()
   {
      return new String[]{"lumbytodray", "lumbytoedge", "lumbytovar", "lumbytofally", "draytofally", "draytobarb", "draytolumby", "draytoedge", "fallytoedge", "fallytodray", "fallytovar", "fallytobarb", "barbtodray", "barbtofally",
 "vartofally", "vartoedge", "vartolumby", "vartoalchard", "alchardtovar", "edgetovar", "edgetodray", "edgetofally"};
   }
