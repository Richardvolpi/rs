public class TargetStriker extends Script
{
    public boolean TargetStriking = true;
    public int exp = 0;
    public TargetStriker(mudclient rs)
    {
        super(rs);
    }
    public String[] getCommands()
    {
        return new String[]{"targetstrike"};
    }
