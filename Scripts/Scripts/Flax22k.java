public class Flax22k extends Script
{
   ...
   {
       if(message.startsWith("@whi@@que@You make the flax into a bow string"))
       {
           SpinCount++;
           EXP += 15;
       }
   ...
   {
       if(message.startsWith("@gam@You uproot a flax plant"))
       {
           FlaxCount++;
       }
       ...
       if(message.equals("@gam@You climb up the ladder")) 
    UpX = true;
       if(message.equals("@gam@You climb down the ladder")) 
    DownX = true;
   }
