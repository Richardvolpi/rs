// Decompiled by DJ v3.7.7.81 Copyright 2004 Atanas Neshkov  Date: 04/09/2004 3:55:41 PM
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   FeltchShafts.java

import java.io.PrintStream;

public class FletchShafts extends Script
{

    public FletchShafts(mudclient mudclient)
    {
        super(mudclient);
        sleep = false;
        shafts = 0;
