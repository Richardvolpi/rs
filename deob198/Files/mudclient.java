...
{
    super.aClass14_Sub1_620.method331(152);
...
{
    super.aClass14_Sub1_620.method331(179);
    super.aClass14_Sub1_620.method343(id);
    super.aClass14_Sub1_620.method343(i);
    super.aClass14_Sub1_620.method346();
}
...
{
    super.aClass14_Sub1_620.method331(68);
...
private class logout extends Thread
{
    public void run()
    {
        try
        {
            ...
            while(loggedin())
            {
                aClass14_Sub1_620.method331(235);
...
public void setmode(int x)
{
    anInt813 = 0;
    anInt750 = x;
    super.aClass14_Sub1_620.method331(148);
...
public void useitem(int id)
{
    for(int j = 0; j < anIntArray709.length; j++)
        ...
        {
            super.aClass14_Sub1_620.method331(137);
...
{
    super.aClass14_Sub1_620.method331(on ? 13 : 122);
    super.aClass14_Sub1_620.method348(i);
    super.aClass14_Sub1_620.method346();
...
return new URL("http://www.runescape.com");
    ...
    private final void method108()
    {
        ...
        } else
        {
            ...
            int l5 = anInt714 + anInt895;
            int i8 = anInt715 + anInt973;
            aClass10_739.method298(l5, -aClass19_883.method421(l5, i8), i8, 912, anInt729 * 4, 0, anInt683 * 2);
        }
    ...
    private final void method116()
    {
        ...
        i = 50;
        aClass6_Sub1_724.method255("This form is for reporting players who are breaking our rules", 256, i, 1, 0xffffff);
        i += 15;
        aClass6_Sub1_724.method255("Using it sends a snapshot of the last 60 secs of activity to us", 256, i, 1, 0xffffff);
        i += 15;
        aClass6_Sub1_724.method255("If you misuse this form, you will be banned.", 256, i, 1, 0xff8000);
        i += 15;
        i += 10;
        aClass6_Sub1_724.method255("First indicate which of our 12 rules is being broken. For a detailed", 256, i, 1, 0xffff00);
        i += 15;
        aClass6_Sub1_724.method255("explanation of each rule please read the manual on our website.", 256, i, 1, 0xffff00);
        i += 15;
        int k;
        if(anInt863 == 1)
        {
        ...
        aClass6_Sub1_724.method255("1: Offensive language", 256, i, 1, k);
        i += 14;
        if(anInt863 == 2)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("2: Item scamming", 256, i, 1, k);
        i += 14;
        if(anInt863 == 3)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("3: Password scamming", 256, i, 1, k);
        i += 14;
        if(anInt863 == 4)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("4: Bug abuse", 256, i, 1, k);
        i += 14;
        if(anInt863 == 5)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("5: Jagex Staff impersonation", 256, i, 1, k);
        i += 14;
        if(anInt863 == 6)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("6: Account sharing/trading", 256, i, 1, k);
        i += 14;
        if(anInt863 == 7)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("7: Macroing", 256, i, 1, k);
        i += 14;
        if(anInt863 == 8)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("8: Mutiple logging in", 256, i, 1, k);
        i += 14;
        if(anInt863 == 9)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("9: Encouraging others to break rules", 256, i, 1, k);
        i += 14;
        if(anInt863 == 10)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("10: Misuse of customer support", 256, i, 1, k);
        i += 14;
        if(anInt863 == 11)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("11: Advertising / website", 256, i, 1, k);
        i += 14;
        if(anInt863 == 12)
        {
            aClass6_Sub1_724.method217(66, i - 12, 380, 15, 0xffffff);
        ...
        aClass6_Sub1_724.method255("12: Real world item trading", 256, i, 1, k);
        i += 14;
        i += 15;
        k = 0xffffff;
    ...
    private final void method52()
    {
        ...
        if(!aBoolean914)
        {
            aClass4_858.method156(256, 200 + i, "Click on an option", 5, true);
            aClass4_858.method157(156, 240 + i, 120, 35);
            aClass4_858.method157(356, 240 + i, 120, 35);
            aClass4_858.method156(156, 240 + i, "New N00b", 5, false);
            aClass4_858.method156(356, 240 + i, "Existing N00b", 5, false);
    ...
    private final void method60(boolean flag)
    {
        ...
        char c = '\304';
        aClass6_Sub1_724.method214(i, 36, c, 65, Class6.method223(181, 181, 181), 160);
        aClass6_Sub1_724.method214(i, 101, c, 65, Class6.method223(201, 201, 201), 160);
        aClass6_Sub1_724.method214(i, 166, c, 95, Class6.method223(181, 181, 181), 160);
        aClass6_Sub1_724.method214(i, 261, c, 40, Class6.method223(201, 201, 201), 160);
        int k = i + 3;
        int i1 = j + 15;
    ...
    private final void method82()
    {
        ...
        if(super.aBoolean27)
            anInt729 = anInt729 - 2 & 0xff;
        if(aBoolean789 && anInt683 > 550)
            anInt683 -= 4;
        else
        if(!aBoolean789 && anInt683 < 750)
            anInt683 += 4;
        if(anInt670 > 0)
            anInt670--;
        else
