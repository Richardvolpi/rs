...
<?php endif; ?>					<li<?php if ($page == 'reports') echo ' class="isactive"'; ?>><a href="admin_reports.php">Reports</a></li>
		...
		<h2 class="block2"><span>RSCD menu</span></h2>
		<div class="box">
			<div class="inbox">
				<ul>
<?php if ($is_admin): ?>					<li<?php if ($page == 'rscd_control') echo ' class="isactive"'; ?>><a href="admin_rscd_control.php">Control Panel</a></li>
<?php endif; ?>					<li<?php if ($page == 'rscd_logs') echo ' class="isactive"'; ?>><a href="admin_rscd_logs.php">Logs</a></li>
<?php if ($is_admin): ?>					<li<?php if ($page == 'rscd_traps') echo ' class="isactive"'; ?>><a href="admin_rscd_traps.php">Bot Traps</a></li>
<?php endif; ?>					<li<?php if ($page == 'rscd_reports') echo ' class="isactive"'; ?>><a href="admin_rscd_reports.php">Reports</a></li>
				</ul>
			</div>
		</div>
<?php
