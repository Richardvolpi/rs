...
public final class mudclient extends GameWindowMiddleMan {
	...
	public static final void main(String[] args) throws Exception {
		...
		GameWindowMiddleMan.clientVersion = 31;
		mudclient mc = new mudclient();
		mc.appletMode = false;
		mc.setLogo(Toolkit.getDefaultToolkit().getImage(Config.CONF_DIR + File.separator + "Loading.rscd"));
		mc.createWindow(mc.windowWidth, mc.windowHeight + 11, "PiruOnline", false); // + GameWindowMiddleMan.clientVersion, false);
	}
...
//                                showServerMessageBox = false;
    ...
    private final String equipmentStatusName[] = {"Armour", "Weapon Aim", "Weapon Power", "Magic", "Prayer", "Range"};
    private int referId;
    ...
    //private final String skillArray[] = {"Attack", "Defense", "Strength", "Hits", "Ranged", "Prayer", "Magic",  "Smithing", "Mining"};
    ...
    //private final String skillArrayLong[] = {"Attack", "Defense", "Strength", "Hits", "Ranged", "Prayer", "Magic",  "Smithing", "Mining"};
