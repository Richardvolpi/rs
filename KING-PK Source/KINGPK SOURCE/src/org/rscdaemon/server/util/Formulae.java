...
public class Formulae {
	...
	//public static final int[] experienceArray = {83, 174, 276, 388, 512, 650, 801, 969, 1154, 1358, 1584, 1833, 2107, 2411, 2746, 3115, 3523, 3973, 4470, 5018, 5624, 6291, 7028, 7842, 8740, 9730, 10824, 12031, 13363, 14833, 16456, 18247, 20224, 22406, 24815, 27473, 30408, 33648, 37224, 41171, 45529, 50339, 55649, 61512, 67983, 75127, 83014, 91721, 101333, 111945, 123660, 136594, 150872, 166636, 184040, 203254, 224466, 247886, 273742, 302288, 333804, 368599, 407015, 449428, 496254, 547953, 605032, 668051, 737627, 814445, 899257, 992895, 1096278, 1210421, 1336443, 1475581, 1629200, 1798808, 1986068, 2192818, 2421087, 2673114,2951373, 3258594, 3597792, 3972294, 4385776, 4842295, 5346332, 5902831, 6517253, 7195629, 7944614, 8771558, 9684577, 10692629, 11805606, 13034431, 14391160, 15889228, 17543116, 19369154, 21385258, 23611212, 26068862, 28782516, 31778456, 35086232, 38738308, 42770516, 47222242, 52137724, 57565032, 63556712,70171308,77475322,83539602,85564921,88652316,115127436,127110886,140342616,154950644,167079204,171129842,208547476,230254872,254221772,280685232,309901288,334158408,342259684,417094952,460509744,508443544,561370464,619802576,668316816,669316817,67616818,68316818,70116819,718316820,728316821,768316822,798316823,828316824,858316825,878316826,908316827};
	public static final String[] statArray = {"attack", "defense", "strength", "hits", "ranged", "prayer", "magic", "Pking", "woodcut", "fletching", "fishing", "firemaking", "crafting", "smithing", "mining", "herblaw", "agility", "thieving"};
	//public static final String[] statArray = {"attack", "defense", "strength", "hits", "ranged", "prayer", "magic", "smithing", "mining"};
	public static final int[] woodcuttingAxeIDs = {405, 204, 203, 428, 88, 12, 87};
	//public static final int[] woodcuttingAxeIDs = {0};
	public static final int[] miningAxeIDs = {1262, 1261, 1260, 1259, 1258, 156};
	//public static final int[] miningAxeIDs = {0};
	public static final int[] arrowIDs = {11};
	...
	public static int getSmithingExp(int barID, int barCount) {
		int[] exps = {390, 750, 1110, 1500, 2490, 2200};
	...
	public static int combatExperience(Mob mob) {
		double exp = ((mob.getCombatLevel() * 7) + 10) * 70D;
		return (int)(mob instanceof Player? (exp / 6D) : exp);
	}
	...
	public static int experienceToLevel(int exp) {
		...
		//for(int level = 0; level < 149; level++) {
