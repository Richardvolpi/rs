  				...
  				Player attackerPlayer = (Player)attacker;
					...
					case 0:
						for(int x = 0;x < 3;x++) {
							...
							attackerPlayer.incExp(x, exp, true);
							attackerPlayer.getActionSender().sendStat(x);
						}
						break;
					case 1:

						attackerPlayer.incExp(2, exp * 3, true);
						attackerPlayer.getActionSender().sendStat(2);
						break;
					case 2:

						attackerPlayer.incExp(0, exp * 3, true);
						attackerPlayer.getActionSender().sendStat(0);
						break;
					case 3:

						attackerPlayer.incExp(1, exp * 3, true);
						attackerPlayer.getActionSender().sendStat(1);
						break;
				}
	      			attackerPlayer.incExp(3, exp, true);
