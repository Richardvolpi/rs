...
*/
	...
	private static final String[] destinationNames = {
		"@red@[WILD]@whi@Dragons", "@red@[WILD]@WHI@Castle", "@RED@[WILD]@WHI@Falador",
		"Ardougne", "*Castle*", "*Dragon Maze*", "*Mage Arena*"
	};
	private static final Point[] destinationCoords = {
		Point.location(216, 452), Point.location(130, 508), Point.location(313, 541), Point.location(550, 596),
		Point.location(271, 353), Point.location(268, 197), Point.location(447, 3371)
	};
