public class Scene {
    ...
    public Scene(Surface surface, int i, int j, int k) {
        ...
        // anIntArray412 = new int[maxModelCount]; // only set not used
        anInt413 = 0;
    ...
    public void addModel(GameModel model) {
        ...
        if (modelCount < maxModelCount) {
            //anIntArray412[modelCount] = 0; // only set, not used
            models[modelCount++] = model;
        }
    }

    public void freeModel(GameModel gameModel) {
    ...
    public int drawSprite(int x, int z, int y, int l, int i1, int j1, int tag) {
        ...
        currentModel.createFace(2, vs, 0, 0);
        currentModel.faceTag[spriteCount] = tag;
        currentModel.faceSpriteType[spriteCount++] = 0;
        return spriteCount - 1;
    }

    public void method269(int i) {
        currentModel.faceSpriteType[i] = 1;
    }
    ...
    public void setMidpoints(int width1, int height1, int width2, int height2, int fullwidth, int const_9) {
        anInt397 = width2;
        anInt398 = height2;
        anInt399 = width1;
        anInt400 = height1;
    ...
    public void endscene() {
        ...
        int i3 = anInt397 * clipFar_3d >> viewDist;
        int j3 = anInt398 * clipFar_3d >> viewDist;
        frustumLeft = 0;
        frustumRight = 0;
        frustumBottom = 0;
        frustumTop = 0;
        ...
        method279(anInt397, anInt398, 0);
        frustumLeft += cameraX;
        frustumRight += cameraX;
        frustumBottom += cameraY;
        frustumTop += cameraY;
        frustumNear += cameraZ;
        frustumFar += cameraZ;
        models[modelCount] = currentModel;
        currentModel.transformState = 2;
        for (int i = 0; i < modelCount; i++)
            models[i].project(cameraX, cameraY, cameraZ, cameraPitch, cameraYaw, cameraRoll, viewDist, clipNear);

        models[modelCount].project(cameraX, cameraY, cameraZ, cameraPitch, cameraYaw, cameraRoll, viewDist, clipNear);
        anInt413 = 0;
        for (int count = 0; count < modelCount; count++) {
            GameModel gameModel = models[count];
            if (gameModel.visible) {
                for (int j = 0; j < gameModel.numFaces; j++) {
                    int l3 = gameModel.faceNumVertices[j];
                    int ai1[] = gameModel.faceVertices[j];
                    boolean flag = false;
                    for (int k4 = 0; k4 < l3; k4++) {
                        int i1 = gameModel.vertexCameraZ[ai1[k4]];
                        if (i1 <= clipNear || i1 >= clipFar_3d)
                            continue;
                        flag = true;
                        break;
                    }
                    ...
                    if (flag) {
                        ...
                        for (int k5 = 0; k5 < l3; k5++) {
                            int j1 = gameModel.vertexViewX[ai1[k5]];
                            if (j1 > -anInt397)
                                l1 |= 1;
                            if (j1 < anInt397)
                                l1 |= 2;
                        ...
                        if (l1 == 3) {
                            ...
                            for (int l6 = 0; l6 < l3; l6++) {
                                int k1 = gameModel.vertexViewY[ai1[l6]];
                                if (k1 > -anInt398)
                                    i2 |= 1;
                                if (k1 < anInt398)
                                    i2 |= 2;
                            ...
                            if (i2 == 3) {
                                ...
                                if (polygon_1.anInt365 < 0)
                                    l8 = gameModel.faceFillFront[j];
                                else
                                    l8 = gameModel.faceFillBack[j];
                                if (l8 != 0xbc614e) {
                                    int j2 = 0;
                                    for (int l9 = 0; l9 < l3; l9++)
                                        j2 += gameModel.vertexCameraZ[ai1[l9]];
        ...
        if (model_2d.visible) {
            for (int face = 0; face < model_2d.numFaces; face++) {
                int ai[] = model_2d.faceVertices[face];
                int j4 = ai[0];
                int l4 = model_2d.vertexViewX[j4];
                int l5 = model_2d.vertexViewY[j4];
                int i7 = model_2d.vertexCameraZ[j4];
                if (i7 > clipNear && i7 < clipFar_2d) {
                    int i8 = (anIntArray420[face] << viewDist) / i7;
                    int i9 = (anIntArray421[face] << viewDist) / i7;
                    if (l4 - i8 / 2 <= anInt397 && l4 + i8 / 2 >= -anInt397 && l5 - i9 <= anInt398 && l5 >= -anInt398) {
                        ...
                        method294(anInt413);
                        polygon_2.depth = (i7 + model_2d.vertexCameraZ[ai[1]]) / 2;
                        anInt413++;
                    }
                }
            }
        ...
        for (int i4 = 0; i4 < anInt413; i4++) {
            ...
            if (gameModel_2 == currentModel) {
                int ai2[] = gameModel_2.faceVertices[l];
                int i6 = ai2[0];
                int j7 = gameModel_2.vertexViewX[i6];
                int j8 = gameModel_2.vertexViewY[i6];
                int j9 = gameModel_2.vertexCameraZ[i6];
                int i10 = (anIntArray420[l] << viewDist) / j9;
                int k10 = (anIntArray421[l] << viewDist) / j9;
                int i11 = j8 - gameModel_2.vertexViewY[ai2[1]];
                int j11 = ((gameModel_2.vertexViewX[ai2[1]] - j7) * i11) / k10;
                j11 = gameModel_2.vertexViewX[ai2[1]] - j7;
                int l11 = j7 - i10 / 2;
                int j12 = (anInt400 + j8) - k10;
                surface.spriteClipping(l11 + anInt399, j12, i10, k10, spriteX[l], j11, (256 << viewDist) / j9);
                if (aBoolean389 && anInt392 < anInt393) {
                    l11 += (anIntArray422[l] << viewDist) / j9;
                    if (mouseY >= j12 && mouseY <= j12 + k10 && mouseX >= l11 && mouseX <= l11 + i10 && !gameModel_2.pickable && gameModel_2.faceSpriteType[l] == 0) {
                ...
                if (gameModel_2.faceIntensity[l] != 0xbc614e)
                ...
                for (int k11 = 0; k11 < l10; k11++) {
                    int k2 = ai3[k11];
                    anIntArray444[k11] = gameModel_2.vertexCameraX[k2];
                    anIntArray445[k11] = gameModel_2.vertexCameraY[k2];
                    anIntArray446[k11] = gameModel_2.vertexCameraZ[k2];
                    if (gameModel_2.faceIntensity[l] == 0xbc614e)
                        if (polygon.anInt365 < 0)
                            j10 = (gameModel_2.lightAmbience - gameModel_2.vertexIntensity[k2]) + gameModel_2.vertexAmbience[k2];
                        else
                            j10 = gameModel_2.lightAmbience + gameModel_2.vertexIntensity[k2] + gameModel_2.vertexAmbience[k2];
                    if (gameModel_2.vertexCameraZ[k2] >= clipNear) {
                        anIntArray441[k8] = gameModel_2.vertexViewX[k2];
                        anIntArray442[k8] = gameModel_2.vertexViewY[k2];
                        anIntArray443[k8] = j10;
                        if (gameModel_2.vertexCameraZ[k2] > fogZDistance)
                            anIntArray443[k8] += (gameModel_2.vertexCameraZ[k2] - fogZDistance) / fogZFalloff;
                        k8++;
                    } else {
                        int k9;
                        if (k11 == 0)
                            ...
                            k9 = ai3[k11 - 1];
                        if (gameModel_2.vertexCameraZ[k9] >= clipNear) {
                            int k7 = gameModel_2.vertexCameraZ[k2] - gameModel_2.vertexCameraZ[k9];
                            int i5 = gameModel_2.vertexCameraX[k2] - ((gameModel_2.vertexCameraX[k2] - gameModel_2.vertexCameraX[k9]) * (gameModel_2.vertexCameraZ[k2] - clipNear)) / k7;
                            int j6 = gameModel_2.vertexCameraY[k2] - ((gameModel_2.vertexCameraY[k2] - gameModel_2.vertexCameraY[k9]) * (gameModel_2.vertexCameraZ[k2] - clipNear)) / k7;
                            anIntArray441[k8] = (i5 << viewDist) / clipNear;
                            anIntArray442[k8] = (j6 << viewDist) / clipNear;
                            anIntArray443[k8] = j10;
                            k8++;
                        }
                        if (k11 == l10 - 1)
                            ...
                            k9 = ai3[k11 + 1];
                        if (gameModel_2.vertexCameraZ[k9] >= clipNear) {
                            int l7 = gameModel_2.vertexCameraZ[k2] - gameModel_2.vertexCameraZ[k9];
                            int j5 = gameModel_2.vertexCameraX[k2] - ((gameModel_2.vertexCameraX[k2] - gameModel_2.vertexCameraX[k9]) * (gameModel_2.vertexCameraZ[k2] - clipNear)) / l7;
                            int k6 = gameModel_2.vertexCameraY[k2] - ((gameModel_2.vertexCameraY[k2] - gameModel_2.vertexCameraY[k9]) * (gameModel_2.vertexCameraZ[k2] - clipNear)) / l7;
                            anIntArray441[k8] = (j5 << viewDist) / clipNear;
                            anIntArray442[k8] = (k6 << viewDist) / clipNear;
                            anIntArray443[k8] = j10;
                            k8++;
                        }
                    }
    ...
    private void method281(int i, int j, int k, int l, int i1, int ai[], int ai1[],
        ...
        if (aBoolean389 && anInt392 < anInt393 && mouseY >= anInt439 && mouseY < anInt440) {
            Class8 class8_1 = aClass8Array438[mouseY];
            if (mouseX >= class8_1.anInt370 >> 8 && mouseX <= class8_1.anInt371 >> 8 && class8_1.anInt370 <= class8_1.anInt371 && !gameModel.pickable && gameModel.faceSpriteType[j1] == 0) {
    ...
    private void method282(int i, int j, int k, int ai[], int ai1[], int ai2[], int l,
        ...
        if (l >= 0) {
            ...
            if (anIntArray427[l] == 1) {
                ...
                int k10 = j7 * j2 - k8 * k1 << (5 - viewDist) + 7 + 4;
                int i11 = k8 * i1 - i6 * j2 << (5 - viewDist) + 7;
                int k11 = i3 * k1 - k3 * i1 << 12;
                int i12 = k3 * j2 - i4 * k1 << (5 - viewDist) + 7 + 4;
                int k12 = i4 * i1 - i3 * j2 << (5 - viewDist) + 7;
                int i13 = k3 * i6 - i3 * j7 << 5;
                int k13 = i4 * j7 - k3 * k8 << (5 - viewDist) + 4;
                int i14 = i3 * k8 - i4 * i6 >> viewDist - 5;
                int k14 = k10 >> 4;
                int i15 = i12 >> 4;
                int k15 = k13 >> 4;
                ...
                if (gameModel.unknownSceneBoolean) {
            ...
            int l10 = j7 * j2 - k8 * k1 << (5 - viewDist) + 6 + 4;
            int j11 = k8 * i1 - i6 * j2 << (5 - viewDist) + 6;
            int l11 = i3 * k1 - k3 * i1 << 11;
            int j12 = k3 * j2 - i4 * k1 << (5 - viewDist) + 6 + 4;
            int l12 = i4 * i1 - i3 * j2 << (5 - viewDist) + 6;
            int j13 = k3 * i6 - i3 * j7 << 5;
            int l13 = i4 * j7 - k3 * k8 << (5 - viewDist) + 4;
            int j14 = i3 * k8 - i4 * i6 >> viewDist - 5;
            int l14 = l10 >> 4;
            int j15 = j12 >> 4;
            int l15 = l13 >> 4;
    ...
    private void method293(int i) {
        ...
        int k = gameModel.faceNumVertices[j];
        int l = gameModel.faceCameraNormalScale[j];
        int j1 = gameModel.vertexCameraX[ai[0]];
        int k1 = gameModel.vertexCameraY[ai[0]];
        int l1 = gameModel.vertexCameraZ[ai[0]];
        int i2 = gameModel.vertexCameraX[ai[1]] - j1;
        int j2 = gameModel.vertexCameraY[ai[1]] - k1;
        int k2 = gameModel.vertexCameraZ[ai[1]] - l1;
        int l2 = gameModel.vertexCameraX[ai[2]] - j1;
        int i3 = gameModel.vertexCameraY[ai[2]] - k1;
        int j3 = gameModel.vertexCameraZ[ai[2]] - l1;
        int k3 = j2 * j3 - i3 * k2;
        int l3 = k2 * l2 - j3 * i2;
        int i4 = i2 * i3 - l2 * j2;
        if (l == -1) {
            ...
            gameModel.faceCameraNormalScale[j] = l;
            gameModel.faceCameraNormalMagnitude[j] = (int) ((double) anInt402 * Math.sqrt(k3 * k3 + l3 * l3 + i4 * i4));
        } else {
            k3 >>= l;
            l3 >>= l;
            i4 >>= l;
        ...
        polygon.anInt363 = l3;
        polygon.anInt364 = i4;
        int j4 = gameModel.vertexCameraZ[ai[0]];
        int k4 = j4;
        int l4 = gameModel.vertexViewX[ai[0]];
        int i5 = l4;
        int j5 = gameModel.vertexViewY[ai[0]];
        int k5 = j5;
        for (int l5 = 1; l5 < k; l5++) {
            int i1 = gameModel.vertexCameraZ[ai[l5]];
            if (i1 > k4)
                k4 = i1;
            else if (i1 < j4)
                j4 = i1;
            i1 = gameModel.vertexViewX[ai[l5]];
            if (i1 > i5)
                i5 = i1;
            else if (i1 < l4)
                l4 = i1;
            i1 = gameModel.vertexViewY[ai[l5]];
            if (i1 > k5)
                k5 = i1;
            else if (i1 < j5)
                j5 = i1;
    ...
    private void method294(int i) {
        ...
        int i1 = 0;
        int j1 = 1;
        int k1 = gameModel.vertexCameraX[ai[0]];
        int l1 = gameModel.vertexCameraY[ai[0]];
        int i2 = gameModel.vertexCameraZ[ai[0]];
        gameModel.faceCameraNormalMagnitude[j] = 1;
        gameModel.faceCameraNormalScale[j] = 0;
        polygon.anInt365 = k1 * l + l1 * i1 + i2 * j1;
        polygon.anInt362 = l;
        polygon.anInt363 = i1;
        polygon.anInt364 = j1;
        int j2 = gameModel.vertexCameraZ[ai[0]];
        int k2 = j2;
        ...
        int k = gameModel.vertexCameraZ[ai[1]];
        if (k > k2)
            k2 = k;
        else if (k < j2)
            j2 = k;
    ...
    private boolean method295(Polygon polygon, Polygon polygon_1) {
        ...
        int k2 = gameModel_1.vertexCameraX[ai1[0]];
        int l2 = gameModel_1.vertexCameraY[ai1[0]];
        int i3 = gameModel_1.vertexCameraZ[ai1[0]];
        int j3 = polygon_1.anInt362;
        int k3 = polygon_1.anInt363;
        int l3 = polygon_1.anInt364;
        int i4 = gameModel_1.faceCameraNormalMagnitude[j];
        int j4 = polygon_1.anInt365;
        boolean flag = false;
        for (int k4 = 0; k4 < k; k4++) {
            int i1 = ai[k4];
            int i2 = (k2 - gameModel.vertexCameraX[i1]) * j3 + (l2 - gameModel.vertexCameraY[i1]) * k3 + (i3 - gameModel.vertexCameraZ[i1]) * l3;
        ...
        if (!flag)
            return true;
        k2 = gameModel.vertexCameraX[ai[0]];
        l2 = gameModel.vertexCameraY[ai[0]];
        i3 = gameModel.vertexCameraZ[ai[0]];
        j3 = polygon.anInt362;
        k3 = polygon.anInt363;
        l3 = polygon.anInt364;
        ...
        for (int l4 = 0; l4 < l; l4++) {
            int j1 = ai1[l4];
            int j2 = (k2 - gameModel_1.vertexCameraX[j1]) * j3 + (l2 - gameModel_1.vertexCameraY[j1]) * k3 + (i3 - gameModel_1.vertexCameraZ[j1]) * l3;
    ...
    private boolean method296(Polygon polygon, Polygon polygon_1) {
        ...
        int k = gameModel.faceNumVertices[i];
        int l = gameModel_1.faceNumVertices[j];
        int i2 = gameModel_1.vertexCameraX[ai1[0]];
        int j2 = gameModel_1.vertexCameraY[ai1[0]];
        int k2 = gameModel_1.vertexCameraZ[ai1[0]];
        int l2 = polygon_1.anInt362;
        int i3 = polygon_1.anInt363;
        int j3 = polygon_1.anInt364;
        int k3 = gameModel_1.faceCameraNormalMagnitude[j];
        int l3 = polygon_1.anInt365;
        boolean flag = false;
        for (int i4 = 0; i4 < k; i4++) {
            int i1 = ai[i4];
            int k1 = (i2 - gameModel.vertexCameraX[i1]) * l2 + (j2 - gameModel.vertexCameraY[i1]) * i3 + (k2 - gameModel.vertexCameraZ[i1]) * j3;
        ...
        if (!flag)
            return true;
        i2 = gameModel.vertexCameraX[ai[0]];
        j2 = gameModel.vertexCameraY[ai[0]];
        k2 = gameModel.vertexCameraZ[ai[0]];
        l2 = polygon.anInt362;
        i3 = polygon.anInt363;
        j3 = polygon.anInt364;
        ...
        for (int j4 = 0; j4 < l; j4++) {
            int j1 = ai1[j4];
            int l1 = (i2 - gameModel_1.vertexCameraX[j1]) * l2 + (j2 - gameModel_1.vertexCameraY[j1]) * i3 + (k2 - gameModel_1.vertexCameraZ[j1]) * j3;
    ...
    public void initialiseTextures(int count, int something7, int something11) {
        textureCount = count;
    ...
    public void loadTexture(int i, byte abyte0[], int ai[], int j) {
    ...
    public int anInt378;
    public int clipNear;
    public int clipFar_3d;
    public int clipFar_2d;
    ...
    int anIntArray446[];
    boolean interlace;
    static int frustumLeft;
    static int frustumRight;
    static int frustumBottom;
    static int frustumTop;
    static int frustumNear;
    static int frustumFar;
    int anInt454;
    int anInt455;
