public class GameData {
    ...
    public static void loadData(byte buffer[], boolean isMembers) {
        ...
        npcSomething_1 = new int[npcCount];
        npcSomething_2 = new int[npcCount];
        ...
        for (i = 0; i < npcCount; i++)
            npcSomething_1[i] = getUnsignedShort();

        for (i = 0; i < npcCount; i++)
            npcSomething_2[i] = getUnsignedShort();
        ...
        objectSomething = new int[objectCount];
        ...
        for (i = 0; i < objectCount; i++)
            objectSomething[i] = getUnsignedByte();
        ...
        wallObjectSomething2 = new int[wallObjectCount];
        wallObjectTexture = new int[wallObjectCount];
        wallObjectVisible = new int[wallObjectCount];
        ...
        for (i = 0; i < wallObjectCount; i++)
            wallObjectSomething2[i] = getUnsignedInt();

        for (i = 0; i < wallObjectCount; i++)
            wallObjectTexture[i] = getUnsignedInt();

        for (i = 0; i < wallObjectCount; i++)
            wallObjectVisible[i] = getUnsignedByte();// what's this?

        for (i = 0; i < wallObjectCount; i++)
            wallObjectInvisible[i] = getUnsignedByte();// value is 0 if visible

        anInt116 = getUnsignedShort();// the World class does something with these
        ...
        anInt88 = getUnsignedShort();// and these
    ...
    public static int objectSomething[];
    public static int spellCount;
    public static int npcSomething_1[];
    public static int npcSomething_2[];
    ...
    public static int wallObjectSomething2[];
    public static int wallObjectTexture[];
    public static int wallObjectVisible[];
