...
public class Class6
    ...
    public void method210(Graphics g, int i, int j) {
        method207();
    ...
    public void method224(int i, byte abyte0[], byte abyte1[], int j) {
        int k = Class15.method353(abyte0, 0);
        int l = Class15.method353(abyte1, k);
        k += 2;
        int i1 = Class15.method353(abyte1, k);
        k += 2;
        ...
        for(int i2 = i; i2 < i + j; i2++) {
            ...
            anIntArray324[i2] = Class15.method353(abyte1, k);
            k += 2;
            anIntArray325[i2] = Class15.method353(abyte1, k);
            k += 2;
    ...
    public void method230(int i, int j, int k) {
        ...
        if(anIntArrayArray321[k] == null) {
            method236(anIntArray317, aByteArrayArray322[k], anIntArrayArray323[k], i1, l, k1, j1, l1, i2, byte0);
            return;
        } else {
            method235(anIntArray317, anIntArrayArray321[k], 0, i1, l, k1, j1, l1, i2, byte0);
            return;
        }
    }

    public void method231(int i, int j, int k, int l, int i1) {
        try {
            ...
            method237(anIntArray317, anIntArrayArray321[i1], 0, l1, i2, i3, k3, k, l, j2, k2, j1, byte0);
            return;
        }
        catch(Exception _ex) {
    ...
    public void method232(int i, int j, int k, int l) {
        ...
        if(anIntArrayArray321[k] == null) {
            method239(anIntArray317, aByteArrayArray322[k], anIntArrayArray323[k], j1, i1, l1, k1, i2, j2, byte0, l);
            return;
        } else {
            method238(anIntArray317, anIntArrayArray321[k], 0, j1, i1, l1, k1, i2, j2, byte0, l);
            return;
        }
    }
    ...
    public void method233(int i, int j, int k, int l, int i1, int j1) {
        try {
            ...
            method240(anIntArray317, anIntArrayArray321[i1], 0, i2, j2, j3, l3, k, l, k2, l2, k1, byte0, j1);
            return;
        }
        catch(Exception _ex) {
            System.out.println("error in sprite clipping routine");
    ...
    public void method235(int ai[], int ai1[], int i, int j, int k, int l, int i1, 
    ...
    public void method236(int ai[], byte abyte0[], int ai1[], int i, int j, int k, int l, 
    ...
    public void method238(int ai[], int ai1[], int i, int j, int k, int l, int i1, 
    ...
    public void method239(int ai[], byte abyte0[], int ai1[], int i, int j, int k, int l, 
    ...
    public void method241(int ai[], int ai1[], int i, int j, int k, int l, int i1, 
            int j1, int k1, int l1, int i2, int j2, int k2, int l2) {
        int i3 = l2 >> 16 & 0xff;
        int j3 = l2 >> 8 & 0xff;
        int k3 = l2 & 0xff;
        ...
        for(int i11 = k6; i11 < l6; i11++) {
            ...
            if(k11 - j11 <= 0) {
                ...
                if(!aBoolean335 || (i11 & 1) == 0)
                    if(!aBooleanArray330[k])
                        method243(anIntArray317, ai, 0, l10 + j11, l11, j12, i12, k12, j11 - k11, j9);
                    else
    ...
    public void method244(int ai[], int ai1[], int i, int j, int k, int l, int i1, 
            int j1, int k1, int l1) {
        ...
        try {
            ...
            if(k1 == 0xffffff) {
                if(anIntArrayArray321[i1] != null)
                    if(!flag) {
                        method247(anIntArray317, anIntArrayArray321[i1], 0, k2, l2, j4, k, l, j3, k3, i2, j1, i3, l3, i5);
                        return;
                    } else {
                        method247(anIntArray317, anIntArrayArray321[i1], 0, (anIntArray324[i1] << 16) - k2 - 1, l2, j4, k, l, -j3, k3, i2, j1, i3, l3, i5);
                        return;
                    }
                if(!flag) {
                    method249(anIntArray317, aByteArrayArray322[i1], anIntArrayArray323[i1], 0, k2, l2, j4, k, l, j3, k3, i2, j1, i3, l3, i5);
                    return;
                } else {
                    method249(anIntArray317, aByteArrayArray322[i1], anIntArrayArray323[i1], 0, (anIntArray324[i1] << 16) - k2 - 1, l2, j4, k, l, -j3, k3, i2, j1, i3, l3, i5);
                    return;
                }
            }
            if(anIntArrayArray321[i1] != null)
                if(!flag) {
                    method248(anIntArray317, anIntArrayArray321[i1], 0, k2, l2, j4, k, l, j3, k3, i2, j1, k1, i3, l3, i5);
                    return;
                } else {
                    method248(anIntArray317, anIntArrayArray321[i1], 0, (anIntArray324[i1] << 16) - k2 - 1, l2, j4, k, l, -j3, k3, i2, j1, k1, i3, l3, i5);
                    return;
                }
            if(!flag) {
                method250(anIntArray317, aByteArrayArray322[i1], anIntArrayArray323[i1], 0, k2, l2, j4, k, l, j3, k3, i2, j1, k1, i3, l3, i5);
                return;
            } else {
                method250(anIntArray317, aByteArrayArray322[i1], anIntArrayArray323[i1], 0, (anIntArray324[i1] << 16) - k2 - 1, l2, j4, k, l, -j3, k3, i2, j1, k1, i3, l3, i5);
                return;
            }
        }
        catch(Exception _ex) {
    ...
    public void method248(int ai[], int ai1[], int i, int j, int k, int l, int i1, 
            int j1, int k1, int l1, int i2, int j2, int k2, int l2, 
            int i3, int j3) {
        int j4 = j2 >> 16 & 0xff;
        int k4 = j2 >> 8 & 0xff;
    ...
    public void method250(int ai[], byte abyte0[], int ai1[], int i, int j, int k, int l, 
            int i1, int j1, int k1, int l1, int i2, int j2, int k2, 
    ...
    public static void method251(String s, int i, Applet_Sub1 applet_sub1) {
        boolean flag = false;
        boolean flag1 = false;
        s = s.toLowerCase();
        ...
        anInt350 = 855;
        for(int l = 0; l < 95; l++)
            method252(font, fontmetrics, s1.charAt(l), l, applet_sub1, i, flag1);
        ...
        if(j == 1 && aBooleanArray349[i]) {
            ...
            method251("f" + k + "p", i, applet_sub1);
        }
        if(flag && !aBooleanArray349[i]) {
            aBooleanArray349[i] = false;
            method251("d" + k + "p", i, applet_sub1);
        }
    }

    public static void method252(Font font, FontMetrics fontmetrics, char c, int i, Applet_Sub1 applet_sub1, int j, boolean flag) {
...
label3:
    ...
    public void method253(String s, int i, int j, int k, int l) {
        method256(s, i - method262(s, k), j, k, l);
    }

    public void method254(String s, int i, int j, int k, int l) {
        method256(s, i - method262(s, k) / 2, j, k, l);
    }
        ...
        try {
            ...
            for(int i2 = 0; i2 < s.length(); i2++) {
                ...
                if(j1 > i1) {
                    if(l1 <= k1)
                        l1 = i2;
                    method254(s.substring(k1, l1), i, j, k, l);
                    j1 = 0;
                    k1 = i2 = l1 + 1;
                    j += method260(k);
                }
            ...
            if(j1 > 0) {
                method254(s.substring(k1), i, j, k, l);
                return;
            }
        }
    ...
    public void method256(String s, int i, int j, int k, int l) {
        try {
            byte abyte0[] = aByteArrayArray336[k];
    ...
    public void method257(int i, int j, int k, int l, byte abyte0[], boolean flag) {
        ...
        if(k1 > 0 && l1 > 0) {
            ...
            method258(anIntArray317, abyte0, l, i2, j2, k1, l1, k2, l2);
        }
    }

    public void method258(int ai[], byte abyte0[], int i, int j, int k, int l, int i1, 
            int j1, int k1) {
        try {
            int l1 = -(l >> 2);
            l = -(l & 3);
    ...
    public void method259(int ai[], byte abyte0[], int i, int j, int k, int l, int i1, 
            int j1, int k1) {
    ...
    public int method262(String s, int i) {
        int j = 0;
