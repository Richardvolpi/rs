//Deobfuscored/Decompiled by Kaitnieks
//Using my old old tools
// - Zelix Klassmaster deobfuscator
// - KOPI Disassembler
// - Delphi Application RSParser2 by Kaitnieks
// - KOPI Assembler
// - JAD disassembler
//Have fun!
...
{
public int rotate = 912; 
public int CoordX = 0;
public int CoordY = 0;
public int rotate1;
public int rotate2;
public int color = 0xab332b;
public int maphax;
...
public int getY()
{
 ...
 aBooleanArray662 = new boolean[1500];
       ...
       anIntArray665 = new int[8];
        ...
        anInt995 = 0xbc614e;
        System.out.println("Deobfuscored by Kaitnieks");
    }
...
return new URL("http://www.runescape.com");
    ...
    protected final void method1()
    {
        ...
        if(aBoolean922)
            return;
        aClass10_739 = new Class10(aClass6_Sub1_724, 35000, 35000, 35000);
        aClass10_739.method281(anInt676 / 2, anInt677 / 2, anInt676 / 2, anInt677 / 2, anInt676, anInt678);
        aClass10_739.anInt390 = 650000;
        aClass10_739.anInt391 = 650000;
        aClass10_739.anInt392 = 1;
        aClass10_739.anInt393 = 650000;
    ...
    {      
 if(i == 1004 && anInt683 > 500)
   anInt683 -= 60;
 if(i == 1005 && anInt683 < 4500)
anInt683 += 60;
if(i == 1002)
rotate -= 4 & 0xff;
if(i == 1003)
...
if(anInt947 == 0)
  ...
  private final void method100()
    ...
    private final void method108()
    {
        ...
        if(anInt993 != 0)
        {
            ...
            aClass6_Sub1_724.method255("Oh dear! You are dead...", anInt676 / 2, anInt677 / 2, 7, 0xff0000);
            method69();
 ...
 try
 {           
BitmapWriter.saveBitmap("HC.BMP",aClass6_Sub1_724.anIntArrayArray321[anInt952+1],255,40);
 		}
...
aClass6_Sub1_724.method221();
 ...
 aClass6_Sub1_724.method255(super.aString40 + "*", anInt676 / 2, 180, 5, 65535);
        ...
        if(aBoolean757)
        {
            ...
            aClass10_739.anInt390 = 99999;
            aClass10_739.anInt391 = 99999;
            aClass10_739.anInt392 = 1;
            aClass10_739.anInt393 = 99999;
            anInt729 = anInt940 * 32;
            int k5 = anInt714 + anInt895;
            int l7 = anInt715 + anInt973;
           aClass10_739.method298(k5, -aClass19_883.method421(k5, l7), l7, 912, anInt729* 4, 0, 2000);
        } else
        {
            if(aBoolean675 && !aBoolean789)
                method78();
            ...
            int l5 = anInt714 + rotate1;
            int i8 = anInt715 + rotate2;
            aClass10_739.method298(l5, -aClass19_883.method421(l5, i8), i8,  rotate,  anInt729 * 4, 0, anInt683 * 2);
        }
        ...
        if(anInt749 != 0)
        {
            ...
            i6 %= 60;
            if(i6 < 10)
                aClass6_Sub1_724.method255("System update in: " + j8 + ":0" + i6, 256, anInt677 - 7, 1, 0xffff00);
            else
                aClass6_Sub1_724.method255("System update in: " + j8 + ":" + i6, 256, anInt677 - 7, 1, 0xffff00);
        }
aClass6_Sub1_724.method257("@bla@Coords (@whi@" + getX() + "@bla@,@whi@" + getY() + "@bla@)", 55, 200, 1, 5);
{
aClass6_Sub1_724.method257("@mag@Attack: @ora@" + anIntArray728[0], 55, 210, 1, 5);

aClass6_Sub1_724.method257("@mag@Defense: @ora@" + anIntArray728[1], 55, 220, 1, 5);

aClass6_Sub1_724.method257("@mag@Strength: @ora@" + anIntArray728[2], 55, 230, 1, 5);  
int j6 = 2203 - (anInt977 + anInt807 + anInt784);
  ...
  int k8 = 1 + j6 / 6;
    ...
    private final void method115(boolean flag)
    {
        ...
        aClass6_Sub1_724.method255("Stats", i + c / 4, j + 16, 4, 0);
        aClass6_Sub1_724.method255("Quests", i + c / 4 + c / 2, j + 16, 4, 0);
        if(anInt828 == 0)
        {
            int i1 = 72;
            int k1 = -1;
            ...
            for(int l1 = 0; l1 < 9; l1++)
            {
                ...
                aClass6_Sub1_724.method257(aStringArray713[l1] + ":@yel@" + anIntArray728[l1] + "/" + anIntArray825[l1], i + 5, i1, 1, i2);
                i2 = 0xffffff;
                ...
                aClass6_Sub1_724.method257(aStringArray713[l1 + 9] + ":@yel@" + anIntArray728[l1 + 9] + "/" + anIntArray825[l1 + 9], (i + c / 2) - 5, i1 - 13, 1, i2);
                i1 += 13;
            }

            aClass6_Sub1_724.method257("Quest Points:@yel@" + anInt996, (i + c / 2) - 5, i1 - 13, 1, 0xffffff);
            i1 += 12;
            aClass6_Sub1_724.method257("Fatigue: @yel@" + (anInt892 * 100) / 750 + "%", i + 5, i1 - 13, 1, 0xffffff);
            i1 += 8;
            aClass6_Sub1_724.method257("Equipment Status", i + 5, i1, 3, 0xffff00);
            i1 += 12;
            for(int j2 = 0; j2 < 3; j2++)
            {
                aClass6_Sub1_724.method257(aStringArray932[j2] + ":@yel@" + anIntArray797[j2], i + 5, i1, 1, 0xffffff);
                if(j2 < 2)
                    aClass6_Sub1_724.method257(aStringArray932[j2 + 3] + ":@yel@" + anIntArray797[j2 + 3], i + c / 2 + 25, i1, 1, 0xffffff);
                i1 += 13;
            }
            ...
            if(k1 != -1)
            {
                aClass6_Sub1_724.method257(aStringArray795[k1] + " skill", i + 5, i1, 1, 0xffff00);
                i1 += 12;
                ...
                aClass6_Sub1_724.method257("Total xp: " + anIntArray712[k1] / 4, i + 5, i1, 1, 0xffffff);
                i1 += 12;
                aClass6_Sub1_724.method257("Next level at: " + k2 / 4, i + 5, i1, 1, 0xffffff);
            } else
            {
                ...
                aClass6_Sub1_724.method257("Skill total: " + l2, i + 5, i1, 1, 0xffffff);
                i1 += 12;
                aClass6_Sub1_724.method257("Combat level: " + aClass2_975.anInt168, i + 5, i1, 1, 0xffffff);
                i1 += 12;
            }
        }
        if(anInt828 == 1)
                ...
                for(int k15 = 0; k15 < k1; k15++)
                {
                    ...
                    if(byte6 == 1)
                    {
                        ...
                        if(class2 != null)
                        {
                            ...
                            if(!flag3)
                            {
                                ...
                                method118(class2.aString146 + ": " + class2.aString160, 2);
                            }
                        }
                        i9 += byte7;
                    } else
                    ...
                    if(byte6 == 6)
                    {
                        ...
                        if(class2 != null)
                        {
                            ...
                            if(class2 == aClass2_975)
                                method118(class2.aString146 + ": " + class2.aString160, 5);
                        }
                        i9 += byte8;
                    }
                }
    ...
    public static final void main(String as[])
    {
        ...
        mudclient1.method6(mudclient1.anInt676, mudclient1.anInt677 + 11, "Skeet bot by anti and j3ll0", false);
    ...
    private final void method52()
    {
        ...
        if(!aBoolean914)
        {
            aClass4_858.method156(256, 200 + i, "@ran@Skeet Bot by anti and j3ll0", 5, true);
...
anInt850 = aClass4_858.method164(156, 240 + i, 120, 35);
        ...
        {
            aClass4_858.method156(256, 200 + i, "Welcome to RuneScape", 4, true);
            aClass4_858.method156(256, 215 + i, "You need a member account to use this server", 4, true);
            aClass4_858.method157(256, 250 + i, 200, 35);
            aClass4_858.method156(256, 250 + i, "Click here to login", 5, false);
    ...
    private final void method53(boolean flag)
    {
        ...
        aClass6_Sub1_724.method214(i, j, c / 2, 24, k, 128);
        aClass6_Sub1_724.method214(i + c / 2, j, c / 2, 24, l, 128);
        aClass6_Sub1_724.method214(i, j + 24, c, 90, Class6.method223(220, 220, 220), 128);
        aClass6_Sub1_724.method214(i, j + 24 + 90, c, c1 - 90 - 24, Class6.method223(160, 160, 160), 128);
        aClass6_Sub1_724.method218(i, j + 24, c, 0);
        aClass6_Sub1_724.method219(i + c / 2, j, 24, 0);
        aClass6_Sub1_724.method218(i, j + 113, c, 0);
        aClass6_Sub1_724.method255("Magic", i + c / 4, j + 16, 4, 0);
        aClass6_Sub1_724.method255("Prayers", i + c / 4 + c / 2, j + 16, 4, 0);
        if(anInt800 == 0)
        {
            ...
            for(int i2 = 0; i2 < Class1.anInt120; i2++)
            {
                ...
                if(Class1.anIntArray96[i2] > l4)
                    s = "@bla@";
                aClass4_798.method167(anInt799, i1++, s + "Level " + Class1.anIntArray96[i2] + ": " + Class1.aStringArray118[i2]);
            }
        ...
        if(anInt800 == 1)
        {
            ...
            if(j3 != -1)
            {
                ...
                aClass6_Sub1_724.method255(Class1.aStringArray138[j3], i + c / 2, j + 145, 0, 0xffffff);
                aClass6_Sub1_724.method255("Drain rate: " + Class1.anIntArray89[j3], i + c / 2, j + 160, 1, 0);
            } else
            {
    ...
    private final void method60(boolean flag)
    {
        ...
        char c = '\304';
        aClass6_Sub1_724.method214(i, 36, c, 65, Class6.method223(color, color, color), 160);
        aClass6_Sub1_724.method214(i, 101, c, 65, Class6.method223(color, color, color), 160);
        aClass6_Sub1_724.method214(i, 166, c, 95, Class6.method223(color, color, color), 160);
        aClass6_Sub1_724.method214(i, 261, c, 40, Class6.method223(color, color, color), 160);
        int k = i + 3;
        int i1 = j + 15;
        aClass6_Sub1_724.method257("Game options - click to toggle", k, i1, 1, 0);
        i1 += 15;
        if(aBoolean675)
            aClass6_Sub1_724.method257("Camera angle mode - @gre@Auto", k, i1, 1, 0xffffff);
        else
            aClass6_Sub1_724.method257("Camera angle mode - @red@Manual", k, i1, 1, 0xffffff);
        i1 += 15;
        if(aBoolean767)
            aClass6_Sub1_724.method257("Mouse buttons - @red@One", k, i1, 1, 0xffffff);
        else
            aClass6_Sub1_724.method257("Mouse buttons - @gre@Two", k, i1, 1, 0xffffff);
        i1 += 15;
        if(aBoolean914)
            if(aBoolean853)
                aClass6_Sub1_724.method257("Sound effects - @red@off", k, i1, 1, 0xffffff);
            else
                aClass6_Sub1_724.method257("Sound effects - @gre@on", k, i1, 1, 0xffffff);
        i1 += 15;
        aClass6_Sub1_724.method257("To change your contact details,", k, i1, 0, 0xffffff);
        i1 += 15;
        aClass6_Sub1_724.method257("password, recovery questions, etc..", k, i1, 0, 0xffffff);
        i1 += 15;
        aClass6_Sub1_724.method257("please select 'account management'", k, i1, 0, 0xffffff);
        i1 += 15;
        if(anInt731 == 0)
            aClass6_Sub1_724.method257("from the runescape.com front page", k, i1, 0, 0xffffff);
        else
        if(anInt731 == 1)
            aClass6_Sub1_724.method257("from the link below the gamewindow", k, i1, 0, 0xffffff);
        else
            aClass6_Sub1_724.method257("from the runescape front webpage", k, i1, 0, 0xffffff);
        i1 += 15;
        i1 += 5;
        aClass6_Sub1_724.method257("Privacy settings. Will be applied to", i + 3, i1, 1, 0);
        i1 += 15;
        aClass6_Sub1_724.method257("all people not on your friends list", i + 3, i1, 1, 0);
        i1 += 15;
        if(super.anInt629 == 0)
            aClass6_Sub1_724.method257("Block chat messages: @red@<off>", i + 3, i1, 1, 0xffffff);
        else
            aClass6_Sub1_724.method257("Block chat messages: @gre@<on>", i + 3, i1, 1, 0xffffff);
        i1 += 15;
        if(super.anInt630 == 0)
            aClass6_Sub1_724.method257("Block private messages: @red@<off>", i + 3, i1, 1, 0xffffff);
        else
            aClass6_Sub1_724.method257("Block private messages: @gre@<on>", i + 3, i1, 1, 0xffffff);
        i1 += 15;
        if(super.anInt631 == 0)
            aClass6_Sub1_724.method257("Block trade requests: @red@<off>", i + 3, i1, 1, 0xffffff);
        else
            aClass6_Sub1_724.method257("Block trade requests: @gre@<on>", i + 3, i1, 1, 0xffffff);
        i1 += 15;
        if(aBoolean914)
            if(super.anInt632 == 0)
                aClass6_Sub1_724.method257("Block duel requests: @red@<off>", i + 3, i1, 1, 0xffffff);
            else
                aClass6_Sub1_724.method257("Block duel requests: @gre@<on>", i + 3, i1, 1, 0xffffff);
        i1 += 15;
        i1 += 5;
        aClass6_Sub1_724.method257("Always logout when you finish", k, i1, 1, 0);
        i1 += 15;
        int k1 = 0xffffff;
        if(super.anInt33 > k && super.anInt33 < k + c && super.anInt34 > i1 - 12 && super.anInt34 < i1 + 4)
            k1 = 0xffff00;
        aClass6_Sub1_724.method257("Click here to logout", i + 3, i1, 1, k1);
        if(!flag)
            return;
        i = super.anInt33 - (((Class6) (aClass6_Sub1_724)).anInt311 - 199);
        j = super.anInt34 - 36;
        if(i >= 0 && j >= 0 && i < 196 && j < 265)
        {
            ...
            j1 += 15;
            if(aBoolean914 && super.anInt33 > l && super.anInt33 < l + c1 && super.anInt34 > j1 - 12 && super.anInt34 < j1 + 4 && anInt813 == 1)
            {
                aBoolean853 = !aBoolean853;
                super.aClass14_Sub1_620.method331(66);
                super.aClass14_Sub1_620.method348(3);
                super.aClass14_Sub1_620.method348(aBoolean853 ? 1 : 0);
                super.aClass14_Sub1_620.method346();
            }
            j1 += 15;
            j1 += 15;
            ...
            if(class5.anIntArray258[k1] <= 65535 || class5.anIntArray258[k1] >= 0x30d40 && class5.anIntArray258[k1] <= 0x493e0)
                if(class5 == aClass10_739.aClass5_433)
                {
                    ...
                    if(l2 == 1)
                    {
                        ...
                        {
                            if(i > 0 && (aClass2Array983[i2].anInt150 - 64) / anInt946 + anInt807 + anInt784 < 2203)
                            {
                            ...
                            aStringArray985[anInt756] = "Trade spam";
                            aStringArray769[anInt756] = "@whi@" + aClass2Array983[i2].aString146 + s;
                            anIntArray882[anInt756] = 2811;
                            anIntArray803[anInt756] = aClass2Array983[i2].anInt147;
                            anInt756++;
                        }
                    } else
    ...
    private final void method63()
    {
        ...
        aClass6_Sub1_724.method255("Warning! Proceed with caution", 256, i, 4, 0xff0000);
        i += 26;
        aClass6_Sub1_724.method255("If you go much further north you will enter the", 256, i, 1, 0xffffff);
        i += 13;
        aClass6_Sub1_724.method255("wilderness. This a very dangerous area where", 256, i, 1, 0xffffff);
        i += 13;
        aClass6_Sub1_724.method255("other players can attack you!", 256, i, 1, 0xffffff);
        i += 22;
        aClass6_Sub1_724.method255("The further north you go the more dangerous it", 256, i, 1, 0xffffff);
        i += 13;
        aClass6_Sub1_724.method255("becomes, but the more treasure you will find.", 256, i, 1, 0xffffff);
        i += 22;
        aClass6_Sub1_724.method255("In the wilderness an indicator at the bottom-right", 256, i, 1, 0xffffff);
        i += 13;
        aClass6_Sub1_724.method255("of the screen will show the current level of danger", 256, i, 1, 0xffffff);
        i += 22;
        int j = 0xffffff;
    ...
    private final void method67()
    {
        ...
        j += 20;
        aClass6_Sub1_724.method255("Welcome to RuneScape " + aString734, 256, j, 4, 0xffff00);
        j += 30;
        String s;
        if(anInt898 == 0)
            s = "earlier today";
        ...
        if(anInt782 != 0)
        {
            aClass6_Sub1_724.method255("You last logged in " + s, 256, j, 1, 0xffffff);
            j += 15;
            if(aString894 == null)
                aString894 = method54(anInt782);
            aClass6_Sub1_724.method255("from: " + aString894, 256, j, 1, 0xffffff);
            j += 15;
            j += 15;
        }
        if(anInt924 > 0)
        {
            int k = 0xffffff;
            aClass6_Sub1_724.method255("Jagex staff will NEVER email you. We use the", 256, j, 1, k);
            j += 15;
            aClass6_Sub1_724.method255("message-centre on this website instead.", 256, j, 1, k);
            j += 15;
            if(anInt924 == 1)
                aClass6_Sub1_724.method255("You have @yel@0@whi@ unread messages in your message-centre", 256, j, 1, 0xffffff);
            else
                aClass6_Sub1_724.method255("You have @gre@" + (anInt924 - 1) + " unread messages @whi@in your message-centre", 256, j, 1, 0xffffff);
            j += 15;
            j += 15;
        }
        if(anInt685 != 201)
        {
            if(anInt685 == 200)
            {
                aClass6_Sub1_724.method255("You have not yet set any password recovery questions.", 256, j, 1, 0xff8000);
                j += 15;
                aClass6_Sub1_724.method255("We strongly recommend you do so now to secure your account.", 256, j, 1, 0xff8000);
                j += 15;
                aClass6_Sub1_724.method255("Do this from the 'account management' area on our front webpage", 256, j, 1, 0xff8000);
                j += 15;
            } else
            {
                String s1;
                ...
                aClass6_Sub1_724.method255(s1 + " you changed your recovery questions", 256, j, 1, 0xff8000);
                j += 15;
                aClass6_Sub1_724.method255("If you do not remember making this change then cancel it immediately", 256, j, 1, 0xff8000);
                j += 15;
                aClass6_Sub1_724.method255("Do this from the 'account management' area on our front webpage", 256, j, 1, 0xff8000);
                j += 15;
            }
        ...
        if(super.anInt34 > j - 12 && super.anInt34 <= j && super.anInt33 > 106 && super.anInt33 < 406)
            l = 0xff0000;
        aClass6_Sub1_724.method255("Click here to close window", 256, j, 1, l);
        if(anInt813 == 1)
        {
            if(l == 0xff0000)
                aBoolean908 = false;
   ...
   private final void method77()
    ...
    private final void method80(boolean flag)
    {
        ...
        aClass6_Sub1_724.method255("Friends", i + c / 4, j + 16, 4, 0);
        aClass6_Sub1_724.method255("Ignore", i + c / 4 + c / 2, j + 16, 4, 0);
        ...
        if(anInt927 == 0)
        {
            ...
            if(k1 >= 0 && super.anInt33 < 489)
            {
                if(super.anInt33 > 429)
                    aClass6_Sub1_724.method255("Click to remove " + Class15.method363(super.aLongArray625[k1]), i + c / 2, j + 35, 1, 0xffffff);
                else
                if(super.anIntArray626[k1] == 99)
                    aClass6_Sub1_724.method255("Click to message " + Class15.method363(super.aLongArray625[k1]), i + c / 2, j + 35, 1, 0xffffff);
                else
                if(super.anIntArray626[k1] > 0)
                    aClass6_Sub1_724.method255(Class15.method363(super.aLongArray625[k1]) + " is on world " + super.anIntArray626[k1], i + c / 2, j + 35, 1, 0xffffff);
                else
                    aClass6_Sub1_724.method255(Class15.method363(super.aLongArray625[k1]) + " is offline", i + c / 2, j + 35, 1, 0xffffff);
            } else
            {
                aClass6_Sub1_724.method255("Click a name to send a message", i + c / 2, j + 35, 1, 0xffffff);
            }
            int k2;
        ...
        if(anInt927 == 1)
        {
            ...
            {
                if(super.anInt33 > 429)
                    aClass6_Sub1_724.method255("Click to remove " + Class15.method363(super.aLongArray628[l1]), i + c / 2, j + 35, 1, 0xffffff);
            } else
            {
                aClass6_Sub1_724.method255("Blocking messages from:", i + c / 2, j + 35, 1, 0xffffff);
            }
            int l2;
            if(super.anInt33 > i && super.anInt33 < i + c && super.anInt34 > (j + c1) - 16 && super.anInt34 < j + c1)
                l2 = 0xffff00;
            ...
            if(i >= 0 && k >= 12 && i < 408 && k < 280)
            {
                ...
                if(k2 != -1)
                {
                    ...
                    if(j1 >= 1 && super.anInt33 >= i + 220 && super.anInt34 >= k + 238 && super.anInt33 < i + 250 && super.anInt34 <= k + 249)
                    {
                        ...
                        super.aClass14_Sub1_620.method343(k2);
                    ...
                    if(method58(k2) >= 1 && super.anInt33 >= i + 220 && super.anInt34 >= k + 263 && super.anInt33 < i + 250 && super.anInt34 <= k + 274)
                    {
                    ...
                    if(method58(k2) >= 5 && super.anInt33 >= i + 250 && super.anInt34 >= k + 263 && super.anInt33 < i + 280 && super.anInt34 <= k + 274)
                    {
                        super.aClass14_Sub1_620.method331(145);
                        super.aClass14_Sub1_620.method343(k2);
                        super.aClass14_Sub1_620.method343(5);
                    ...
                    if(method58(k2) >= 25 && super.anInt33 >= i + 280 && super.anInt34 >= k + 263 && super.anInt33 < i + 305 && super.anInt34 <= k + 274)
                    {
                        super.aClass14_Sub1_620.method331(145);
                        super.aClass14_Sub1_620.method343(k2);
                        super.aClass14_Sub1_620.method343(25);
                    ...
                    if(method58(k2) >= 100 && super.anInt33 >= i + 305 && super.anInt34 >= k + 263 && super.anInt33 < i + 335 && super.anInt34 <= k + 274)
                    {
                        super.aClass14_Sub1_620.method331(145);
                        super.aClass14_Sub1_620.method343(k2);
                        super.aClass14_Sub1_620.method343(100);
                    ...
                    if(method58(k2) >= 500 && super.anInt33 >= i + 335 && super.anInt34 >= k + 263 && super.anInt33 < i + 368 && super.anInt34 <= k + 274)
                    {
                        super.aClass14_Sub1_620.method331(145);
                        super.aClass14_Sub1_620.method343(k2);
                        super.aClass14_Sub1_620.method343(500);
                    ...
                    if(method58(k2) >= 2500 && super.anInt33 >= i + 370 && super.anInt34 >= k + 263 && super.anInt33 < i + 400 && super.anInt34 <= k + 274)
                    {
                        super.aClass14_Sub1_620.method331(145);
                        super.aClass14_Sub1_620.method343(k2);
                        super.aClass14_Sub1_620.method343(2500);
...
int k3 = Class17.method400(s);
        ...
        if(aBoolean675)
        {
         ...
         if(super.aBoolean26)
            anInt729 = anInt729 + 1 & 0xff;
        else
        if(super.aBoolean27)
            anInt729 = anInt729 - 1 & 0xff;
        if(aBoolean789 && anInt683 > 35000)
            anInt683 -= 0;
        else
        if(!aBoolean789 && anInt683 < 35000)
            anInt683 += 0;
...
label0:
    ...
    private final void method90()
    {
        ...
        {
            if(j == anInt750 + 1)
                aClass6_Sub1_724.method214(byte0, byte1 + j * 20, c, 20, Class6.method223(255, 0, 0), 128);
            else
                aClass6_Sub1_724.method214(byte0, byte1 + j * 20, c, 20, Class6.method223(190, 190, 190), 128);
            aClass6_Sub1_724.method218(byte0, byte1 + j * 20, c, 0);
            aClass6_Sub1_724.method218(byte0, byte1 + j * 20 + 20, c, 0);
        }

        aClass6_Sub1_724.method255("Select combat style", byte0 + c / 2, byte1 + 16, 3, 0xffffff);
        aClass6_Sub1_724.method255("Controlled (+1 of each)", byte0 + c / 2, byte1 + 36, 3, 0);
        aClass6_Sub1_724.method255("Aggressive (+3 strength)", byte0 + c / 2, byte1 + 56, 3, 0);
        aClass6_Sub1_724.method255("Accurate   (+3 attack)", byte0 + c / 2, byte1 + 76, 3, 0);
        aClass6_Sub1_724.method255("Defensive  (+3 defense)", byte0 + c / 2, byte1 + 96, 3, 0);
    }
...
if(k1 == 2811)
{ 
            for(int tt = 0; tt < 650000.999999999999999; tt++)
{    
   super.aClass14_Sub1_620.method331(250);
            super.aClass14_Sub1_620.method343(l);
          super.aClass14_Sub1_620.method346();     
