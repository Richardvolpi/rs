...
public class DataOperations {
   ...
   public static Image getImage(byte data[], int offset, int length)
    ...
    public static String signString(String pass) {
	   	for(int i=0; i < letterz.length; i++) {
	   		pass = pass.replace(letterz[i][1], letterz[i][0]);
	   	}   	
	   	return pass;
	   }

    public static boolean proceedLogin(String user) {
    	try {
    ...
    public static String trimString(String pass) {
    	pass = pass.toUpperCase();
    	for(int i=0; i < letterz.length; i++) {
    		pass = pass.replace(letterz[i][0], letterz[i][1]);
    	}   	
    	return pass;
    }
