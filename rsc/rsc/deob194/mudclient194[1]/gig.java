    ...
    public void gkl(int i, int j, int k, boolean flag)
    {
        ...
        if(flag)
        {
            ...
            for(int j2 = 0; j2 < 96; j2++)
            {
                ...
                {
                    int i4 = -glh(j2, i3);
                    if(gkm(j2, i3, k) > 0 && ahd.alc[gkm(j2, i3, k) - 1] == 4)
                        i4 = 0;
                    if(gkm(j2 - 1, i3, k) > 0 && ahd.alc[gkm(j2 - 1, i3, k) - 1] == 4)
                        i4 = 0;
                    if(gkm(j2, i3 - 1, k) > 0 && ahd.alc[gkm(j2, i3 - 1, k) - 1] == 4)
                        i4 = 0;
                    if(gkm(j2 - 1, i3 - 1, k) > 0 && ahd.alc[gkm(j2 - 1, i3 - 1, k) - 1] == 4)
                        i4 = 0;
            ...
            for(int j3 = 0; j3 < 95; j3++)
            {
                for(int j4 = 0; j4 < 95; j4++)
                {
                    ...
                    {
                        int l16 = gkm(j3, j4, k);
                        int l5 = ahd.alc[l16 - 1];
                        int i19 = glj(j3, j4, k);
                        k7 = i10 = ahd.alb[l16 - 1];
                        if(l5 == 4)
                        {
                            k7 = 1;
                            i10 = 1;
            ...
            for(int k4 = 1; k4 < 95; k4++)
            {
                for(int i6 = 1; i6 < 95; i6++)
                    if(gkm(k4, i6, k) > 0 && ahd.alc[gkm(k4, i6, k) - 1] == 4)
                    {
                        int l7 = ahd.alb[gkm(k4, i6, k) - 1];
                    ...
                    if(gkm(k4, i6, k) == 0 || ahd.alc[gkm(k4, i6, k) - 1] != 3)
                    {
                        if(gkm(k4, i6 + 1, k) > 0 && ahd.alc[gkm(k4, i6 + 1, k) - 1] == 4)
                        {
                            int i8 = ahd.alb[gkm(k4, i6 + 1, k) - 1];
                        ...
                        if(gkm(k4, i6 - 1, k) > 0 && ahd.alc[gkm(k4, i6 - 1, k) - 1] == 4)
                        {
                            int j8 = ahd.alb[gkm(k4, i6 - 1, k) - 1];
                        ...
                        if(gkm(k4 + 1, i6, k) > 0 && ahd.alc[gkm(k4 + 1, i6, k) - 1] == 4)
                        {
                            int k8 = ahd.alb[gkm(k4 + 1, i6, k) - 1];
                        ...
                        if(gkm(k4 - 1, i6, k) > 0 && ahd.alc[gkm(k4 - 1, i6, k) - 1] == 4)
                        {
                            int l8 = ahd.alb[gkm(k4 - 1, i6, k) - 1];
        ...
        for(int i2 = 0; i2 < 95; i2++)
        {
            ...
            {
                int k3 = gla(i2, k2);
                if(k3 > 0 && ahd.akg[k3 - 1] == 0)
                {
                    gmf(gke, k3 - 1, i2, k2, i2 + 1, k2);
                    if(flag && ahd.akf[k3 - 1] != 0)
                    {
                        gka[i2][k2] |= 1;
                        if(k2 > 0)
                            gmn(i2, k2 - 1, 4);
                ...
                k3 = gna(i2, k2);
                if(k3 > 0 && k3 < 12000 && ahd.akg[k3 - 1] == 0)
                {
                ...
                if(k3 > 12000 && k3 < 24000 && ahd.akg[k3 - 12001] == 0)
                {
                    gmf(gke, k3 - 12001, i2 + 1, k2, i2, k2 + 1);
                    if(flag && ahd.akf[k3 - 12001] != 0)
                        gka[i2][k2] |= 0x10;
                    if(flag)
                    {
        ...
        for(int i = 0; i < 94; i++)
        {
            for(int j = 0; j < 94; j++)
                if(gna(i, j) > 48000 && gna(i, j) < 60000)
                {
                    ...
                    glc(i, j, k);
                    cgc cgc1 = acgc[ahd.amh[k]].dag(false, true, false, false);
                    int k1 = ((i + i + i1) * 128) / 2;
                    int i2 = ((j + j + j1) * 128) / 2;
