// Decompiled by DJ v3.7.7.81 Copyright 2004 Atanas Neshkov  Date: 03/09/2004 7:42:47 PM
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   HerberTaverly.java


public class HerberTaverly extends Script
{

    public HerberTaverly(mudclient mudclient)
    {
        super(mudclient);
        T = "nothing";
    }
                ...
                {
                    {
                        ...
                        if(k != -1)
                        {
                            ...
                            SetFightMode(i);
                            AttackNPC(k);
                            for(; System.currentTimeMillis() - l <= (long)j && !InCombat() && Running(); Wait(1));
                        }
                        if(LastChatMessage() != null)
                        {
                            T = LastChatMessage();
    ...
    public void WalkAndBank()
    {
        ...
        Wait(2000);
        for(; GetX() == 342 && Running(); Wait(2000))
            AtObject(341, 487);

        Walk(316, 521);
        Walk(327, 553);
        for(; ObjectAt(327, 522) == 64; Wait(1000))
            AtObject(327, 522);
        ...
        Walk(341, 488);
        Wait(1000);
        for(; GetX() == 341 && Running(); Wait(2000))
            AtObject(341, 487);
