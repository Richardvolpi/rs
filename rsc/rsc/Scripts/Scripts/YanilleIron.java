public class YanilleIron extends Script
{
    ...
    public YanilleIron(mudclient rs)
    {
        super(rs);
    }
    ...
    {
        DisplayMessage("@ran@-@ran@=@ran@=@ran@:@ora@Yanille Iron Miner By Unknown Idiot started@ran@:@ran@=@ran@=@ran@-", 3);
        while(Running())
        {   
            DoMining();
            Wait(500);
        ...
        DisplayMessage("@ran@-@ran@=@ran@=@ran@:@ora@Yanille Iron Miner By Unknown Idiot stopped@ran@:@ran@=@ran@=@ran@-", 3);
    }
...
//MINING PROCEDURE
    public void DoMining()
    {
        ...
        while(InvCount() < 30)
        {
            ...
            if (ObjectAt(569,715) == 102 && ObjectAt(567,716) == 98 && Running() == true) AtObject(569,715);
            Wait(2000);
        }
    }
//WALK TO BANK
