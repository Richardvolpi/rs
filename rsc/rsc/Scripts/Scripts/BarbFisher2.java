...
public class BarbFisher2 extends Script implements ActionListener
{
    ...
    public int fishes = 0, slept = 0, startexp = 0, expgained = 0, fLevels = 0, sLevel = 0, XFire = 0, YFire = 0, DepId1 = 0, DepId2 = 0; 
    ...
    public BarbFisher2(mudclient rs)
    {
        super(rs);
    }
   ...
   pSlept.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));
       ...
       if (fishmode.equalsIgnoreCase("Fish Then Cook") && bankmode.equalsIgnoreCase("Banking"))  { DepId1 = 357; DepId2 = 359; XFire = 222; YFire = 1385;}
       if (fishmode.equalsIgnoreCase("Fish Then Cook") && bankmode.equalsIgnoreCase("No Banking")) {XFire = 234; YFire = 495;}
       if (fishmode.equalsIgnoreCase("Just Fish") && bankmode.equalsIgnoreCase("No Banking")) {DepId1 = 356; DepId2 = 358;}
       sLevel=GetStat(10);
       setupReport();
       showReport();
       Wait(1000);   
       DisplayMessage("@ran@S@ran@a@ran@g@ran@s @cya@Multi @blu@Barb @cya@Fisher @blu@Started @gre@ MUCH <3 To Bruncle for GUI!!", 3);
