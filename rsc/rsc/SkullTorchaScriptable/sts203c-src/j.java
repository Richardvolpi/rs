...
public class j implements ImageProducer, ImageObserver {
    ...
    public void can(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        for (int j2 = 0; j2 < arg3; j2 += byte0) {
            if (j2 + arg1 >= bmm && j2 + arg1 < bmn) {
                int k2 = ((i * j2 + i1 * (arg3 - j2)) / arg3 << 16) + ((k * j2 + j1 * (arg3 - j2)) / arg3 << 8)
    ...
    public void DrawBorder(int i, int k, int l, int i1, int j1) {
        cbc(i, k, l, j1);
        cbc(i, (k + i1) - 1, l, j1);
        cbd(i, k, i1, j1);
        cbd((i + l) - 1, k, i1, j1);
    ...
    public static int ToHex(int i, int k, int l) {
        return (i << 16) + (k << 8) + l;
    }
    ...
    public void DrawPicture(int x, int y, int PictureIndex) {
        ...
        int i1 = x + y * blg;
        int j1 = 0;
        int k1 = bmg[PictureIndex];
        int l1 = bmf[PictureIndex];
        int i2 = blg - l1;
        int j2 = 0;
        ...
        if (bmc[PictureIndex] == null) {
            cch(blm, bmd[PictureIndex], bme[PictureIndex], j1, i1, l1, k1, i2, j2, byte0);
        } else {
            ccg(blm, bmc[PictureIndex], 0, j1, i1, l1, k1, i2, j2, byte0);
        }
    }
    ...
    private void ccg(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        int i = -(arg5 >> 2);
    ...
    private void cch(int arg0[], byte arg1[], int arg2[], int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        int i = -(arg5 >> 2);
    ...
    private void cci(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12) {
        try {
            int i = arg3;
    ...
    private void ccj(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
        int i = 256 - arg10;
        ...
        for (int k = -arg6; k < 0; k += arg9) {
            for (int l = -arg5; l < 0; l++) {
                ...
                if (arg2 != 0) {
                    ...
                    arg0[arg4++] = ((arg2 & 0xff00ff) * arg10 + (i1 & 0xff00ff) * i & 0xff00ff00)
                            + ((arg2 & 0xff00) * arg10 + (i1 & 0xff00) * i & 0xff0000)
                                    >> 8;
                } else {
                    arg4++;
                }
    ...
    private void cck(int arg0[], byte arg1[], int arg2[], int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10) {
        int i = 256 - arg10;
        ...
        for (int k = -arg6; k < 0; k += arg9) {
            for (int l = -arg5; l < 0; l++) {
                ...
                if (i1 != 0) {
                    ...
                    arg0[arg4++] = ((i1 & 0xff00ff) * arg10 + (j1 & 0xff00ff) * i & 0xff00ff00)
                            + ((i1 & 0xff00) * arg10 + (j1 & 0xff00) * i & 0xff0000)
                                    >> 8;
                } else {
                    arg4++;
                }
    ...
    private void ccl(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13) {
        int i = 256 - arg13;
            ...
            for (int l = -arg8; l < 0; l += arg12) {
                ...
                for (int j1 = -arg7; j1 < 0; j1++) {
                    ...
                    if (arg2 != 0) {
                        ...
                        arg0[arg5++] = ((arg2 & 0xff00ff) * arg13 + (k1 & 0xff00ff) * i & 0xff00ff00)
                                + ((arg2 & 0xff00) * arg13 + (k1 & 0xff00) * i & 0xff0000)
                                        >> 8;
                    } else {
                        arg5++;
                    }
    ...
    private void ccm(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13) {
        int i = arg13 >> 16 & 0xff;
        int k = arg13 >> 8 & 0xff;
        int l = arg13 & 0xff;
    ...
    private void cda(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
    ...
    private void cdb(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
    ...
    public void cdd(int i, int k, int l, int i1, int j1, int k1, int l1, int i2, boolean flag) {
        try {
            if (k1 == 0) {
                k1 = 0xffffff;
            }
    ...
    private void cde(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14) {
    ...
    private void cdf(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15) {
        int i1 = arg11 >> 16 & 0xff;
        int j1 = arg11 >> 8 & 0xff;
        int k1 = arg11 & 0xff;
    ...
    private void cdg(int arg0[], byte arg1[], int arg2[], int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15) {
    ...
    private void cdh(int arg0[], byte arg1[], int arg2[], int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16) {
        int i1 = arg12 >> 16 & 0xff;
        int j1 = arg12 >> 8 & 0xff;
        int k1 = arg12 & 0xff;
    ...
    public static void cdj(Font arg0, FontMetrics arg1, char arg2, int arg3, a arg4, int arg5, boolean arg6) {
        ...
        if (arg6) {
            try {
                ...
                if (arg2 == 'f' || arg2 == 't' || arg2 == 'w' || arg2 == 'v' || arg2 == 'k' || arg2 == 'x'
                        || arg2 == 'y' || arg2 == 'A' || arg2 == 'V' || arg2 == 'W') {
                    i++;
                }
            } catch (Exception _ex) {}
        }
    ...
    public void cdk(String s, int i, int k, int l, int i1) {
        DrawStr(s, i - cef(s, l), k, l, i1);
    }

    public void DrawCenteredStr(String s, int i, int k, int l, int i1) {
        DrawStr(s, i - cef(s, l) / 2, k, l, i1);
    }
        ...
        try {
            ...
            for (int i1 = 0; i1 < arg0.length(); i1++) {
                ...
                if (i > arg5) {
                    ...
                    DrawCenteredStr(arg0.substring(k, l), arg1, arg2, arg3, arg4);
                    i = 0;
                    k = i1 = l + 1;
                    arg2 += ced(arg3);
                }
            ...
            if (i > 0) {
                DrawCenteredStr(arg0.substring(k), arg1, arg2, arg3, arg4);
                return;
            }
    ...
    public void DrawStr(String arg0, int arg1, int arg2, int arg3, int arg4) {
        try {
            byte abyte0[] = bnd[arg3];
            ...
            for (int i = 0; i < arg0.length(); i++) {
                if (arg0.charAt(i) == '@' && i + 4 < arg0.length() && arg0.charAt(i + 4) == '@') {
                    if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("red")) {
                        arg4 = 0xff0000;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("lre")) {
                        arg4 = 0xff9040;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("yel")) {
                        arg4 = 0xffff00;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("gre")) {
                        arg4 = 65280;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("blu")) {
                        arg4 = 255;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("cya")) {
                        arg4 = 65535;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("mag")) {
                        arg4 = 0xff00ff;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("whi")) {
                        arg4 = 0xffffff;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("gra")) {
                        arg4 = 0x9f9f9f;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("bla")) {
                        arg4 = 0;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("dre")) {
                        arg4 = 0xc00000;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("ora")) {
                        arg4 = 0xff9040;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("ran")) {
                        arg4 = (int) (Math.random() * 16777215D);
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("or1")) {
                        arg4 = 0xffb000;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("or2")) {
                        arg4 = 0xff7000;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("or3")) {
                        arg4 = 0xff3000;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("gr1")) {
                        arg4 = 0xc0ff00;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("gr2")) {
                        arg4 = 0x80ff00;
                    } else if (arg0.substring(i + 1, i + 4).equalsIgnoreCase("gr3")) {
                        arg4 = 0x40ff00;
                    }
                    i += 4;
                } else if (arg0.charAt(i) == '~' && i + 4 < arg0.length() && arg0.charAt(i + 4) == '~') {
    ...
    private void ceb(int arg0[], byte arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
        try {
            int i = -(arg5 >> 2);
    ...
    private void cec(int arg0[], byte arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
            ...
            for (int k = -arg5; k < 0; k++) {
                ...
                if (l > 30) {
                    if (l >= 230) {
                        ...
                        arg0[arg4++] = ((arg2 & 0xff00ff) * l + (i1 & 0xff00ff) * (256 - l) & 0xff00ff00)
                                + ((arg2 & 0xff00) * l + (i1 & 0xff00) * (256 - l) & 0xff0000)
                                        >> 8;
                    }
                } else {
                    arg4++;
