...
public class i {
    ...
    public i(byte arg0[], int arg1, boolean arg2) {
        ...
        cle = 512;
        clf = 32;
        int j = t.fmi(arg0, arg1);

        arg1 += 2;
        int k = t.fmi(arg0, arg1);

        arg1 += 2;
        cli(j, k);
        cje = new int[k][1];
        for (int l = 0; l < j; l++) {
            cil[l] = t.fml(arg0, arg1);
            arg1 += 2;
        }
        for (int i1 = 0; i1 < j; i1++) {
            cim[i1] = t.fml(arg0, arg1);
            arg1 += 2;
        }
        for (int j1 = 0; j1 < j; j1++) {
            cin[j1] = t.fml(arg0, arg1);
            arg1 += 2;
        }
        cfh = j;
    ...
    public i(String arg0) {
        ...
        try {
            java.io.InputStream inputstream = t.OpenInputStream(arg0);
    ...
    public void cnh(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, 
            int arg7) {
        cng();
        if (chf > n.bgj || chg < n.bgi || chb > n.bgf || chc < n.bge || chd > n.bgh || che < n.bgg) {
            cha = false;
            return;
        }
        cha = true;
