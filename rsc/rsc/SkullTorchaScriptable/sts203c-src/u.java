public class u {
    ...
    public static void ffl(q q1, q q2, q q3, q q4) {
        ffn(q2);
        fga(q3);
        fgb(q1);
        ffm(q4);
    ...
    public static void fgb(q arg0) {
        ffd = new int[arg0.dbf()];
        for (int i = 0; i < ffd.length; i++) {
            ffd[i] = arg0.dbe();
        }
    }

    public static void fgc(q arg0, char arg1[][], byte arg2[][][]) {
        for (int i = 0; i < arg1.length; i++) {
            ...
            arg1[i] = ac;
            byte abyte0[][] = new byte[arg0.dbf()][2];

            for (int k = 0; k < abyte0.length; k++) {
                abyte0[k][0] = (byte) arg0.dbd();
                abyte0[k][1] = (byte) arg0.dbd();
            }
            if (abyte0.length > 0) {
                arg2[i] = abyte0;
            }
    ...
    public static void fgj(char arg0[], char arg1[], char arg2[], char arg3[], int arg4) {
        ...
        for (int i = 0; i <= arg0.length - arg3.length; i++) {
            ...
            if (k >= arg3.length) {
                ...
                if (fen) {
                    System.out.println(
                            "Potential tld: " + CharToStr(arg3) + " at char " + i + " (type=" + arg4 + ", startmatch="
                            + i1 + ", endmatch=" + j1 + ")");
                }
                if (arg4 == 1 && i1 > 0 && j1 > 0) {
                    flag = true;
                ...
                if (flag) {
                    System.out.println("Filtered tld: " + CharToStr(arg3) + " at char " + i);
                    int k1 = i;
                    int l1 = j - 1;
    ...
    public static void fgm(char arg0[], char arg1[], byte arg2[][]) {
        ...
        for (int i = 0; i <= arg0.length - arg1.length; i++) {
            ...
            if (k >= arg1.length) {
                ...
                if (fen) {
                    System.out.println("Potential word: " + CharToStr(arg1) + " at char " + i);
                }
                if (!flag) {
                    char c1 = ' ';
                ...
                if (flag1) {
                    System.out.println("Filtered word: " + CharToStr(arg1) + " at char " + i);
    ...
    static char ffi[][];
    static int ffj[];
    static String ffk[] = { "cook", "cook's", "cooks", "seeks", "sheet"};
}
