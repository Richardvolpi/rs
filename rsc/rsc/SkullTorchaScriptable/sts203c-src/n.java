public class n {
    ...
    public void bhk(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        bcj = arg2;
        bck = arg3;
        bcl = arg0;
        bcm = arg1;
    ...
    public void bhm(int arg0, l arg1[], int arg2) {
        ...
        do {
            ...
            for (int i2 = k1; i2 >= j1 + 1; i2--) {
                ...
                if (l1.bkd < l2.bkf && l2.bkd < l1.bkf && l1.bke < l2.bkg && l2.bke < l1.bkg && l1.ble != l2.blf
                        && !bjc(l1, l2) && bjd(l2, l1)) {
                    bhn(arg1, j1, i2);
                    if (arg1[i2] != l2) {
                        i2++;
    ...
    private void bic(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5[], int arg6[], int arg7[], i arg8, int arg9) {
        if (arg4 == 3) {
            int k = arg6[0] + bcm;
            int l1 = arg6[1] + bcm;
            int l2 = arg6[2] + bcm;
    ...
    private void bid(int arg0, int arg1, int arg2, int arg3[], int arg4[], int arg5[], int arg6, i arg7) {
        if (arg6 == -2) {
            return;
        }
        if (arg6 >= 0) {
            ...
            if (bel[arg6] == 1) {
                ...
                if (arg7.chi) {
                    for (arg0 = bfj; arg0 < bfk; arg0 += byte1) {
                        ...
                        if (j20 <= 0) {
                            ...
                            bif(bfh, ben[arg6], 0, 0, k9 + j14 * arg1, j11 + l14 * arg1, l12 + j15 * arg1, j10, l11, j13,
                ...
                if (!bfa[arg6]) {
                    for (arg0 = bfj; arg0 < bfk; arg0 += byte1) {
                        ...
                        if (k20 <= 0) {
                            ...
                            bie(bfh, ben[arg6], 0, 0, k9 + j14 * arg1, j11 + l14 * arg1, l12 + j15 * arg1, j10, l11, j13,
                ...
                for (arg0 = bfj; arg0 < bfk; arg0 += byte1) {
                    ...
                    if (l20 <= 0) {
                        ...
                        big(bfh, 0, 0, 0, ben[arg6], k9 + j14 * arg1, j11 + l14 * arg1, l12 + j15 * arg1, j10, l11, j13,
                                l20, l16 + arg1, j22, l23);
                        k9 += l10;
                        j11 += j12;
                        l12 += l13;
                        l16 += j16;
            ...
            if (arg7.chi) {
                for (arg0 = bfj; arg0 < bfk; arg0 += byte2) {
                    ...
                    if (i21 <= 0) {
                        ...
                        bii(bfh, ben[arg6], 0, 0, l9 + k14 * arg1, k11 + i15 * arg1, i13 + k15 * arg1, k10, i12, k13,
                                i21, i17 + arg1, k22, i24);
                        l9 += i11;
                        k11 += k12;
                        i13 += i14;
                        i17 += k16;
            ...
            if (!bfa[arg6]) {
                for (arg0 = bfj; arg0 < bfk; arg0 += byte2) {
                    ...
                    if (j21 <= 0) {
                        ...
                        bih(bfh, ben[arg6], 0, 0, l9 + k14 * arg1, k11 + i15 * arg1, i13 + k15 * arg1, k10, i12, k13,
                                j21, i17 + arg1, l22, j24);
                        l9 += i11;
                        k11 += k12;
                        i13 += i14;
                        i17 += k16;
            ...
            for (arg0 = bfj; arg0 < bfk; arg0 += byte2) {
                ...
                if (k21 <= 0) {
                    ...
                    bij(bfh, 0, 0, 0, ben[arg6], l9 + k14 * arg1, k11 + i15 * arg1, i13 + k15 * arg1, k10, i12, k13, k21,
                            i17 + arg1, i23, k24);
                    l9 += i11;
                    k11 += k12;
                    i13 += i14;
    ...
    private static void bie(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13) {
        if (arg10 <= 0) {
            return;
        }
        int k = 0;
    ...
    private static void bif(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13) {
        if (arg10 <= 0) {
            return;
        }
        int k = 0;
    ...
    private static void big(int arg0[], int arg1, int arg2, int arg3, int arg4[], int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14) {
        if (arg11 <= 0) {
            return;
        }
        int k = 0;
    ...
    private static void bih(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13) {
        if (arg10 <= 0) {
            return;
        }
        int k = 0;
    ...
    private static void bii(int arg0[], int arg1[], int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13) {
        if (arg10 <= 0) {
            return;
        }
        int k = 0;
    ...
    private static void bij(int arg0[], int arg1, int arg2, int arg3, int arg4[], int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14) {
        if (arg11 <= 0) {
            return;
        }
        int k = 0;
    ...
    public void bin(int k, int i1, int j1, int k1, int l1, int i2, int j2) {
        k1 &= 0x3ff;
        l1 &= 0x3ff;
        i2 &= 0x3ff;
        bde = 1024 - k1 & 0x3ff;
            ...
            if (arg1[j1] < arg1[k1]) {
                if (arg1[j1] < arg3[l1]) {
                    if (arg1[j1] < arg3[i2]) {
                        ...
                        int l16 = bjn(arg2[((i2 - 1) + i1) % i1], arg3[((i2 - 1) + i1) % i1], arg2[i2], arg3[i2],
                                arg1[j1]);
