    ...
    implements ImageProducer, ImageObserver
{
    ...
    {
        int k3 = anInt352;
        int k = fnf.method354(abyte0, 0);
        int l = fnf.method354(abyte1, k);
        k += 2;
        int i1 = fnf.method354(abyte1, k);
        k += 2;
        ...
        for(int i2 = i; i2 < i + j; i2++)
        {
            ...
            anIntArray324[i2] = fnf.method354(abyte1, k);
            k += 2;
            anIntArray325[i2] = fnf.method354(abyte1, k);
            k += 2;
    ...
    public void method237(int ai[], byte abyte0[], int ai1[], int i, int j, int k, int l, 
    ...
    public void method240(int ai[], byte abyte0[], int ai1[], int i, int j, int k, int l, 
    ...
    public void method245(int ai[], int ai1[], int i, int j, int k, int l, int i1, 
            int j1, int k1, int l1)
    {
        int j2 = anInt352;
    ...
    public void method249(int ai[], int ai1[], int i, int j, int k, int l, int i1, 
            int j1, int k1, int l1, int i2, int j2, int k2, int l2, 
            int i3, int j3)
    {
        int l7 = anInt352;
    ...
    public void method251(int ai[], byte abyte0[], int ai1[], int i, int j, int k, int l, 
            int i1, int j1, int k1, int l1, int i2, int j2, int k2, 
...
label3:
        ...
        try
        {
            ...
            for(int i2 = 0; i2 < s.length(); i2++)
            {
                ...
                if(j1 > i1)
                {
                    if(l1 <= k1)
                        l1 = i2;
                    drawString(s.substring(k1, l1), i, j, k, l);
                    j1 = 0;
                    k1 = i2 = l1 + 1;
                    j += method261(k);
                }
            ...
            if(j1 > 0)
            {
                drawString(s.substring(k1), i, j, k, l);
                return;
            }
        }
    ...
    public void method258(int i, int j, int k, int l, byte abyte0[], boolean flag)
    {
        int i1 = j + abyte0[i + 5];
        int j1 = k - abyte0[i + 6];
        int k1 = abyte0[i + 3];
    ...
    public void method260(int ai[], byte abyte0[], int i, int j, int k, int l, int i1, 
            int j1, int k1)
    {
        int l2 = anInt352;
