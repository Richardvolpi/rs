    ...
    implements Runnable
{
    ...
    {
        fjh.setColor(new Color(53,53,53));
...
public void drawlogo() {
    ...
    private final Image fll(byte arg0[])
    {
	  ...
	  /*try{
	  PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("index.txt")));
	  out.print(image); out.close();} catch(Exception e) { System.err.println(e.toString()); }
        */
	  return image;
    }
