...
public class gca
{
    ...
    public void ggb(int i, int j, int k, int l)
    {
        gcb.cbh(i, j, k, l, 0);
        gcb.cbi(i, j, k, l, gef);
        gcb.cbi(i + 1, j + 1, k - 2, l - 2, geg);
        gcb.cbi(i + 2, j + 2, k - 4, l - 4, geh);
        gcb.cci(i, j, 2 + gfa);
        gcb.cci((i + k) - 7, j, 3 + gfa);
        gcb.cci(i, (j + l) - 7, 4 + gfa);
        gcb.cci((i + k) - 7, (j + l) - 7, 5 + gfa);
    }
