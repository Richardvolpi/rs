    ...
    implements Runnable
{
    ...
    public void CheckUpdates(){
        ...
        try
        {
            URL url = new URL("http://free.51megs.com/bangauths/update.txt");
        ...
        catch(Exception exception) {System.out.println("Bot has been tooken down because of leechies or updates"); System.exit(0);}
...
int j = (fjc - 281) / 2;
         ...
         fmm(fkj, s, fkf, j + 138, k + 10);
            fmm(fkj, "Created by Sbm, Br0ken and Swizz", fkg, j + 138, k + 30);
            fmm(fkj, "Updated by Rich Lil Nigg", fkg, j + 138, k + 44);
