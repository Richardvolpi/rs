    ...
    implements ImageProducer, ImageObserver
{
    ...
    public void drawGame(Graphics g, int i, int k)
    {
        cag();
    ...
    public static int createRGB(int i, int k, int l)
    {
        return (i << 16) + (k << 8) + l;
    }
...
label3:
    ...
    public void drawBoxTextRight(String s, int i, int k, int l, int i1)
    {
        drawBoxText(s, i - textWidth(s, l), k, l, i1);
    }

    public void drawText(String s, int i, int k, int l, int i1)
    {
        drawBoxText(s, i - textWidth(s, l) / 2, k, l, i1);
    }
    ...
    public void drawBoxText(String arg0, int arg1, int arg2, int arg3, int arg4)
    {
        try
        {
            byte abyte0[] = bnd[arg3];
