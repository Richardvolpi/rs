...
public class h
{
    ...
    {
        return j.createRGB((gdj * i) / 114, (gdk * k) / 114, (gdl * l) / 176);
    }
    ...
    public boolean buttonHandleDown(int i)
    {
        if(gam[i] && gbb[i])
        {
            gbb[i] = false;
    ...
    protected void gee(int arg0, int arg1, int arg2, int arg3, int arg4)
    {
        ...
        gaj.drawLine(arg1, arg2, arg3, gdc);
        gaj.cbd(arg1, arg2, arg4, gdc);
        gaj.drawLine(arg1, (arg2 + arg4) - 1, arg3, gdf);
        gaj.cbd((arg1 + arg3) - 1, arg2, arg4, gdf);
        if(gbe[arg0] == 1)
        {
            for(int i = 0; i < arg4; i++)
            {
                gaj.drawLine(arg1 + i, arg2 + i, 1, 0);
                gaj.drawLine((arg1 + arg3) - 1 - i, arg2 + i, 1, 0);
            }
    ...
    protected void geg(int arg0, int arg1, int arg2, String arg3, int arg4)
    {
        ...
        if(gbg[arg0])
            ...
            i = 0;
        gaj.drawBoxText(arg3, arg1, arg2, arg4, i);
    }
    ...
    public void gei(int arg0, int arg1, int arg2, int arg3)
    {
        ...
        gaj.drawLine(arg0, arg1, arg2, gdc);
        gaj.drawLine(arg0 + 1, arg1 + 1, arg2 - 2, gdc);
        gaj.drawLine(arg0 + 2, arg1 + 2, arg2 - 4, gdd);
        gaj.cbd(arg0, arg1, arg3, gdc);
        gaj.cbd(arg0 + 1, arg1 + 1, arg3 - 2, gdc);
        gaj.cbd(arg0 + 2, arg1 + 2, arg3 - 4, gdd);
        gaj.drawLine(arg0, (arg1 + arg3) - 1, arg2, gdf);
        gaj.drawLine(arg0 + 1, (arg1 + arg3) - 2, arg2 - 2, gdf);
        gaj.drawLine(arg0 + 2, (arg1 + arg3) - 3, arg2 - 4, gde);
    ...
    protected void gen(int i, int k, int l, int i1, int j1, int k1)
    {
        ...
        gaj.drawLine(l1, k + 13, 12, 0);
        gaj.drawLine(l1, (k + i1) - 13, 12, 0);
        ...
        for(int k1 = 0; k1 < k; k1++)
        {
            ...
            if(gbe[arg0] == k1)
                if(gbg[arg0])
                    ...
                    l1 = 0xc00000;
            gaj.drawBoxText(arg4[k1], i1, j1, arg3, l1);
        ...
        for(int l = 0; l < i; l++)
        {
            ...
            if(gbe[arg0] == l)
                if(gbg[arg0])
                    ...
                    i1 = 0xc00000;
            gaj.drawBoxText(arg4[l], arg1 - j1 / 2, k, arg3, i1);
            k += gaj.ced(arg3);
        }
            ...
            int arg7, int arg8)
    {
        ...
        for(int l1 = arg8; l1 < arg7; l1++)
        {
            ...
            if(gbe[arg0] == l1 && gdg)
                j2 = 0xff0000;
            gaj.drawBoxText(arg6[l1], arg1 + 2, j1, arg5, j2);
            j1 += gaj.ced(arg5);
            if(j1 >= arg2 + arg4)
                return;
        }
    ...
    public int drawMenuText(int i, int k, String s, int l, boolean flag)
    {
        gbj[gak] = 1;
        gam[gak] = true;
        gbb[gak] = false;
    ...
    public int drawMenuButton(int i, int k, int l, int i1)
    {
        gbj[gak] = 2;
        gam[gak] = true;
        gbb[gak] = false;
    ...
    public int createTextHandle(int i, int k, int l, int i1, int j1, int k1, boolean flag, 
            boolean flag1)
    {
        gbj[gak] = 6;
        gam[gak] = true;
    ...
    public int createButtonHandle(int i, int k, int l, int i1)
    {
        gbj[gak] = 10;
        gam[gak] = true;
        gbb[gak] = false;
