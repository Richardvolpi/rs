    ...
    implements Runnable
{
    ...
    private final void flh()
    {
        ...
        } else
        {
            ...
            fjg = Toolkit.getDefaultToolkit().createImage("Data/3rxbot.jag");
            j.cdi("h11p", 0, this);
            j.cdi("h12b", 1, this);
            j.cdi("h12p", 2, this);
            j.cdi("h13b", 3, this);
    ...
    protected final void flj(int i, String s)
    {
        try
        {
			String t = String.valueOf(((xi * 100) / 13));
			if(t.length() < 3)
				t = (t.length() == 2 ? "0" : "00") + t;
			s = "Loading: " + t + "%";
            int k = (fia - 281) / 2;
            ...
            int i1 = (277 * i) / 100;
            fjh.drawImage(fjg, 0, 0, this);
            fjh.setColor(new Color(200, 200, 200));
            if(fja)
                fjh.setColor(new Color(40, 40, 255));
    ...
    protected byte[] fcb(String arg0, String arg1, int arg2)
    {
        ...
        if(System.currentTimeMillis() - drawTimer >= 3000)
        {
        	fjh.drawImage(fjg, 0, 0, this);
    ...
    public a()
    {
        ...
        fja = false;
        fjc = "Loading";
        fjd = new Font("Tahoma", 0, 12);
        fje = new Font("Tahoma", 1, 13);
        fjf = new Font("Tahoma", 0, 12);
        fjj = false;
        fjk = false;
        fjl = false;
        fjm = false;
