...
public class Class10 {
    ...
    public void method268(Class5 class5) {
        if(class5 == null)
    ...
    public void method271() {
        anInt425 = 0;
        aClass5_433.method176();
    }

    public void method272(int i) {
        anInt425 -= i;
        aClass5_433.method177(i, i * 2);
        if(anInt425 < 0)
            anInt425 = 0;
    }

    public int method273(int i, int j, int k, int l, int i1, int j1, int k1) {
        ...
        int l1 = aClass5_433.method180(j, k, l);
        int i2 = aClass5_433.method180(j, k - j1, l);
        int ai[] = {
            l1, i2
        };
        aClass5_433.method181(2, ai, 0, 0);
    ...
    public Class5[] method279() {
        return aClass5Array404;
    }

    public void method280(int i, int j, int k, int l, int i1, int j1) {
        anInt407 = k;
        anInt408 = l;
        anInt409 = i;
        anInt410 = j;
    ...
    public void method281(Class7 aclass7[], int i, int j) {
        if(i < j) {
            int k = i - 1;
            int l = j + 1;
            int i1 = (i + j) / 2;
    ...
    public void method282(int i, Class7 aclass7[], int j) {
        for(int k = 0; k <= j; k++) {
        ...
        do {
            ...
            for(int k1 = j1; k1 >= i1 + 1; k1--) {
                ...
                if(class7.anInt353 < class7_1.anInt355 && class7_1.anInt353 < class7.anInt355 && class7.anInt354 < class7_1.anInt356 && class7_1.anInt354 < class7.anInt356 && class7.anInt368 != class7_1.anInt369 && !method300(class7, class7_1) && method301(class7_1, class7)) {
    ...
    public boolean method283(Class7 aclass7[], int i, int j) {
        do {
    ...
    public void method285() {
        ...
        anInt462 = 0;
        anInt463 = 0;
        method284(-i3, -j3, anInt390);
        method284(-i3, j3, anInt390);
        method284(i3, -j3, anInt390);
        method284(i3, j3, anInt390);
        method284(-anInt407, -anInt408, 0);
        method284(-anInt407, anInt408, 0);
        method284(anInt407, -anInt408, 0);
        method284(anInt407, anInt408, 0);
        anInt458 += anInt413;
        ...
        for(int i = 0; i < anInt419; i++)
            aClass5Array421[i].method201(anInt413, anInt414, anInt415, anInt416, anInt417, anInt418, anInt411, anInt389);

        aClass5Array421[anInt419].method201(anInt413, anInt414, anInt415, anInt416, anInt417, anInt418, anInt411, anInt389);
        anInt423 = 0;
        ...
        if(anInt423 == 0)
            return;
        anInt388 = anInt423;
        method281(aClass7Array424, 0, anInt423 - 1);
        method282(100, aClass7Array424, anInt423);
        for(int i4 = 0; i4 < anInt423; i4++) {
            ...
            if(class5_2 == aClass5_433) {
                ...
                aClass6_446.method245(l11 + anInt409, j12, i10, k10, anIntArray426[l], j11, (256 << anInt411) / j9);
                ...
                method286(0, 0, 0, 0, k8, anIntArray451, anIntArray452, anIntArray453, class5_2, l);
                if(anInt450 > anInt449)
                    method287(0, 0, l10, anIntArray454, anIntArray455, anIntArray456, class7.anInt366, class5_2);
            }
        }
    ...
    public void method286(int i, int j, int k, int l, int i1, int ai[], int ai1[], 
    ...
    public void method287(int i, int j, int k, int ai[], int ai1[], int ai2[], int l, 
            Class5 class5) {
        if(l == -2)
            return;
        if(l >= 0) {
            ...
            if(anIntArray437[l] == 1) {
                ...
                if(class5.aBoolean255) {
                    for(i = anInt449; i < anInt450; i += byte1) {
                        ...
                        if(k20 <= 0) {
                            ...
                            method289(anIntArray447, anIntArrayArray439[l], 0, 0, l9 + k14 * j, k11 + i15 * j, i13 + k15 * j, k10, i12, k13, k20, i17 + j, i22, k23 << 2);
                            l9 += i11;
                            k11 += k12;
                            i13 += i14;
                            i17 += k16;
                ...
                if(!aBooleanArray440[l]) {
                    for(i = anInt449; i < anInt450; i += byte1) {
                        ...
                        if(l20 <= 0) {
                            ...
                            method288(anIntArray447, anIntArrayArray439[l], 0, 0, l9 + k14 * j, k11 + i15 * j, i13 + k15 * j, k10, i12, k13, l20, i17 + j, j22, l23 << 2);
                            l9 += i11;
                            k11 += k12;
                            i13 += i14;
                            i17 += k16;
                ...
                for(i = anInt449; i < anInt450; i += byte1) {
                    ...
                    if(i21 <= 0) {
                        ...
                        method290(anIntArray447, 0, 0, 0, anIntArrayArray439[l], l9 + k14 * j, k11 + i15 * j, i13 + k15 * j, k10, i12, k13, i21, i17 + j, k22, i24);
                        l9 += i11;
                        k11 += k12;
                        i13 += i14;
                        i17 += k16;
            ...
            if(class5.aBoolean255) {
                for(i = anInt449; i < anInt450; i += byte2) {
                    ...
                    if(j21 <= 0) {
                        ...
                        method292(anIntArray447, anIntArrayArray439[l], 0, 0, i10 + l14 * j, l11 + j15 * j, j13 + l15 * j, l10, j12, l13, j21, j17 + j, l22, j24);
                        i10 += j11;
                        l11 += l12;
                        j13 += j14;
                        j17 += l16;
            ...
            if(!aBooleanArray440[l]) {
                for(i = anInt449; i < anInt450; i += byte2) {
                    ...
                    if(k21 <= 0) {
                        ...
                        method291(anIntArray447, anIntArrayArray439[l], 0, 0, i10 + l14 * j, l11 + j15 * j, j13 + l15 * j, l10, j12, l13, k21, j17 + j, i23, k24);
                        i10 += j11;
                        l11 += l12;
                        j13 += j14;
                        j17 += l16;
        ...
        if(aBoolean396) {
            for(i = anInt449; i < anInt450; i += byte0) {
                ...
                if(l6 <= 0) {
                    ...
                    method294(anIntArray447, -l6, l2 + j, 0, anIntArray387, i8, j9);
                    l2 += i2;
                }
            }
    ...
    public static void method288(int ai[], int ai1[], int i, int j, int k, int l, int i1, int j1, 
    ...
    public static void method290(int ai[], int i, int j, int k, int ai1[], int l, int i1, int j1, 
    ...
    public static void method291(int ai[], int ai1[], int i, int j, int k, int l, int i1, int j1, 
            int k1, int l1, int i2, int j2, int k2, int l2) {
        if(i2 <= 0)
            return;
        int i3 = 0;
    ...
    public static void method293(int ai[], int i, int j, int k, int ai1[], int l, int i1, int j1, 
            int k1, int l1, int i2, int j2, int k2, int l2, int i3) {
        if(j2 <= 0)
            return;
        int j3 = 0;
    ...
    public boolean method300(Class7 class7, Class7 class7_1) {
    ...
    public void method308(int i, int j, int k) {
        ...
        for(int l = 0; l < anInt419; l++)
            aClass5Array421[l].method186(i, j, k);
    ...
    public void method309(int i, int j, int k, int l, int i1) {
        ...
        for(int j1 = 0; j1 < anInt419; j1++)
            aClass5Array421[j1].method185(i, j, k, l, i1);
    ...
    public Class6 aClass6_446;
    public int anIntArray447[];
    public Class9 aClass9Array448[];
    public int anInt449;
    public int anInt450;
