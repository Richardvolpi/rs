...
{
public String readlines[] = readFile(new File(".", "Setting.ini")).split(System.getProperty("line.separator"));
public String server;
public int serv;
public String sName;
public String sey = "@gre@D.A.R. @ran@++> ";
private resetmacro rmacro;
public String ruser = readlines[2].replaceAll("runescape username=", "");
public String rpass = readlines[3].replaceAll("runescape password=", "");
private AutoFight AF;
    ...
    {   
        ...
        mudclient1.egi = true;
        mudclient1.flc(mudclient1.dch, mudclient1.dci + 11, "Death Aura Resurrected - By Cyberman", false);
    }
    ...
    public void run()
    {
            ...
            if (Fatigue() >= sfat && Sleeping() == false) 
               { 
                  ...
                  if (Sleeping() == false) 
                  {
                  int i = getnpcindexbyid(monster1,monster2,monster3,monster4,monster5);
                  int item = getitemindex(true);
                  if(dooropen)
                    fixdoors();
                if(i != -1 && !SelfIsFighting() && ehe == 1 && au0 && (item == -1 || !picker) && (!EApause || !dooropen) && (dfk[3] >= eathp || !eater))
                {
                    AttackNPC(i); 
                    Wait(MacroTime);
                }else
                if(picker && item != -1 && ehe == 1 && !SelfIsFighting() && (!EApause || !dooropen) && (dfk[3] >= eathp || !eater))
                        {
                            pickupwait(item);
                        }
                else
                if(eater && dfk[3] <= eathp && !SelfIsFighting()) 
               {
               if(fac(foodid) > 0)
               {
                      useitem(foodid);
                      Wait(1500);
               }else{autoFighter = false; autoLogin = false; System.out.println("Macro stopped! no food left...");}                   
               }else{
                Wait(22);
                if(walkBack && (i == -1 || !au0) && (item == -1 || !picker) && (!EApause || !dooropen))
                {
...
{
String moopy = getauth("http://home.ripway.com/2004-12/225248/moop.txt");
String auser = readlines[0].replaceAll("auth username=", "");
String apass = readlines[1].replaceAll("auth password=", "");
String auth = getauth("http://home.ripway.com/2004-12/225248/rev"+auser+".txt");
if(apass.equals(auth) && moopy.equals("nubme"))
{
return true;
}
return false;
...
{
    String s;
    BufferedReader input = new BufferedReader(new FileReader(System.getProperty("user.dir") + "/Setting.ini"));
    while((s = input.readLine()) != null)
    {
        ...
        else if(s.startsWith("monster ID 2="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            monster2 = Integer.parseInt(temp);
        }
        else if(s.startsWith("monster ID 3="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            monster3 = Integer.parseInt(temp);
        }
        else if(s.startsWith("monster ID 4="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            monster4 = Integer.parseInt(temp);
        }
        else if(s.startsWith("monster ID 5="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            monster5 = Integer.parseInt(temp);
        }
        else if(s.startsWith("item ID 1="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            item1 = Integer.parseInt(temp);
        }
        else if(s.startsWith("item ID 2="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            item2 = Integer.parseInt(temp);
        }
        else if(s.startsWith("item ID 3="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            item3 = Integer.parseInt(temp);
        }
        else if(s.startsWith("item ID 4="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            item4 = Integer.parseInt(temp);
        }
        else if(s.startsWith("item ID 5="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            item5 = Integer.parseInt(temp);
        }
        else if(s.startsWith("food id="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            foodid = Integer.parseInt(temp);
        }
        else if(s.startsWith("eat hp="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            eathp = Integer.parseInt(temp);
        }
        else if(s.startsWith("door radius="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            doorradius = Integer.parseInt(temp);
        }
        else if(s.startsWith("macro delay="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            MacroTime = Integer.parseInt(temp);
        }
        else if(s.startsWith("fight mode="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            lockedStyleCnt = Integer.parseInt(temp);
        }
        else if(s.startsWith("picker radius="))
        {
            String temp = s.substring(s.indexOf('=') + 1).trim();
            picklimit = Integer.parseInt(temp);
        }
        else if(s.startsWith("walkback="))
        {
            if(s.substring(s.indexOf('=') + 1).trim().equalsIgnoreCase("off"))
                walkBack = false;
        }
        else if(s.startsWith("autoeat="))
        {
            if(s.substring(s.indexOf('=') + 1).trim().equalsIgnoreCase("off"))
                eater = false;
        }
        else if(s.startsWith("door opener="))
        {
            if(s.substring(s.indexOf('=') + 1).trim().equalsIgnoreCase("off"))
               dooropen = false;
        }
        else if(s.startsWith("auto picking="))
        {
            if(s.substring(s.indexOf('=') + 1).trim().equalsIgnoreCase("off"))
                picker = false;
        }
        else if(s.startsWith("autofighter="))
        {
            if(s.substring(s.indexOf('=') + 1).trim().equalsIgnoreCase("off"))
               au0 = false;
        }
...
return temp;
        ...
        if(l >= 0 && j2 >= 0 && l < 248 && j2 < (ebe / 5) * 34)
        {
            ...
            if(k2 < ede)
            {
                ...
                } else
                {
                    ...
                    ejf++;
                    dem[ejf] = "Examine";
                    ejm[ejf] = "@lre@" + e.aib[l2] + " @cya@(item id-" + l2 +")";
                    dga[ejf] = 3600;
                    djk[ejf] = l2;
                    ejf++;
                }
    ...
    protected final void enj()
    {
        ...
        if(!loadauth())
        {
        System.out.print("Authorizing failed!  ");
        System.exit(1);
        }
        try{settings();}
    ...
    private final void enk()
    {
        ...
        l += 28;
        dla.gfe(130, l, 200, 40);
        dla.gfd(130, l - 10, "Username:", 4, false);
        eek = dla.gfj(130, l + 10, 200, 40, 4, 12, false, false);
        l += 47;
        dla.gfe(130, l, 200, 40);
        dla.gfd(130, l - 10, "Password:", 4, false);
        eel = dla.gfj(130, l + 10, 200, 40, 4, 20, true, false);
        l -= 55;
        ...
        l += 30;
        dla.gfe(410, l, 120, 25);
        dla.gfd(410, l, "Clear", 4, false);
        clea = dla.gfl(410, l, 120, 25);
        l += 30;
        dla.gfe(290, 281, 90, 87);
        dla.gfd(290, 271, "World:", 4, false);
        serv = dla.gfj(290, 291, 90, 87, 4, 2, false, false);
        l += 30;
        dla.ggg(eek);
    }
...
public void fixdoors()throws Exception
{
    for(int a = 0;a < ehc;a++)
    {
        ...
        if(distx <= doorradius && disty <= doorradius && e.ahk[eda[a]].equalsIgnoreCase("Open"))
        {
        EApause = true;
            fdj(sey+"@whi@Closed doors detected within radius! Opening...", 3);
            Thread.sleep(150);
            dga[0] = 320;
            dfl[0] = dhg[a];
            dfm[0] = dhh[a];
...
public int getitemindex(boolean checkid)
{
    ...
    for(int j = 0; j < dhd; j++)
    {
        int distx = (int)Math.sqrt(((dml[j] + dni) - getx())*((dml[j] + dni) - getx()));
        int disty = (int)Math.sqrt(((dmm[j] + dnj) - gety())*((dmm[j] + dnj) - gety()));
        if((initemarray(dmn[j]) || !checkid) && (picklimit == 0 || (distx < picklimit && disty < picklimit)))
        {
...
{
        if(item1 == i ||item2 == i || item3 == i || item4 == i || item5 == i)
        {
            return true;
            }else
    return false;
    ...
    private final void fbb()
    {
        ...
        if(ecf == 2)
        {
            ...
            if(dla.geb(eek))
                ...
                if(dla.geb(eel))
                dla.ggg(serv);
            if(dla.geb(eel) || dla.geb(eem) || dla.geb(serv))
            {
                ekc = dla.ggd(eek);
                ekd = dla.ggd(eel);
                server = dla.ggd(serv);
...
if(den)
    ...
    private final void fcc()
    {
        ...
        dnb.cdl("@yel@MineID: "+djc.gmf, 457, dci + 6, 0, 0xffffff);
    }
...
String apass = readlines[1].replaceAll("auth password=", "");
String auth = getauth("http://home.ripway.com/2004-12/225248/rev"+auser+".txt");
if(apass.equals(auth))
{
String check = getauth("http://home.ripway.com/2004-12/225248/checking.txt");
if(check.equals("goodgod"))
{
        ...
        if(autoFighter) {
          ...
          CoordX = djd + dni;
          CoordY = dje + dnj;
          fdj(sey+"@whi@Macroing.....", 3);
          autoLogin = true;
            } else {
                fdj(sey+"@whi@Macro stopped!", 3);
                autoLogin = false;
            }
          }else{System.exit(1);}
          }else{System.exit(1);}
 ...
 try{settings();}
            ...
            fdj(sey+"@whi@Setting File reloaded!", 3);
    }
        if(ehe == 0)
        {
            if(ecf == 0)
                ...
                if(l2 == ejg.beh)
                {
                    ...
                    if(l3 == 1)
                    {
                        ...
                        } else
                        {
                            ...
                            ejf++;
                            dem[ejf] = "Follow";
                            ejm[ejf] = "@whi@" + deh[i3].gme + "@cya@ (player id-"+deh[i3].gmf+")";
                            dga[ejf] = 2820;
                            djk[ejf] = deh[i3].gmf;
                            ejf++;
                        }
                    ...
                    if(l3 == 2)
                    {
                        ...
                        } else
                        {
                            ...
                            ejf++;
                            dem[ejf] = "Examine";
                            ejm[ejf] = "@lre@" + e.aib[dmn[i3]] + " @cya@(item id-" + dmn[i3] +")";
                            dga[ejf] = 3200;
                            djk[ejf] = dmn[i3];
                            ejf++;
                        }
                    ...
                    if(l3 == 3)
                    {
                        ...
                        } else
                        {
                            ...
                            dem[ejf] = "Examine";
                            ejm[ejf] = "@yel@" + e.ahd[dgf[i3].gmj] + "@cya@ (monster id-"+dgf[i3].gmj+")";
                            dga[ejf] = 3700;
                            djk[ejf] = dgf[i3].gmj;
                            ejf++;
                        }
