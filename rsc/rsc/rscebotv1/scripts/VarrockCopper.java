import bot.*;
public class VarrockCopper extends Methods {
	long startTime;
	int oresMined, misses;
	
	public VarrockCopper(Client mc) {super(mc);}
	public void main(String args[]) {
		startTime = System.currentTimeMillis();
		printMessage("@or2@Miner: @yel@Varrock copper miner started");
		while(running()) {
			// do the mining
