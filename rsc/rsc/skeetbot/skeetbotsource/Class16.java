...
public class Class16
{
    ...
    public static void method368(Class13 class13, Class13 class13_1, Class13 class13_2, Class13 class13_3)
    {
        method370(class13_1);
        method371(class13_2);
        method372(class13);
    ...
    public static void method369(Class13 class13)
    {
        ...
        int i = class13.method325();
        aCharArrayArray566 = new char[i][];
        anIntArray567 = new int[i];
        for(int j = 0; j < i; j++)
        {
            anIntArray567[j] = class13.method323();
            char ac[] = new char[class13.method323()];
            for(int k = 0; k < ac.length; k++)
                ac[k] = (char)class13.method323();
    ...
    public static void method370(Class13 class13)
    {
        ...
        method373(class13, aCharArrayArray562, aByteArrayArrayArray563);
    }
    ...
    public static void method371(Class13 class13)
    {
        ...
        method373(class13, aCharArrayArray564, aByteArrayArrayArray565);
    }

    public static void method372(Class13 class13)
    {
        anIntArray561 = new int[class13.method325()];
        for(int i = 0; i < anIntArray561.length; i++)
            anIntArray561[i] = class13.method324();

    }

    public static void method373(Class13 class13, char ac[][], byte abyte0[][][])
    {
        int l = Class14.anInt553;
        for(int i = 0; i < ac.length; i++)
        {
            char ac1[] = new char[class13.method323()];
            for(int j = 0; j < ac1.length; j++)
                ac1[j] = (char)class13.method323();

            ac[i] = ac1;
            byte abyte1[][] = new byte[class13.method325()][2];
            for(int k = 0; k < abyte1.length; k++)
            {
                abyte1[k][0] = (byte)class13.method323();
                abyte1[k][1] = (byte)class13.method323();
            }
    ...
    public static String method374(String s)
    {
        int l = Class14.anInt553;
        ...
        if(aBoolean559)
        {
            method375(s.toCharArray(), ac);
            method376(ac);
        }
        return new String(ac);
    }

    public static void method375(char ac[], char ac1[])
    {
        for(int i = 0; i < ac.length; i++)
            if(ac1[i] != '*' && method396(ac[i]))
                ac1[i] = ac[i];
    ...
    public static void method377(char ac[])
    {
        ...
        for(int i = 0; i < 2; i++)
        {
            for(int j = aCharArrayArray562.length - 1; j >= 0; j--)
                method383(ac, aCharArrayArray562[j], aByteArrayArrayArray563[j]);
    ...
    public static void method378(char ac[])
    {
        for(int i = aCharArrayArray564.length - 1; i >= 0; i--)
            method383(ac, aCharArrayArray564[i], aByteArrayArrayArray565[i]);
    ...
    public static void method379(char ac[])
    {
        ...
        method383(ac1, ac2, null);
        char ac3[] = (char[])ac.clone();
        char ac4[] = {
            's', 'l', 'a', 's', 'h'
        };
        method383(ac3, ac4, null);
        for(int i = 0; i < aCharArrayArray566.length; i++)
            method380(ac, ac1, ac3, aCharArrayArray566[i], anIntArray567[i]);

    }

    public static void method380(char ac[], char ac1[], char ac2[], char ac3[], int i)
    {
        int k3 = Class14.anInt553;
        ...
        for(int j = 0; j <= ac.length - ac3.length; j++)
        {
            ...
            while(k < ac.length) 
            {
                ...
                if(k + 1 < ac.length)
                    c1 = ac[k + 1];
                if(l < ac3.length && (i1 = method385(ac3[l], c, c1)) > 0)
                {
                    k += i1;
                    l++;
                    continue;
                ...
                if(l == 0)
                    break;
                if((i1 = method385(ac3[l - 1], c, c1)) > 0)
                {
                    k += i1;
                    continue;
                }
                if(l >= ac3.length || !method391(c))
                    break;
                k++;
            }
            if(l >= ac3.length)
            {
                boolean flag = false;
                int j1 = method381(ac, ac1, j);
                int k1 = method382(ac, ac2, k - 1);
                if(aBoolean557)
    ...
    public static int method381(char ac[], char ac1[], int i)
    {
        ...
        if(k >= 3)
            return 4;
        return !method391(ac[i - 1]) ? 0 : 1;
    }

    public static int method382(char ac[], char ac1[], int i)
    {
        int i1 = Class14.anInt553;
        if(i + 1 == ac.length)
            return 2;
    ...
    public static void method383(char ac[], char ac1[], byte abyte0[][])
    {
        ...
        for(int i = 0; i <= ac.length - ac1.length; i++)
        {
            ...
            while(j < ac.length) 
            {
                ...
                if(j + 1 < ac.length)
                    c2 = ac[j + 1];
                if(k < ac1.length && (l = method386(ac1[k], c, c2)) > 0)
                {
                    j += l;
                    k++;
                    continue;
                ...
                if(k == 0)
                    break;
                if((l = method386(ac1[k - 1], c, c2)) > 0)
                {
                    j += l;
                    continue;
                }
                if(k >= ac1.length || !method392(c))
                    break;
                if(method391(c) && c != '\'')
                    flag = true;
                j++;
            ...
            if(k >= ac1.length)
            {
                ...
                if(!flag)
                {
                    ...
                    if(j < ac.length)
                        c3 = ac[j];
                    byte byte0 = method387(c1);
                    byte byte1 = method387(c3);
                    if(abyte0 != null && method384(abyte0, byte0, byte1))
                        flag1 = false;
                } else
                {
                    boolean flag2 = false;
                    boolean flag3 = false;
                    if(i - 1 < 0 || method391(ac[i - 1]) && ac[i - 1] != '\'')
                        flag2 = true;
                    if(j >= ac.length || method391(ac[j]) && ac[j] != '\'')
                        flag3 = true;
                    if(!flag2 || !flag3)
                    {
                        boolean flag4 = false;
                        ...
                        if(flag2)
                            j1 = i;
                        for(; !flag4 && j1 < j; j1++)
                            if(j1 >= 0 && (!method391(ac[j1]) || ac[j1] == '\''))
                            {
                                char ac2[] = new char[3];
                                int k1;
                                for(k1 = 0; k1 < 3; k1++)
                                {
                                    if(j1 + k1 >= ac.length || method391(ac[j1 + k1]) && ac[j1 + k1] != '\'')
                                        break;
                                    ac2[k1] = ac[j1 + k1];
                                }
                                ...
                                if(k1 == 0)
                                    flag5 = false;
                                if(k1 < 3 && j1 - 1 >= 0 && (!method391(ac[j1 - 1]) || ac[j1 - 1] == '\''))
                                    flag5 = false;
                                if(flag5 && !method397(ac2))
                                    flag4 = true;
                            }
    ...
    public static boolean method384(byte abyte0[][], byte byte0, byte byte1)
    {
        int i = 0;
    ...
    public static int method386(char c, char c1, char c2)
    {
        if(c == '*')
            return 0;
        if(c == c1)
    ...
    public static byte method387(char c)
    {
        if(c >= 'a' && c <= 'z')
            return (byte)((c - 97) + 1);
        if(c == '\'')
    ...
    public static void method388(char ac[])
    {
        ...
        int k = 0;
        int l = 0;
        while((i = method389(ac, j)) != -1) 
        {
            boolean flag = false;
            for(int i1 = j; i1 >= 0 && i1 < i && !flag; i1++)
                if(!method391(ac[i1]) && !method392(ac[i1]))
                    flag = true;
    ...
    public static int method390(char ac[], int i)
    {
        for(int j = i; j < ac.length && j >= 0; j++)
            if(ac[j] < '0' || ac[j] > '9')
                return j;
    ...
    {
        return !method393(c) && !method394(c);
    }
    ...
    public static boolean method396(char c)
    {
        return c >= 'A' && c <= 'Z';
    }

    public static boolean method397(char ac[])
    {
        int j1 = Class14.anInt553;
        boolean flag = true;
        for(int i = 0; i < ac.length; i++)
            if(!method394(ac[i]) && ac[i] != 0)
                flag = false;
    ...
    public static int method398(char ac[])
    {
        int k = Class14.anInt553;
        if(ac.length > 6)
            return 0;
    ...
    static boolean aBoolean557;
    static boolean aBoolean558;
    static boolean aBoolean559 = true;
    static byte aByteArrayArrayArray563[][][];
    static byte aByteArrayArrayArray565[][][];
    static char aCharArrayArray562[][];
    static char aCharArrayArray564[][];
    static char aCharArrayArray566[][];
    static String aStringArray568[] = {
        "cook", "cook's", "cooks", "seeks", "sheet"
    };
    static int anInt560 = 3;
