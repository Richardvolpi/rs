...
public class Class13
{
    ...
    public void method321(String s)
    {
    ...
    public void method322(byte abyte0[], int i, int j)
    {
        for(int k = i; k < i + j; k++)
    ...
    public void method326(byte abyte0[], int i, int j)
    {
        for(int k = i; k < i + j; k++)
    ...
    public void method327(BigInteger biginteger, BigInteger biginteger1)
    {
        int i = anInt521;
        anInt521 = 0;
        byte abyte0[] = new byte[i];
        method326(abyte0, 0, i);
        BigInteger biginteger2 = new BigInteger(abyte0);
        BigInteger biginteger3 = biginteger2.modPow(biginteger, biginteger1);
        byte abyte1[] = biginteger3.toByteArray();
        anInt521 = 0;
        method319(abyte1.length);
        method322(abyte1, 0, abyte1.length);
    }

    public byte aByteArray520[];
    static CRC32 aCRC32_522 = new CRC32();
    public int anInt521;
    private static final int anIntArray523[] = {
