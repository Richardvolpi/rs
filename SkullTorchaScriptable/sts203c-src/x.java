...
public class x {
    ...
    public void gjf(int arg0, int arg1, int arg2, int arg3) {
        ...
        try {
            if (gii != null) {
                byte abyte0[] = t.Extract(s + ".hei", 0, gii);

                if (abyte0 == null && gib != null) {
                    abyte0 = t.Extract(s + ".hei", 0, gib);
                }
                ...
                abyte0 = t.Extract(s + ".dat", 0, gij);
                if (abyte0 == null && gic != null) {
                    abyte0 = t.Extract(s + ".dat", 0, gic);
                }
                if (abyte0 == null || abyte0.length == 0) {
    ...
    public int gkb(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6[], int arg7[], boolean arg8) // BOLLOCKS
    {
        for (int k = 0; k < 96; k++) {
            for (int l = 0; l < 96; l++) {
                ghh[k][l] = 0;
        ...
        while (j1 != i1) {
            ...
            if (arg8) {
                ...
                if (k1 < 95 && k1 + 1 >= arg2 && k1 + 1 <= arg4 && l1 >= arg3 && l1 <= arg5
                        && (ghb[k1 + 1][l1] & 2) == 0) {
                    flag = true;
                    break;
                }
                ...
                if (l1 < 95 && k1 >= arg2 && k1 <= arg4 && l1 + 1 >= arg3 && l1 + 1 <= arg5
                        && (ghb[k1][l1 + 1] & 1) == 0) {
                    flag = true;
                    break;
                }
            ...
            if (k1 > 0 && l1 > 0 && (ghb[k1][l1 - 1] & 0x74) == 0 && (ghb[k1 - 1][l1] & 0x78) == 0
                    && (ghb[k1 - 1][l1 - 1] & 0x7c) == 0 && ghh[k1 - 1][l1 - 1] == 0) {
                arg6[i1] = k1 - 1;
                arg7[i1] = l1 - 1;
                i1 = (i1 + 1) % i2;
                ghh[k1 - 1][l1 - 1] = 3;
            }
            if (k1 < 95 && l1 > 0 && (ghb[k1][l1 - 1] & 0x74) == 0 && (ghb[k1 + 1][l1] & 0x72) == 0
                    && (ghb[k1 + 1][l1 - 1] & 0x76) == 0 && ghh[k1 + 1][l1 - 1] == 0) {
                arg6[i1] = k1 + 1;
                arg7[i1] = l1 - 1;
                i1 = (i1 + 1) % i2;
                ghh[k1 + 1][l1 - 1] = 9;
            }
            if (k1 > 0 && l1 < 95 && (ghb[k1][l1 + 1] & 0x71) == 0 && (ghb[k1 - 1][l1] & 0x78) == 0
                    && (ghb[k1 - 1][l1 + 1] & 0x79) == 0 && ghh[k1 - 1][l1 + 1] == 0) {
                arg6[i1] = k1 - 1;
                arg7[i1] = l1 + 1;
                i1 = (i1 + 1) % i2;
                ghh[k1 - 1][l1 + 1] = 6;
            }
            if (k1 < 95 && l1 < 95 && (ghb[k1][l1 + 1] & 0x71) == 0 && (ghb[k1 + 1][l1] & 0x72) == 0
                    && (ghb[k1 + 1][l1 + 1] & 0x73) == 0 && ghh[k1 + 1][l1 + 1] == 0) {
                arg6[i1] = k1 + 1;
                arg7[i1] = l1 + 1;
                i1 = (i1 + 1) % i2;
                ghh[k1 + 1][l1 + 1] = 12;
                        ...
                        if (l5 == 5) {
                            if (gkn(j3, j4) > 0 && gkn(j3, j4) < 24000) {
                                if (gjm(j3 - 1, j4, arg2, k12) != 0xbc614e && gjm(j3, j4 - 1, arg2, k12) != 0xbc614e) {
                                    ...
                                    l14 = 0;
                                } else if (gjm(j3 + 1, j4, arg2, k12) != 0xbc614e
                                        && gjm(j3, j4 + 1, arg2, k12) != 0xbc614e) {
    ...
    public void glc(int arg0, int arg1, int arg2, int arg3) {
        ...
        for (int k = arg0; k <= arg0 + arg2; k++) {
            for (int l = arg1; l <= arg1 + arg3; l++) {
                if ((gjl(k, l) & 0x63) != 0 || (gjl(k - 1, l) & 0x59) != 0 || (gjl(k, l - 1) & 0x56) != 0
                        || (gjl(k - 1, l - 1) & 0x6c) != 0) {
                    gkk(k, l, 35);
                } else {
                    gkk(k, l, 0);
