public class h {
    ...
    public int gdn(int i, int k, int l) {
        return j.ToHex((gdj * i) / 114, (gdk * k) / 114, (gdl * l) / 176);
    }

    public void gea(int arg0, int arg1, int arg2, int arg3) {
        gcc = arg0;
        gcd = arg1;
        gcf = arg3;
        if (arg2 != 0) {
        ...
        if (arg2 == 1) {
            for (int i = 0; i < gak; i++) {
                if (gam[i] && gbj[i] == 10 && gcc >= gbh[i] && gcd >= gbi[i] && gcc <= gbh[i] + gbk[i]
                        && gcd <= gbi[i] + gbl[i]) {
                    gbb[i] = true;
                }
                if (gam[i] && gbj[i] == 14 && gcc >= gbh[i] && gcd >= gbi[i] && gcc <= gbh[i] + gbk[i]
                        && gcd <= gbi[i] + gbl[i]) {
                    gbe[i] = 1 - gbe[i];
                }
            }
        ...
        if (arg2 == 1 || gch > 20) {
            for (int k = 0; k < gak; k++) {
                if (gam[k] && gbj[k] == 15 && gcc >= gbh[k] && gcd >= gbi[k] && gcc <= gbh[k] + gbk[k]
                        && gcd <= gbi[k] + gbl[k]) {
                    gbb[k] = true;
                }
            }
        ...
        for (int i = 0; i < gak; i++) {
            if (gam[i]) {
                if (gbj[i] == 0) {
                    ...
                    gef(i, gbh[i] - gaj.cef(gca[i], gbn[i]) / 2, gbi[i], gca[i], gbn[i]);
                } else if (gbj[i] == 2) {
    ...
    protected void gee(int arg0, int arg1, int arg2, int arg3, int arg4) {
        ...
        gaj.cbc(arg1, arg2, arg3, gdc);
        gaj.cbd(arg1, arg2, arg4, gdc);
        gaj.cbc(arg1, (arg2 + arg4) - 1, arg3, gdf);
        gaj.cbd((arg1 + arg3) - 1, arg2, arg4, gdf);
        if (gbe[arg0] == 1) {
            for (int i = 0; i < arg4; i++) {
                gaj.cbc(arg1 + i, arg2 + i, 1, 0);
                gaj.cbc((arg1 + arg3) - 1 - i, arg2 + i, 1, 0);
            }
        }
    }
    ...
    protected void geg(int arg0, int arg1, int arg2, String arg3, int arg4) {
        ...
        gaj.DrawStr(arg3, arg1, arg2, arg4, i);
    }
    ...
    protected void geh(int arg0, int arg1, int arg2, int arg3, int arg4, String arg5, int arg6) {
        ...
        if (gbj[arg0] == 5) {
            ...
            if (gce == 1 && gcc >= arg1 - arg3 / 2 && gcd >= arg2 - arg4 / 2 && gcc <= arg1 + arg3 / 2
                    && gcd <= arg2 + arg4 / 2) {
                gcg = arg0;
            }
            arg1 -= gaj.cef(arg5, arg6) / 2;
        }
        if (gcg == arg0) {
            arg5 = arg5 + "*";
        }
    ...
    public void gei(int arg0, int arg1, int arg2, int arg3) // Draw login boxes
    {
        int Colour1 = gdn(184, 43, 70);
        int Colour4 = gdn(188, 52, 86);
        int Colour3 = gdn(197, 62, 101);
        int Colour2 = gdn(235, 96, 129);
        gaj.cah(arg0, arg1, arg0 + arg2, arg1 + arg3);
        gaj.can(arg0, arg1, arg2, arg3, Colour1, Colour2);
        if (gdh) {
        ...
        gaj.cbc(arg0, arg1, arg2, Colour2);
        gaj.cbc(arg0 + 1, arg1 + 1, arg2 - 2, Colour2);
        gaj.cbc(arg0 + 2, arg1 + 2, arg2 - 4, Colour3);
        gaj.cbd(arg0, arg1, arg3, Colour2);
        gaj.cbd(arg0 + 1, arg1 + 1, arg3 - 2, Colour2);
        gaj.cbd(arg0 + 2, arg1 + 2, arg3 - 4, Colour3);
        gaj.cbc(arg0, (arg1 + arg3) - 1, arg2, Colour1);
        gaj.cbc(arg0 + 1, (arg1 + arg3) - 2, arg2 - 2, Colour1);
        gaj.cbc(arg0 + 2, (arg1 + arg3) - 3, arg2 - 4, Colour4);
        gaj.cbd((arg0 + arg2) - 1, arg1, arg3, Colour1);
        gaj.cbd((arg0 + arg2) - 2, arg1 + 1, arg3 - 2, Colour1);
        gaj.cbd((arg0 + arg2) - 3, arg1 + 2, arg3 - 4, Colour4);
        gaj.cai();
    }

    public void gej(int i, int k, int l, int i1) {
        gaj.DrawBox(i, k, l, i1, 0);
        gaj.DrawBorder(i, k, l, i1, gcn);
        gaj.DrawBorder(i + 1, k + 1, l - 2, i1 - 2, gda);
        gaj.DrawBorder(i + 2, k + 2, l - 4, i1 - 4, gdb);
    ...
    protected void gem(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, String arg6[], int arg7, int arg8) {
    ...
    protected void gfa(int arg0, int arg1, int arg2, int arg3, String arg4[]) {
        ...
        for (int k1 = 0; k1 < k; k1++) {
            ...
            if (gcc >= i1 && gcc <= i1 + gaj.cef(arg4[k1], arg3) && gcd <= j1 && gcd > j1 - gaj.ced(arg3)) {
                if (gbg[arg0]) {
                    l1 = 0x808080;
                } else {
                    l1 = 0xffffff;
            ...
            gaj.DrawStr(arg4[k1], i1, j1, arg3, l1);
            i1 += gaj.cef(arg4[k1] + "  ", arg3);
        }
    }
    ...
    protected void gfb(int arg0, int arg1, int arg2, int arg3, String arg4[]) {
        ...
        for (int l = 0; l < i; l++) {
            ...
            gaj.DrawStr(arg4[l], arg1 - j1 / 2, k, arg3, i1);
            k += gaj.ced(arg3);
        }

    }

    protected void gfc(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, String arg6[], int arg7, int arg8) {
        int i = arg4 / gaj.ced(arg5);
        if (i < arg7) {
            int k = (arg1 + arg3) - 12;
            int i1 = ((arg4 - 27) * i) / arg7;
        ...
        for (int l1 = arg8; l1 < arg7; l1++) {
            ...
            if (gcc >= arg1 + 2 && gcc <= arg1 + 2 + gaj.cef(arg6[l1], arg5) && gcd - 2 <= j1
                    && gcd - 2 > j1 - gaj.ced(arg5)) {
                if (gbg[arg0]) {
                    j2 = 0x808080;
                } else {
                    j2 = 0xffffff;
            ...
            gaj.DrawStr(arg6[l1], arg1 + 2, j1, arg5, j2);
            j1 += gaj.ced(arg5);
            if (j1 >= arg2 + arg4) {
                return;
            }
    ...
    public int gfd(int i, int k, String s, int l, boolean flag) {
        gbj[gak] = 1;
        gam[gak] = true;
        gbb[gak] = false;
        gbn[gak] = l;
    ...
    public int gfe(int i, int k, int l, int i1) {
        gbj[gak] = 2;
        gam[gak] = true;
        gbb[gak] = false;
        gbh[gak] = i - l / 2;
    ...
    public int gfi(int i, int k, int l, int i1, int j1, int k1, boolean flag, boolean flag1) {
        gbj[gak] = 5;
        gam[gak] = true;
        gba[gak] = flag;
        gbb[gak] = false;
    ...
    public int gfj(int i, int k, int l, int i1, int j1, int k1, boolean flag, boolean flag1) {
        gbj[gak] = 6;
        gam[gak] = true;
        gba[gak] = flag;
        gbb[gak] = false;
    ...
    public int gfk(int i, int k, int l, int i1, int j1, int k1, boolean flag) {
        gbj[gak] = 9;
        gam[gak] = true;
        gbb[gak] = false;
        gbn[gak] = j1;
    ...
    public int gfl(int i, int k, int l, int i1) {
        gbj[gak] = 10;
        gam[gak] = true;
        gbb[gak] = false;
        gbh[gak] = i - l / 2;
    ...
    public void gfm(int i) {
        gbd[i] = 0;
    }

    public void gfn(int i) {
        gbc[i] = 0;
        gbf[i] = -1;
    }

    public void gga(int i, int k, String s) {
        gcb[i][k] = s;
        if (k + 1 > gbd[i]) {
            gbd[i] = k + 1;
        }
    ...
    public void ggc(int i, String s) {
        gca[i] = s;
    }

    public String ggd(int i) {
        if (gca[i] == null) {
            return "null";
        } else {
            return gca[i];
    ...
    public void ggg(int i) {
        gcg = i;
    }

    public int ggh(int i) {
        return gbf[i];
    }
