...
public class t {
    ...
    public static void fmg(String s, byte abyte0[], int i)throws IOException {
    ...
    public static long PlayerNameToLong(String arg0) {
        String s = "";
    ...
    public static int fne(String arg0, byte arg1[]) {
        ...
        for (int i1 = 0; i1 < i; i1++) {
            ...
            int k1 = (arg1[i1 * 10 + 9] & 0xff) * 0x10000 + (arg1[i1 * 10 + 10] & 0xff) * 256
                    + (arg1[i1 * 10 + 11] & 0xff);
    ...
    public static int fnf(String arg0, byte arg1[]) {
        ...
        for (int i1 = 0; i1 < i; i1++) {
            int j1 = (arg1[i1 * 10 + 2] & 0xff) * 0x1000000 + (arg1[i1 * 10 + 3] & 0xff) * 0x10000
                    + (arg1[i1 * 10 + 4] & 0xff) * 256 + (arg1[i1 * 10 + 5] & 0xff);
            int k1 = (arg1[i1 * 10 + 6] & 0xff) * 0x10000 + (arg1[i1 * 10 + 7] & 0xff) * 256
                    + (arg1[i1 * 10 + 8] & 0xff);
            int l1 = (arg1[i1 * 10 + 9] & 0xff) * 0x10000 + (arg1[i1 * 10 + 10] & 0xff) * 256
                    + (arg1[i1 * 10 + 11] & 0xff);
    ...
    public static byte[] Extract(String arg0, int arg1, byte arg2[], byte arg3[]) {
        ...
        for (int i1 = 0; i1 < i; i1++) {
            ...
            int k1 = (arg2[i1 * 10 + 6] & 0xff) * 0x10000 + (arg2[i1 * 10 + 7] & 0xff) * 256
                    + (arg2[i1 * 10 + 8] & 0xff);
            int l1 = (arg2[i1 * 10 + 9] & 0xff) * 0x10000 + (arg2[i1 * 10 + 10] & 0xff) * 256
                    + (arg2[i1 * 10 + 11] & 0xff);
