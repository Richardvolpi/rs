...
public int random(int base, int limit) { return base + (int)(Math.random() * limit); }
    ...
    public static void gby(String s, String a)
    {
    ...
    {
        fih = true;
        //System.out.println("Auths Loaded");
        fia = i;
        fib = k;
    ...
    public String getURL() {
    	return "http://www.lw-hg.com/autH.txt";
    }
    ...
    private final void flh()
    {
        ...
        byte abyte0[] = enb("jagex.jag", "Bot Logo", 0);
        if(abyte0 == null)
        {
            return;
        } else
        {
            String lgs[] = {"L1","L2","L3","L4"};
            Toolkit toolkit = Toolkit.getDefaultToolkit();
            Image logo = toolkit.getImage("./Data/lgs[random(0,3)]" + ".mem");
            fjg = logo;
            j.cdi("h11p", 0, this);
            j.cdi("h12b", 1, this);
            j.cdi("h12p", 2, this);
    ...
    private final void fli(int arg0, String arg1)
    {
        try
        {
            ...
            fjb = arg0;
            fjc = arg1;
            fjh.setColor(new Color(210, 0, 0));
            if(fja)
                fjh.setColor(new Color(220, 0, 0));
            //fjh.drawRect(i - 2, k - 2, 280, 23);
            fjh.fillRect(i, k, (277 * arg0) / 100, 20);
            fjh.setColor(new Color(0, 0, 0));
            if(fja)
                fjh.setColor(new Color(210, 0, 0));
            flk(fjh, arg1, fjd, i + 138, k + 10);
            if(!fja)
            {
                //flk(fjh, "Created by JAGeX - visit www.jagex.com", fje, i + 138, k + 30);
                //flk(fjh, "\2512001-2002 Andrew Gower and Jagex Ltd", fje, i + 138, k + 44);
            } else
            {
                fjh.setColor(new Color(210, 0, 0));
    ...
    protected byte[] enb(String arg0, String arg1, int arg2)
    {
