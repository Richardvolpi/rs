...
public class x
{
    ...
    public void gjn(int k, int l, int i1, int j1, int k1)
    {
        ...
        {
            ghd.cbc(l1, i2, 3, j2);
            ghd.cbc(l1, i2 + 1, 2, j2);
            ghd.cbc(l1, i2 + 2, 1, j2);
            ghd.cbc(l1 + 2, i2 + 1, 1, k2);
            ghd.cbc(l1 + 1, i2 + 2, 2, k2);
            return;
        }
        if(i1 == 1)
        {
            ghd.cbc(l1, i2, 3, k2);
            ghd.cbc(l1 + 1, i2 + 1, 2, k2);
            ghd.cbc(l1 + 2, i2 + 2, 1, k2);
            ghd.cbc(l1, i2 + 1, 1, j2);
            ghd.cbc(l1, i2 + 2, 2, j2);
        }
    }
    ...
    public void gkm(int arg0, int arg1, int arg2, boolean arg3)
    {
        ...
        if(arg3)
        {
            ...
            for(int j2 = 0; j2 < 96; j2++)
            {
                ...
                {
                    int i4 = -gkd(j2, i3);
                    if(gjk(j2, i3, arg2) > 0 && e.ahe[gjk(j2, i3, arg2) - 1] == 4)
                        i4 = 0;
                    if(gjk(j2 - 1, i3, arg2) > 0 && e.ahe[gjk(j2 - 1, i3, arg2) - 1] == 4)
                        i4 = 0;
                    if(gjk(j2, i3 - 1, arg2) > 0 && e.ahe[gjk(j2, i3 - 1, arg2) - 1] == 4)
                        i4 = 0;
                    if(gjk(j2 - 1, i3 - 1, arg2) > 0 && e.ahe[gjk(j2 - 1, i3 - 1, arg2) - 1] == 4)
                        i4 = 0;
            ...
            for(int k4 = 1; k4 < 95; k4++)
            {
                for(int i6 = 1; i6 < 95; i6++)
                    if(gjk(k4, i6, arg2) > 0 && e.ahe[gjk(k4, i6, arg2) - 1] == 4)
                    {
                        int l7 = e.ahd[gjk(k4, i6, arg2) - 1];
                    ...
                    if(gjk(k4, i6, arg2) == 0 || e.ahe[gjk(k4, i6, arg2) - 1] != 3)
                    {
                        if(gjk(k4, i6 + 1, arg2) > 0 && e.ahe[gjk(k4, i6 + 1, arg2) - 1] == 4)
                        {
                            int i8 = e.ahd[gjk(k4, i6 + 1, arg2) - 1];
                        ...
                        if(gjk(k4, i6 - 1, arg2) > 0 && e.ahe[gjk(k4, i6 - 1, arg2) - 1] == 4)
                        {
                            int j8 = e.ahd[gjk(k4, i6 - 1, arg2) - 1];
                        ...
                        if(gjk(k4 + 1, i6, arg2) > 0 && e.ahe[gjk(k4 + 1, i6, arg2) - 1] == 4)
                        {
                            int k8 = e.ahd[gjk(k4 + 1, i6, arg2) - 1];
                        ...
                        if(gjk(k4 - 1, i6, arg2) > 0 && e.ahe[gjk(k4 - 1, i6, arg2) - 1] == 4)
                        {
                            int l8 = e.ahd[gjk(k4 - 1, i6, arg2) - 1];
        ...
        for(int i2 = 0; i2 < 95; i2++)
        {
            ...
            {
                int k3 = gkl(i2, k2);
                if(k3 > 0 && (e.akj[k3 - 1] == 0 || ghf))
                {
                    gjd(gin, k3 - 1, i2, k2, i2 + 1, k2);
                    if(arg3 && e.aki[k3 - 1] != 0)
                    {
                        ghb[i2][k2] |= 1;
                        if(k2 > 0)
                            gli(i2, k2 - 1, 4);
                ...
                k3 = gkn(i2, k2);
                if(k3 > 0 && k3 < 12000 && (e.akj[k3 - 1] == 0 || ghf))
                {
                ...
                if(k3 > 12000 && k3 < 24000 && (e.akj[k3 - 12001] == 0 || ghf))
                {
                    gjd(gin, k3 - 12001, i2 + 1, k2, i2, k2 + 1);
                    if(arg3 && e.aki[k3 - 12001] != 0)
                        ghb[i2][k2] |= 0x10;
                    if(arg3)
                    {
        ...
        for(int k = 0; k < 94; k++)
        {
            for(int l = 0; l < 94; l++)
                if(gkn(k, l) > 48000 && gkn(k, l) < 60000)
                {
                    ...
                    gjj(k, l, i1);
                    i i2 = arg0[e.alk[i1]].cnk(false, true, false, false);
                    int j2 = ((k + k + k1) * 128) / 2;
                    int l2 = ((l + l + l1) * 128) / 2;
